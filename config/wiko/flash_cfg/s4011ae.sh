...
echo "S4011AE 4GB+4Gb config start copy .."
...
cp mediatek/config/s4011/flash_cfg/ProjectConfig_AE.mk mediatek/config/s4011/ProjectConfig.mk

echo "S4011AE 4GB+4Gb config copy done!"
