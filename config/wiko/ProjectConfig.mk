...
CUSTOM_HAL_IMGSENSOR=ov5648_mipi_raw_truly hi258_mipi_yuv_cmk hi258_mipi_yuv_sw
...
CUSTOM_HAL_MAIN_IMGSENSOR=ov5648_mipi_raw_truly
...
CUSTOM_HAL_SUB_BACKUP_IMGSENSOR=hi258_mipi_yuv_cmk
...
CUSTOM_KERNEL_IMGSENSOR=ov5648_mipi_raw_truly hi258_mipi_yuv_cmk hi258_mipi_yuv_sw
...
CUSTOM_KERNEL_MAIN_IMGSENSOR=ov5648_mipi_raw_truly
...
CUSTOM_LK_LCM=otm8018b_dsi_vdo_boe_g6 hx8379c_fwvga_dsi_vdo_tcl
...
CUSTOM_MODEM=mt6582lte_fdd_wik_fr
...
CUSTOM_KERNEL_LCM=otm8018b_dsi_vdo_boe_g6 hx8379c_fwvga_dsi_vdo_tcl

# To choose uboot LCM driver name
CUSTOM_UBOOT_LCM=otm8018b_dsi_vdo_boe_g6 hx8379c_fwvga_dsi_vdo_tcl
...
#CREATE_PROJECT_INFO=20140415215053
MTK_BUILD_VERNO = ALPS.KK1.MP3.V1

#LINE <project> <DATE20140304> <project macro> mickal.ma
TINNO_MS_COLOR_SELECT = yes
PROJECT_L4550=yes
RECEIVER_HEADSET_AUTOTEST=no
# Use TINNO_PROJECT_NAME in java file to identify projects.
TINNO_PROJECT_NAME=L4550AE
# User can input ASCII string which is showed in About phone and bootimg header.
#CUSTOM_BUILD_VERNO =L4550AE_PR_00_06
#INTERNAL_BUILD_VERNO=L4550AE_PR_00_06

#LINE<BUG><EFFA-47><><20140416>yinhuiyong
CUSTOM_PRODUCT_MODEL=L4550AE


# TINNO APPS AND WIDGETS
TN_APP_CALCULATOR = no
TN_APP_CALENDAR = no
TN_APP_DESKCLOCK = no
TN_APP_FILEMANAGER = no
TN_APP_FMRADIO = no
TN_APP_GALLERY2 = no
TN_APP_MUSIC = no
TN_APP_SETTINGS = no
TN_WIDGET_WEATHER = no
TN_WIDGET_WORLDCLOCK = no
...
CUSTOM_BUILD_VERNO = WIKO BIRDY Version 8
CUSTOM_BUILD_DE_VERNO=WIKO BIRDY Version 10
INTERNAL_BUILD_VERNO=L4550AE_KK_PP_WIK_FR_10_13
