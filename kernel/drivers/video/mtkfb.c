...
//TN801031 modified 2013.05.24
#if TN_DISPLAY
int sem_flipping_cnt = 1;
int sem_early_suspend_cnt = 1;
int sem_overlay_buffer_cnt = 1;
#else
...
//TN801031 modified 2013.08.20
#if TN_DISPLAY
struct task_struct *screen_update_task = NULL;
#else
...
//TN801031 added 2013.05.24
#if TN_DISPLAY
	sem_flipping_cnt++;
    up(&sem_flipping);

    if (wait_event_interruptible_timeout(reg_update_wq, PanDispSettingApplied, HZ/10) == 0)//10HZ
    {
    }//if (wait_event_interruptible_timeout(reg_update_wq, PanDispSettingApplied, HZ/10) == 0)//10HZ
#else
//TN801031 added 2013.05.24
...
//zx++
char lcd_desc[50]="Hello world too!";
...
static int mtkfb_probe(struct device *dev)
{
	...
	//TN801031 added 2013.05.23
#if TN_DISPLAY
	extern void vvvvvvvvvvv96(void);
	vvvvvvvvvvv96();
#endif
	//TN801031 added 2013.05.23
	...
	//TN801031 added 2013.08.13
#if TN_DISPLAY

	extern void vvvvvvvvvvv85(void);
...
static void mtkfb_shutdown(struct device *pdev)
{
    ...
    printk("[FB Driver] mtkfb_shutdown() end\n");
}

#if TN_DISPLAY
void mtkfb_clear_lcm(UINT32 color)
#else
...
//zx++
#include "ddp_reg.h"
void mtkfb_clear_lcm_for_TN(unsigned int color)
{
         int i;
        ...
        //printk("mtkfb_early_suspend step2-1\n"); //mtk add
        DISP_REG_SET(DISP_REG_OVL_ROI_BGCLR, color);

                   DISP_UpdateScreen_vdo_mode();
        //printk("mtkfb_early_suspend step2-2\n"); //mtk add
                   //DISP_UpdateScreen_vdo_mode();  // by zx
        //printk("mtkfb_early_suspend step2-3\n"); //mtk add
 

                   DISP_WaitForLCDNotBusy();
        //printk("mtkfb_early_suspend step2-4\n"); //mtk add
         for(i=0;i<LCD_LAYER_NUM;i++)
        ...
        //printk("mtkfb_early_suspend step2-5\n"); //mtk add
} 
//zx--
#ifdef CONFIG_HAS_EARLYSUSPEND
static void mtkfb_early_suspend(struct early_suspend *h)
...
//TN801031 deleted 2013.09.07 for tn801517 
#if TN_DISPLAY
#else
    //add begin zx++
    DSI_switch_to_cmd_mode();
    mtkfb_clear_lcm_for_TN(0xFFFFFFFF);
    //add end zx--
#endif
//TN801031 deleted 2013.09.07 for tn801517 
    ...
    */
#if TN_DISPLAY
    mtkfb_clear_lcm(0xFFFFFFFF);//tinnohd.add by tcp.·ÀÖ¹LCM¼«ÐÔ·´×ª
#endif
...
//tinnohd open
    ...
    {
        mtkfb_clear_lcm(0x00000000);//tinnohd.add by tcp.·ÀÖ¹LCM¼«ÐÔ·´×ª
        msleep(20);
    }
#else
    #if 0
    ...
    #else
     //zx++
    mtkfb_clear_lcm_for_TN(0x00000000);  //½â¾öLCM»½ÐÑ¼«ÐÔ·´×ªÎÊÌâ
    //msleep(20);
    //zx--
    #endif
