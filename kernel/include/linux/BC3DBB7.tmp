...
#define ALSPS_IOCTL_PS_CALI_START			_IOW(ALSPS, 0x0f, int[2])
#define ALSPS_IOCTL_PS_SET_CALI			_IOW(ALSPS, 0x10, int[2])
#define ALSPS_IOCTL_PS_GET_CALI			_IOW(ALSPS, 0x11, int[2])
#define ALSPS_IOCTL_PS_CLR_CALI			_IO(ALSPS, 0x12)
#define ALSPS_IOCTL_PS_CALI_RAW_DATA				_IOR(ALSPS, 0x13, int)
