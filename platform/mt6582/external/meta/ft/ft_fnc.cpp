...
//		FT_DRMKEY_OP
//DESCRIPTION:
//		this function is called to deal with DRMKey feature.
//
//PARAMETERS:
//		req:			[IN]	refers to the define of "FT_DRMKEY_REQ"
//		pPeerBuf: 	[IN]	peer buff
//		peer_len:		[IN]	peer buff size
...
void FT_DRMKEY_OP(FT_DRMKEY_INSTALL_REQ * req, char* pPeerBuf, kal_int16 peer_len)
{
    META_DRMKEY_INSTALL_OP(req, pPeerBuf, peer_len);
}
#endif
