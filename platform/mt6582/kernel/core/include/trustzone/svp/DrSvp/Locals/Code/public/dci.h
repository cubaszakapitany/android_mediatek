...
#define RET_ERR_DRV_SWITCH_OVL_LAYER       4
#define RET_ERR_DRV_CONFIG_OVL_LAYER       5
#define RET_ERR_DRV_CONFIG_RDMA            6
#define RET_ERR_DRV_CONFIG_WDMA_ADDRESS    7
#define RET_ERR_DRV_CONFIG_WDMA            8
#define RET_ERR_DRV_CONFIG_RDMA_ADDRESS    9
