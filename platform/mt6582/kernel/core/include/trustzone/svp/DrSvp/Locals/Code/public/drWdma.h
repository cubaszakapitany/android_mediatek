...
typedef struct _WDMA_CONFIG_STRUCT
{
    ...
    unsigned int dstPitchUV;
    unsigned int useSpecifiedAlpha;
    unsigned char alpha;
} WDMA_CONFIG_STRUCT;

int WDMAConfigAddress_svp(unsigned int buffer);

int WDMAClearIntr(unsigned idx, unsigned int reg_val);

// start module
int WDMAStart(unsigned int idx);

// stop module
int WDMAStop(unsigned int idx);

// soft reset and to default value
int WDMAReset(unsigned int idx);

// config write settings
int WDMAConfig(unsigned int idx,
               unsigned int inputFormat,
               unsigned int srcWidth,
               unsigned int srcHeight,
               unsigned int clipX,
...
int WDMAConfig2(unsigned int idx,
               unsigned int inputFormat,
               unsigned int srcWidth,
               unsigned int srcHeight,
               unsigned int clipX,
               ...
               unsigned int dstWidth,
               unsigned int dstPitch,
               unsigned int dstUVPitch,
               unsigned int useSpecifiedAlpha,
               unsigned char alpha);

void WDMAWait(unsigned int idx);
...
int WDMAConfigUV(unsigned int idx, unsigned int uAddr, unsigned int vAddr, unsigned int dstWidth);
