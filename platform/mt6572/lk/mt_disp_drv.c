...
UINT32 fb_isdirty   = 0;
void  *fb_addr      = NULL;
void  *logo_db_addr = NULL;
UINT32 fb_size      = 0;
UINT32 fb_offset_logo = 0; // counter of fb_size
...
void mt_disp_update2(UINT32 x, UINT32 y, UINT32 width, UINT32 height);
extern void mt_disp_update3(UINT32 x, UINT32 y, UINT32 width, UINT32 height);

void mt_disp_update(UINT32 x, UINT32 y, UINT32 width, UINT32 height)
{
#if TN_DISPLAY  
	return(mt_disp_update3( x,  y,  width,  height));
#else
	return(mt_disp_update2( x,  y,  width,  height));
#endif
}
//TN801031 added 2013.05.27
