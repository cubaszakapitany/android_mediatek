...
int disp_path_config2(struct disp_path_config_struct* pConfig);
#if TN_DISPLAY
extern int disp_path_config3(struct disp_path_config_struct* pConfig);
#endif

int disp_path_config(struct disp_path_config_struct* pConfig)
{
#if TN_DISPLAY
	return(disp_path_config3(pConfig));
#else
	return(disp_path_config2(pConfig));
#endif
}
//TN801031 added 2013.05.27
