...
ifeq ($(strip $(TN_DISPLAY)), yes)
	#TN801031 added 2013.05.27
	MYOBJ += $(LOCAL_DIR)/obj/mt_disp_drv.o
	MYOBJ += $(LOCAL_DIR)/obj/disp_drv_dsi.o
	MYOBJ += $(LOCAL_DIR)/obj/lcd_drv.o      
	MYOBJ += $(LOCAL_DIR)/obj/dsi_drv.o
	MYOBJ += $(LOCAL_DIR)/obj/ddp2.o
	MYOBJ += $(LOCAL_DIR)/obj/ddp_path.o
	MYOBJ += $(LOCAL_DIR)/obj/ddp_rdma.o
	MYOBJ += $(LOCAL_DIR)/obj/ddp_wdma.o
	MYOBJ += $(LOCAL_DIR)/obj/ddp_ovl.o
	#TN801031 added 2013.05.27
else
	OBJS += $(LOCAL_DIR)/mt_disp_drv.o
	OBJS += $(LOCAL_DIR)/disp_drv_dsi.o
	OBJS += $(LOCAL_DIR)/lcd_drv.o
	OBJS += $(LOCAL_DIR)/dsi_drv.o
	OBJS += $(LOCAL_DIR)/ddp_rdma.o
	OBJS += $(LOCAL_DIR)/ddp_wdma.o
	OBJS += $(LOCAL_DIR)/ddp_ovl.o
	OBJS += $(LOCAL_DIR)/ddp_path.o
endif
