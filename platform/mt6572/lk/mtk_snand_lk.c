...
// MTK P67 startup fail
//__attribute__((aligned(4))) unsigned char g_snand_temp[NAND_SECTOR_SIZE + NAND_SPARE_PER_SECTOR];
__attribute__((aligned(4))) unsigned char g_snand_temp[NAND_SECTOR_SIZE + 64];
