...
#if TN_DISPLAY
volatile bool dsiTeEnable = false;
#else
...
DSI_STATUS DSI_StartTransfer2(BOOL needStartDSI);
#if TN_DISPLAY
extern DSI_STATUS DSI_StartTransfer3(BOOL needStartDSI);
#endif

DSI_STATUS DSI_StartTransfer(BOOL needStartDSI)
{
#if TN_DISPLAY
	return(DSI_StartTransfer3(needStartDSI));
#else
	return(DSI_StartTransfer2(needStartDSI));
#endif
}
//TN801031 added 2013.05.27
...
void DSI_set_cmdq_V2(unsigned cmd, unsigned char count, unsigned char *para_list, unsigned char force_update)
{
	...
	else
	{
		...
		{
			t2.CONFG = 2;
			t2.Data_ID = DSI_DCS_LONG_PACKET_ID; //yixuhong 20130701 lcd issue DSI_GERNERIC_LONG_PACKET_ID;
			t2.WC16 = count+1;
