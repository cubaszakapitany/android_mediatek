...
#ifdef __S6041A_DS__
#define LCM_BL_GPIO 134
#define LCM_BL_GPIO_MD0 0
#define LCM_BL_GPIO_OUTPUT 1
#define LCM_BL_GPIO_OUTPUT_ZERO 0
void set_backlight_gpio_default(void)
{
        mt_set_gpio_mode(LCM_BL_GPIO, LCM_BL_GPIO_MD0);
        mt_set_gpio_dir(LCM_BL_GPIO, LCM_BL_GPIO_OUTPUT);
        mt_set_gpio_out(LCM_BL_GPIO, LCM_BL_GPIO_OUTPUT_ZERO);
        printf("zx set_gpio_134\n");
}
#endif
