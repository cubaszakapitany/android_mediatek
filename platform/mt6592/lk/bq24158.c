...
void bq24158_turn_on_charging(void)
{
    ...
    bq24158_config_interface_reg(0x01,0xf0);
    //bq24158_config_interface_reg(0x02,0xaa);
    bq24158_config_interface_reg(0x05,0x04);
    bq24158_config_interface_reg(0x04,0x2a);
}

void bq24158_hw_init(void)
{
#if defined(HIGH_BATTERY_VOLTAGE_SUPPORT)
    dprintf(INFO, "[bq24158_hw_init] (0x06,0x47)\n");
    bq24158_config_interface_reg(0x06,0x47); // set ISAFE and HW CV point (4.34)
    bq24158_config_interface_reg(0x02,0xaa); // 4.34    
#else
    dprintf(INFO, "[bq24158_hw_init] (0x06,0x40)\n");
    bq24158_config_interface_reg(0x06,0x40); // set ISAFE
