...
*/
	CHARGE_CURRENT_700_00_MA,CHARGE_CURRENT_850_00_MA,CHARGE_CURRENT_1000_00_MA,CHARGE_CURRENT_1150_00_MA,
...
static void hw_bc11_dump_register(void)
{
 ...
 static void hw_bc11_init(void)
 {
	 ...
	 upmu_set_rg_bc11_bb_ctrl(0x1);
 	 ...
 	 //msleep(10);
 	 // Jake.L, DATE20140425, SFAE-752, DATE20140425-01 LINE
 	 msleep(50); //mdelay(50);
 ...
 static kal_uint32 charging_hw_init(void *data)
 {
    ...
    bq24158_config_interface_reg(0x01,0xb0);	//TE=0, CE=0, HZ_MODE=0, OPA_MODE=0
    #else
    bq24158_config_interface_reg(0x01,0xb8);	//TE=1, CE=0, HZ_MODE=0, OPA_MODE=0
    #endif  /* TINNO_BATTERY_FEATURE */
    // Jake.L, DATE20140528, SFAE-1072, DATE20140528-01 LINE
    //bq24158_config_interface_reg(0x05,0x03);    // charger voltage is 4.44V
    bq24158_config_interface_reg(0x05,0x04);    // charger voltage is 4.52V
