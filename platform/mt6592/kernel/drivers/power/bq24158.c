...
int bq24158_write_byte(kal_uint8 cmd, kal_uint8 writeData)
{
    char    write_data[2] = {0};
    int     ret=0;
    //battery_xlog_printk(BAT_LOG_CRTI, "bq24158_write_byte cmd=%d, data=%x\n", cmd, writeData);
...
{             
    ...
    bq24158_config_interface_reg(0x06, 0x47); // ISAFE = 1266mA @51mOh, VSAFE = 4.34V
#else
    bq24158_config_interface_reg(0x06,0x40);
#endif
