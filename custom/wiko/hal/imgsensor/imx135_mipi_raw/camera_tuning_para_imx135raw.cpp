...
{{
    ...
    ISPCcmPoly22:{
        ...
        23666,    // i4B_STD
        {  // i4P00[9]
            5128000, -2226000, -346000, -1024000, 4086000, -502000, -212000, -1544000, 4320000
        },
        {  // i4P10[9]
            -346065, -769728, 1111205, 50119, 48948, -99067, 177601, -576436, 403260
        },
        {  // i4P01[9]
            -425904, -431384, 857908, 66481, -292342, 225861, 176750, -1312290, 1137135
        },
        {  // i4P20[9]
            0, 0, 0, 0, 0, 0, 0, 0, 0
        },
...
const NVRAM_CAMERA_3A_STRUCT CAMERA_3A_NVRAM_DEFAULT_VALUE =
{
    ...
    // AE NVRAM
    {
         ...
         // rHistConfig
        {
            ...
            {82, 92, 120, 148, 170},    // u4HistStretchThres[AE_CCT_STRENGTH_NUM] 
            {18, 22, 100, 30, 34}    // u4BlackLightThres[AE_CCT_STRENGTH_NUM]
        },
        // rCCTConfig
        {
