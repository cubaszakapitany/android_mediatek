...
{{
    ...
    ISPCcmPoly22:{
        ...
        22724,    // i4B_STD
        {  // i4P00[9]
            5067500, -2062500, -445000, -745000, 3167500, 135000, 175000, -2292500, 4675000
        },
        {  // i4P10[9]
            1148001, -1001268, -146733, -88789, 107455, -25317, 13112, 216642, -228182
        },
        {  // i4P01[9]
            -243150, -9320, 252469, -73729, -385361, 453386, -28156, -324753, 358814
        },
        {  // i4P20[9]
            0, 0, 0, 0, 0, 0, 0, 0, 0
        },
...
const NVRAM_CAMERA_3A_STRUCT CAMERA_3A_NVRAM_DEFAULT_VALUE =
{
    ...
    // AE NVRAM
    {
         ...
         // rHistConfig
        {
            ...
            {18, 22, 26, 30, 44}    // u4BlackLightThres[AE_CCT_STRENGTH_NUM] 
        },
        // rCCTConfig
        {
