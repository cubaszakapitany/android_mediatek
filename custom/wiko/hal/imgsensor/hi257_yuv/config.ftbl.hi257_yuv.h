...
#ifndef _MTK_CUSTOM_S4011_HAL_IMGSENSOR_SRC_CONFIGFTBL_HI257_YUV_H_
#define _MTK_CUSTOM_S4011_HAL_IMGSENSOR_SRC_CONFIGFTBL_HI257_YUV_H_
...
FTABLE_SCENE_INDEP()
    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ...
            ITEM_AS_VALUES_(
            //BEGIN: <SSZTO-272> <20130703> <remove the redundant scene mode>
             ...
             //END: <SSZTO-272> <20130703> <remove the redundant scene mode>
            )
        ), 
    )
#endif
    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_SUPPORTED(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ...
            ITEM_AS_SUPPORTED_(
            #if 1    //LINE <#if 0> <20130731> <remove the eis function> panzaoyan
...
FTABLE_SCENE_DEP()
...
#endif
    //==========================================================================
#if  0//LINE <#if 1> <20130807> <removed the ISO function.> panzaoyan
    //  ISO
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        //......................................................................
#if 0 //LINE: <#if 1> <20130709> <remove this scene> panzaoyan   //  SCENE LANDSCAPE
...
#endif
        //......................................................................
#if 0 //LINE: <#if 1> <20130709> <remove this scene> panzaoyan  //  SCENE SUNSET
...
#endif
        //......................................................................
#if 1 //LINE: <#if 1> <20130709> <remove this scene> panzaoyan  //  SCENE CANDLELIGHT
...
#endif
    //==========================================================================
#if 1 //LINE <#if 1> <20130807> <removed the Saturation function.> panzaoyan
    //  ISP Saturation
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
...
#endif
    //==========================================================================
#if 1 //LINE <#if 1> <20130807> <removed the Brightness function.> panzaoyan
    //  ISP Brightness
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
...
#endif
    //==========================================================================
#if 1 //LINE <#if 1> <20130807> <removed the contrast function.> panzaoyan
    //  ISP Contrast
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
