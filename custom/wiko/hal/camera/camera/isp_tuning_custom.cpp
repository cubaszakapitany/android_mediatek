...
/*    if (sensorID == IMX179_SENSOR_ID)
    {
        ...
        THL2	= 4900;
        THH2	= 5050;
        TH2 	= (THL2+THH2)/2;//(THL2 +THH2)/2	TH2 = 9828/2=4914	CCT=4764
        TH3 	= -20;
        LOGD("[-evaluate_Shading_CCT_index][IMX179] This is IMX179 sensor.");
    }
    else if(sensorID == OV8835_SENSOR_ID)
    {
        THL1	= 3950;
        THH1	= 4200;
        TH1	= (THL1+THH1)/2; //(THL1 +THH1)/2
        ...
        TH3	= -70;
        LOGD("[-evaluate_Shading_CCT_index][OV8835] This is OV8835 sensor.");
    }
    else*/
    {
        LOGD("[-evaluate_Shading_CCT_index][DEFAULT] This is default value.");
        THL2	= 4673;
        THH2	= 5155;
        TH2	= (THL2+THH2)/2;//(THL2 +THH2)/2    TH2 = 9828/2=4914   CCT=4764
