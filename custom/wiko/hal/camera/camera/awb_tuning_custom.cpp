...
getAWBParam()
{
    ...
    if(strstr(module_name,"imx179mipiraw")||strstr(module_name,"ov8835mipiraw"))
    rAWBParam =
    {
        ...
        // AWB Light source probability look-up table (Max: 100; Min: 0)
    	{
			...
			{100, 100, 100, 100, 100, 100, 100, 100, 100, 100,  100,  80,   33,   1,   1,   1,   1,   1,   1}, // Tungsten
			{100, 100, 100, 100, 100, 100, 100, 100, 100, 100,  100,  80,   33,   1,   1,   1,   1,   1,   1}, // Warm fluorescent
    			{100, 100, 100, 100, 100, 100, 100, 100, 100, 100,  66,  33,   1,   1,   1,   1,   1,   1,   1}, // Fluorescent
			{100, 100, 100, 100, 100, 100, 100, 100, 100, 100,  100,  80,   33,   1,   1,   1,   1,   1,   1}, // CWF
    	...
    	// AWB gain prediction parameter
    	{
            ...
            // Tungsten
    	    {
                 115, // i4IntermediateSceneLvThr_L1
                 135, // i4IntermediateSceneLvThr_H1
                 115, // i4IntermediateSceneLvThr_L2
