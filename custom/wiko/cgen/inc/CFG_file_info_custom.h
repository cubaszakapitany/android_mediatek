...
extern "C"
{
    ...
    const TCFG_FILE g_akCFG_File_Custom[]=
    {
        ...
        {
            "/data/nvram/APCFG/APRDEB/REPORT_NV",       VER(AP_CFG_CUSTOM_FILE_REPORT_LID),         CFG_CUSTOM_FILE_REPORT_NV_SIZE,
            CFG_CUSTOM_FILE_REPORT_NV_TOTAL,                   SIGNLE_DEFUALT_REC,  (char *)&stREPORT_NVConfigDefault,DataReset, NULL
        },
    };
