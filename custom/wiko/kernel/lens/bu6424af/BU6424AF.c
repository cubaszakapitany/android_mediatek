...
static int BU6424AF_Open(struct inode * a_pstInode, struct file * a_pstFile)
{
    ...
    char puSuspendCmd[2] = {(char)(0xCC), (char)(0x2B)};
    i4RetValue = i2c_master_send(g_pstBU6424AF_I2Cclient, puSuspendCmd, 2);

    char puSuspendCmd1[2] = {(char)(0xD4), (char)(0x50)};
    i4RetValue = i2c_master_send(g_pstBU6424AF_I2Cclient, puSuspendCmd1, 2);

    char puSuspendCmd2[2] = {(char)(0xDC), (char)(0xB4)};
    i4RetValue = i2c_master_send(g_pstBU6424AF_I2Cclient, puSuspendCmd2, 2);

    char puSuspendCmd3[2] = {(char)(0xE4), (char)(0x41)};
    i4RetValue = i2c_master_send(g_pstBU6424AF_I2Cclient, puSuspendCmd3, 2);
