...
int FL_dim_duty(kal_uint32 duty)
{
	...
	if(duty < 10)
       { //LEDS_CUSTOM_MODE_THRES==20,torch mode:duty==6,flash mode:duty==12
		flashpwm = 0;
...
#define ISINK_CONTROL  (1) //guomingyi20140312add 0,1 is charger led, 2,3 is flash & torch led.
