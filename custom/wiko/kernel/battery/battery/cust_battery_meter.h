...
#define Q_MAX_POS_50	2045
#define Q_MAX_POS_25	2045
#define Q_MAX_POS_0		2037
#define Q_MAX_NEG_10	2039

#define Q_MAX_POS_50_H_CURRENT	1998
#define Q_MAX_POS_25_H_CURRENT	2003
...
#if defined (TINNO_BATTERY_FEATURE)
#define NORMAL_WAKEUP_PERIOD		600 		//10 * 60 = 10 min
#else
...
#if defined (TINNO_ANDROID_S4750AE)
//#define TINNO_FIXED_TBAT   // Temp sulotion for fault battery sample.
#if !defined (TINNO_BATVOL_USED_OCV)
#define TINNO_BATVOL_USED_OCV
#endif  /* TINNO_BATVOL_USED_OCV */
#endif  /* TINNO_ANDROID_S4750AE */
