 ...
 */
#define LTR501_IOCTL_MAGIC      'c'

/* IOCTLs for ltr501 device */
#define LTR501_IOCTL_PS_ENABLE		_IOW(LTR501_IOCTL_MAGIC, 0, char *)
#define LTR501_IOCTL_ALS_ENABLE		_IOW(LTR501_IOCTL_MAGIC, 1, char *)
#define LTR501_IOCTL_READ_PS_DATA	_IOR(LTR501_IOCTL_MAGIC, 2, char *)
#define LTR501_IOCTL_READ_PS_INT	_IOR(LTR501_IOCTL_MAGIC, 3, char *)
#define LTR501_IOCTL_READ_ALS_DATA	_IOR(LTR501_IOCTL_MAGIC, 4, char *)
#define LTR501_IOCTL_READ_ALS_INT	_IOR(LTR501_IOCTL_MAGIC, 5, char *)
...
#define ltr501_SUCCESS						0
#define ltr501_ERR_I2C						-1
#define ltr501_ERR_STATUS					-3
#define ltr501_ERR_SETUP_FAILURE				-4
#define ltr501_ERR_GETGSENSORDATA			-5
#define ltr501_ERR_IDENTIFICATION			-6
