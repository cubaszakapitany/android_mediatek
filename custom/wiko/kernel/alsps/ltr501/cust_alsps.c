...
static struct alsps_hw cust_alsps_hw = {
 ...
 //   .als_value  = {40, 40, 90,  90, 160, 160,  225,  320,  640,  1280,  1280,  2600,  2600, 2600,  10240, 10240},
    ...
    .als_level  = { 9,   15,   90,     200,  300,   400,     900,     2000,     10000,  14000, 18000,   20000, 30000,},
    .als_value  = {30, 250, 420,   640,  1280,  2600,  10240,   65536,  65536,   65536, 65536,  65536,  65536},

    .ps_threshold = 2,	//3,
    .ps_threshold_high = 141,//275,//178, // 0x11c,
    .ps_threshold_low = 37,//178, // 0x85,
