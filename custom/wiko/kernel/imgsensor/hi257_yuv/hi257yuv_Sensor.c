...
static int VIDEOB_FLAG = 0;//Add By Paul
...
#if 0
extern void MainCameraDigtalPDNCtrl(u32 onoff) ;
#else
void MainCameraDigtalPDNCtrl(u32 onoff) {}
//void FL_SetCaputureFLStatus(int flag){}
//int FL_GetCaputureFLStatus(void){return 0;}
#endif
...
HI257WriteCmosSensor(0x18, 0x37);// Double_AG 5e->37
HI257WriteCmosSensor(0x19, 0x36);// Double_AG 5e->36
...
HI257WriteCmosSensor(0x83, 0x0b); //EXP Normal 33.33 fps 
...
HI257WriteCmosSensor(0x9c, 0x21); //EXP Limit 1500.00 fps 
...
HI257WriteCmosSensor(0x8f, 0x3f); //4e
HI257WriteCmosSensor(0x90, 0x3d); //4d
HI257WriteCmosSensor(0x91, 0x36); //4c
HI257WriteCmosSensor(0x92, 0x32); //4a
HI257WriteCmosSensor(0x93, 0x2a); //46
...
HI257WriteCmosSensor(0x9c, 0x21); 
HI257WriteCmosSensor(0x9d, 0x34); 
...
UINT32 ZSDCapture(MSDK_SENSOR_EXPOSURE_WINDOW_STRUCT *image_window,
                      MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
...
SENSORDB("\n\n\n\n\n\n");
SENSORDB("[HI257]CONTROLFLOW ZSDCapture!!!!!!!!!!!!!\n");
...
HI257SetMirror(IMAGE_NORMAL); //<BUG><EABB-43><guomingyi 20140430 add>
HI257SetPage(0x13);
HI257WriteCmosSensor(0x82, 0x63); //Sharp2D Filter
                    ...
                    MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
  ...
  case MSDK_SCENARIO_ID_CAMERA_ZSD:
   ...
   ZSDCapture(pImageWindow, pSensorConfigData);
...
SENSORDB("[Hi2 57_Debug]HI257Status.SensorMode:%d\n ", HI257Status.SensorMode);	
...
if(HI257Status.SensorMode == SENSOR_MODE_ZSD)
{
	...
	case SCENE_MODE_NIGHTSCENE:
		...
		HI257WriteCmosSensor(0x90, 0x0e);	//BLC_TIME_TH_ON
		HI257WriteCmosSensor(0x91, 0x0e);	//BLC_TIME_TH_OFF
		HI257WriteCmosSensor(0x92, 0x98);	//BLC_AG_TH_ON
		HI257WriteCmosSensor(0x93, 0x90);	//BLC_AG_TH_OFF
		HI257WriteCmosSensor(0x03, 0x02);
		HI257WriteCmosSensor(0xd4, 0x0e);	//DCDC_TIME_TH_ON
		HI257WriteCmosSensor(0xd5, 0x0e);	//DCDC_TIME_TH_OFF
		HI257WriteCmosSensor(0xd6, 0x98);	//DCDC_AG_TH_ON
		HI257WriteCmosSensor(0xd7, 0x90);	//DCDC_AG_TH_OFF
		//AWB	Auto
		HI257WriteCmosSensor(0x03, 0x22);
		HI257WriteCmosSensor(0x11, 0x2e);
		HI257WriteCmosSensor(0x83, 0x58);
		...
		if(ISDarkMode())
		{					
			HI257WriteCmosSensor(0x83, 0x13); //EXP Max(100Hz) 5.00 fps 
			HI257WriteCmosSensor(0x84, 0xd6); 
			HI257WriteCmosSensor(0x85, 0x20);
		}
	...
	case SCENE_MODE_NORMAL:
		...
		if(ISDarkMode())
		{					
			HI257WriteCmosSensor(0x83, 0x0b); //EXP Max(100Hz) 10.00 fps 
			HI257WriteCmosSensor(0x84, 0xe6); 
			HI257WriteCmosSensor(0x85, 0xe0);
		}

		HI257WriteCmosSensor(0xa5, 0x0b);	//EXP	Max(100Hz) 10.00 fps
		HI257WriteCmosSensor(0xa6, 0xe6);
		HI257WriteCmosSensor(0xa7, 0xe0);
	...
	default:
		...
		HI257WriteCmosSensor(0x60, 0x01);
		HI257WriteCmosSensor(0x61, 0x98);
		HI257WriteCmosSensor(0x62, 0x98);
		HI257WriteCmosSensor(0x63, 0xd0);
		...
		if(ISDarkMode())
		{					
			HI257WriteCmosSensor(0x83, 0x0b); //EXP Max(100Hz)8.00 fps 
			HI257WriteCmosSensor(0x84, 0xe6); 
			HI257WriteCmosSensor(0x85, 0xe0);
		}

		HI257WriteCmosSensor(0xa5, 0x0b);	//EXP	Max(100Hz) 8.00 fps
		HI257WriteCmosSensor(0xa6, 0xe6);
		HI257WriteCmosSensor(0xa7, 0xe0);
