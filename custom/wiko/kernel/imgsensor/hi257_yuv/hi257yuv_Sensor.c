...
HI257WriteCmosSensor(0x25, 0x85); //mcmc_hue_angle2
...
{		SENSORDB("[HI257]HI257NightMode Disable AE_FLICKER_MODE_50HZ\n");
	...
	HI257WriteCmosSensor(0x83, 0x0a);  //EXP Normal 8.33 fps 
	HI257WriteCmosSensor(0x84, 0xe8); 
	HI257WriteCmosSensor(0x85, 0xf8); 

	HI257WriteCmosSensor(0x86, 0x01); //EXPMin 13000.00 fps*2 by paul
	HI257WriteCmosSensor(0x87, 0xf4); 

	
	HI257WriteCmosSensor(0x88, 0x0C); //EXP Max(120Hz) 7.00 fps 
	HI257WriteCmosSensor(0x89, 0x5C); 
	HI257WriteCmosSensor(0x8a, 0x10); 
	
	HI257WriteCmosSensor(0xa5, 0x0B); //EXP Max(100Hz) 7.33 fps   
	HI257WriteCmosSensor(0xa6, 0xe6); 
	HI257WriteCmosSensor(0xa7, 0xE0);  
...
{		SENSORDB("[HI257]HI257NightMode Disable AE_FLICKER_MODE_60HZ\n");
	...
	HI257WriteCmosSensor(0x83, 0x0a);  //EXP Normal 9.33 fps 
	HI257WriteCmosSensor(0x84, 0xb6); 
	HI257WriteCmosSensor(0x85, 0x30); 

	HI257WriteCmosSensor(0x86, 0x01); //EXPMin 13000.00 fps*2 by paul
	HI257WriteCmosSensor(0x87, 0xf4); 
	
	HI257WriteCmosSensor(0x88, 0x0C); //EXP Max(120Hz) 9.00 fps 
	HI257WriteCmosSensor(0x89, 0x5C); 
	HI257WriteCmosSensor(0x8a, 0x10); 
	
	HI257WriteCmosSensor(0xa5, 0x0B); //EXP Max(100Hz) 9.33 fps   
	HI257WriteCmosSensor(0xa6, 0xe6); 
	HI257WriteCmosSensor(0xa7, 0xE0);  
