...
UINT32 OV5648MIPIOpen(void)
{
    ...
    otp_update_wb(0x14b, 0x142);//LINE <the values are the  truly module's  typical value> <20130828> <add the otp infomation> panzaoyan
    spin_lock(&ov5648mipi_drv_lock);
                      ...
                      MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
    ...
    SENSORDB("Exit!");
    OV5648MIPI_Set_Mirror_Flip(IMAGE_HV_MIRROR); //added by panzaoyan, 20130816
...
OV5648MIPI_Set_Mirror_Flip(IMAGE_HV_MIRROR); //LINE <SEFOS-305: the image's orientation is reversed when into zsd mode> <20130917> <> panzaoyan
...
//BEGIN <CTS Fail:testFocusAreas fail><20140225>xieqi
void OV5648MIPIGetAFMaxNumFocusAreas(UINT32 *pFeatureReturnPara32)
{	
    *pFeatureReturnPara32 = 0;    
    SENSORDB(" OV5648MIPIGetAFMaxNumFocusAreas, *pFeatureReturnPara32 = %d\n",  *pFeatureReturnPara32);

}

void OV5648MIPIGetAFMaxNumMeteringAreas(UINT32 *pFeatureReturnPara32)
{	
    *pFeatureReturnPara32 = 0;    
    SENSORDB(" OV5648MIPIGetAFMaxNumMeteringAreas,*pFeatureReturnPara32 = %d\n",  *pFeatureReturnPara32);

}

void OV5648MIPIGetExifInfo(UINT32 exifAddr)
{
...
//END <CTS Fail:testFocusAreas fail><20140225>xieqi
                             ...
                             UINT8 *pFeaturePara,UINT32 *pFeatureParaLen)
{
	...
	case SENSOR_FEATURE_GET_AF_MAX_NUM_FOCUS_AREAS:
	    OV5648MIPIGetAFMaxNumFocusAreas(pFeatureReturnPara32);            
	    *pFeatureParaLen=4;
	    break;     
	case SENSOR_FEATURE_GET_AE_MAX_NUM_METERING_AREAS:
	    OV5648MIPIGetAFMaxNumMeteringAreas(pFeatureReturnPara32);            
	    *pFeatureParaLen=4;
	    break;
	case SENSOR_FEATURE_GET_EXIF_INFO:
	    SENSORDB("SENSOR_FEATURE_GET_EXIF_INFO\n");
	    SENSORDB("EXIF addr = 0x%x\n",*pFeatureData32);          
	    OV5648MIPIGetExifInfo(*pFeatureData32);
	    break;
	//END <CTS Fail:testFocusAreas fail><20140225>xieqi		 
        default:
            break;
