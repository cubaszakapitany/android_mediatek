...
typedef struct
{
	...
	#else
	#define S5K3H7Y_PV_PERIOD_PIXEL_NUMS					(3688) //(0x0E68) 	// 0x0E68=3688
	#endif
	#define S5K3H7Y_PV_PERIOD_LINE_NUMS 					(2530) //(0x092E) //(0x0940)  	//(0x0940=2368
	
	//Video
	#define S5K3H7Y_VIDEO_PERIOD_PIXEL_NUMS					(S5K3H7Y_PV_PERIOD_PIXEL_NUMS) 	// 0x0E68=3688
	#define S5K3H7Y_VIDEO_PERIOD_LINE_NUMS					(2530) //(0x0928)  	//(0x0928=2344
	
	//Capture
	#define S5K3H7Y_FULL_PERIOD_PIXEL_NUMS					(S5K3H7Y_PV_PERIOD_PIXEL_NUMS)	//0x0E68=3688
	#ifdef FULL_SIZE_30_FPS
	#define S5K3H7Y_FULL_PERIOD_LINE_NUMS					(2530) //(0x092E)	//0x092E=2350
	#else		
...
#define S5K3H7YMIPI_WRITE_ID 	(0x5A)
#define S5K3H7YMIPI_READ_ID	(0x5B)
