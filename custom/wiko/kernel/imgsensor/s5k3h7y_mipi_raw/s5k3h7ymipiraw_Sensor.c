...
static kal_uint16 s5k3h7y_slave_addr = S5K3H7YMIPI_WRITE_ID2;
                                                                ...
                                                                UINT8 *pFeaturePara,UINT32 *pFeatureParaLen)
{
    ...
    switch (FeatureId)
    {
		...
		{
			*pFeaturePara = '\0';
			strcat(pFeaturePara, SENSOR_DRVNAME_S5K3H7Y_MIPI_RAW);
			strcat(pFeaturePara, "_" );
			strcat(pFeaturePara, s5k3h7y.vendor);
