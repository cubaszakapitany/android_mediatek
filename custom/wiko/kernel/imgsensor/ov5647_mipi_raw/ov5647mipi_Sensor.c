...
void OV5647MIPIGetAFMaxNumFocusAreas(UINT32 *pFeatureReturnPara32)
{	
    *pFeatureReturnPara32 = 0;    
    SENSORDB(" OV5647MIPIGetAFMaxNumFocusAreas, *pFeatureReturnPara32 = %d\n",  *pFeatureReturnPara32);

}

void OV5647MIPIGetAFMaxNumMeteringAreas(UINT32 *pFeatureReturnPara32)
{	
    *pFeatureReturnPara32 = 0;    
    SENSORDB(" OV5647MIPIGetAFMaxNumMeteringAreas,*pFeatureReturnPara32 = %d\n",  *pFeatureReturnPara32);

}

void OV5647MIPIGetExifInfo(UINT32 exifAddr)
{
							 ...
							 UINT8 *pFeaturePara,UINT32 *pFeatureParaLen)
{
	...
	switch (FeatureId)
	{
		...
		case SENSOR_FEATURE_GET_AF_MAX_NUM_FOCUS_AREAS:
		    OV5647MIPIGetAFMaxNumFocusAreas(pFeatureReturnPara32);            
		    *pFeatureParaLen=4;
		    break;     
		case SENSOR_FEATURE_GET_AE_MAX_NUM_METERING_AREAS:
		    OV5647MIPIGetAFMaxNumMeteringAreas(pFeatureReturnPara32);            
		    *pFeatureParaLen=4;
		    break;
		case SENSOR_FEATURE_GET_EXIF_INFO:
		    SENSORDB("SENSOR_FEATURE_GET_EXIF_INFO\n");
		    SENSORDB("EXIF addr = 0x%x\n",*pFeatureData32);          
		    OV5647MIPIGetExifInfo(*pFeatureData32);
		    break;
		//END <CTS Fail:testFocusAreas fail><20140225>xieqi			
		default:
			break;
