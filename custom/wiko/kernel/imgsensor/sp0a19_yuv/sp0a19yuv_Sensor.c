...
{  	//update param by sp_yjp,20131123
	...
	SP0A19_write_cmos_sensor(0x3d,0x12);
	SP0A19_write_cmos_sensor(0x3e,0x12);
	SP0A19_write_cmos_sensor(0x3f,0x12);
	SP0A19_write_cmos_sensor(0x40,0x15);
	...
	SP0A19_write_cmos_sensor(0x4b,0x0a);
	...
	SP0A19_write_cmos_sensor(0x17,0x2a);
	SP0A19_write_cmos_sensor(0x18,0x2c);
	...
	SP0A19_write_cmos_sensor(0x65,0xbb);
	SP0A19_write_cmos_sensor(0x66,0xe5);
	SP0A19_write_cmos_sensor(0x67,0x78);
	SP0A19_write_cmos_sensor(0x68,0x98);

	SP0A19_write_cmos_sensor(0x69,0xa5);
	SP0A19_write_cmos_sensor(0x6a,0xd5);
	SP0A19_write_cmos_sensor(0x6b,0x99);
	SP0A19_write_cmos_sensor(0x6c,0xca);

	SP0A19_write_cmos_sensor(0x61,0x67);
	SP0A19_write_cmos_sensor(0x62,0x85);
	SP0A19_write_cmos_sensor(0x63,0xc0);
	SP0A19_write_cmos_sensor(0x64,0xdf);

	SP0A19_write_cmos_sensor(0x6d,0xaa);
	SP0A19_write_cmos_sensor(0x6e,0xcf);
	SP0A19_write_cmos_sensor(0x6f,0xb5);
	SP0A19_write_cmos_sensor(0x70,0xd9);
	...
	SP0A19_write_cmos_sensor(0x0f,0x50);
	...
	SP0A19_write_cmos_sensor(0x9a,0xE4);
	SP0A19_write_cmos_sensor(0x9b,0xEA);
	SP0A19_write_cmos_sensor(0xfd,0x01);
	SP0A19_write_cmos_sensor(0x8d,0xF1);
	SP0A19_write_cmos_sensor(0x8e,0xF6);
	SP0A19_write_cmos_sensor(0xfd,0x00);
	...
	SP0A19_write_cmos_sensor(0x9c,0x80);
	...
	SP0A19_write_cmos_sensor(0xef,0x70);
	SP0A19_write_cmos_sensor(0xf9,0x6c);
	SP0A19_write_cmos_sensor(0xfa,0x64);
	SP0A19_write_cmos_sensor(0xee,0x60);
	...
	SP0A19_write_cmos_sensor(0xfd,0x00);
	SP0A19_write_cmos_sensor(0xb2,0x15);
	SP0A19_write_cmos_sensor(0xb3,0x1f);
	...
	SP0A19_write_cmos_sensor(0xd7,0x78);
	...
	SP0A19_write_cmos_sensor(0xfd,0x01);
	SP0A19_write_cmos_sensor(0x13,0x00);
	SP0A19SetMirror(IMAGE_SENSOR_MIRROR_HV); //guomingyi20140410 add. change mirror
}
...
BOOL SP0A19_set_param_wb(UINT16 para)
{
	...
	{            
		case AWB_MODE_AUTO:
			...
			SP0A19_write_cmos_sensor(0xfd,0x01);  
  			SP0A19_write_cmos_sensor(0x28,0xc5);  //0xc9     //modify by sp_yjp,20131123                                                   
			SP0A19_write_cmos_sensor(0x29,0x9b);  //0x98
...
BOOL SP0A19_set_param_exposure(UINT16 para)
{
	...
	switch (para)
	{
		...
		case AE_EV_COMP_13:  
			SP0A19_write_cmos_sensor(0xfd,0x00);
  			SP0A19_write_cmos_sensor(0xdc,0x30);//0x20 kavie 20131220
  			break;
		case AE_EV_COMP_10:  
		case AE_EV_COMP_07:  
		case AE_EV_COMP_03: 
			#if 1
			  SP0A19_write_cmos_sensor(0xfd,0x00);
			  SP0A19_write_cmos_sensor(0xdc,0x10);//0x20 kavie 20131220
			#else
			//ae target
			  SP0A19_write_cmos_sensor(0xfd,0x00); 
		...
		case AE_EV_COMP_n10:
			  SP0A19_write_cmos_sensor(0xfd,0x00);
			  SP0A19_write_cmos_sensor(0xdc,0xe0);//0x20 kavie 20131220
			  break;
		case AE_EV_COMP_n07:	
		case AE_EV_COMP_n13:
		case AE_EV_COMP_n20:
			  #if 1
			  SP0A19_write_cmos_sensor(0xfd,0x00);
			  SP0A19_write_cmos_sensor(0xdc,0xd0);//0xe0 kavie 20131220  
			  #else
			//ae target
			  SP0A19_write_cmos_sensor(0xfd,0x00); 
