...
Ver:2.2 2014/1/26 SuperPix Yuanjianping
(1)按客户邓工发过来的HAL层config文件添加对比度、饱和度、亮度及ISO参数；
...
{	
	...
	{
                 SP2519_write_cmos_sensor(0xfd,0x01);	
		SP2519_write_cmos_sensor(0x32, 0x15);//(temp_AWB_reg |0x05));
	}
	else if(enable == 0)
	{
               SP2519_write_cmos_sensor(0xfd,0x01);	
		SP2519_write_cmos_sensor(0x32,0x05);//(temp_AWB_reg & (~0x05)));
	}
#endif
}
...
void SP2519_Sensor_Init(void)
{
	...
	SP2519_write_cmos_sensor(0x1f,0x30);
	SP2519_write_cmos_sensor(0x30,0x00);
	...
	SP2519_write_cmos_sensor(0xeb,0x74);
	SP2519_write_cmos_sensor(0xec,0x64);
	...
	SP2519_write_cmos_sensor(0xcc,0x08);
	SP2519_write_cmos_sensor(0xcd,0x0c);
	SP2519_write_cmos_sensor(0xce,0x14);
	...
	SP2519_write_cmos_sensor(0xe8,0x5c);
	SP2519_write_cmos_sensor(0xec,0x6c);
	SP2519_write_cmos_sensor(0xe9,0x64);
	SP2519_write_cmos_sensor(0xed,0x6c);
	
	SP2519_write_cmos_sensor(0xea,0x5c);
	SP2519_write_cmos_sensor(0xee,0x64);
	...
	SP2519_write_cmos_sensor(0x82,0x65);
	SP2519_write_cmos_sensor(0x83,0x53);
	...
	SP2519_write_cmos_sensor(0x8d,0x1b);
	SP2519_write_cmos_sensor(0x8e,0x2c);
	SP2519_write_cmos_sensor(0x8f,0x39);
	SP2519_write_cmos_sensor(0x90,0x4a);
	SP2519_write_cmos_sensor(0x91,0x59);
	SP2519_write_cmos_sensor(0x92,0x64);
	SP2519_write_cmos_sensor(0x93,0x6e);
	SP2519_write_cmos_sensor(0x94,0x7f);
	SP2519_write_cmos_sensor(0x95,0x8e);
	SP2519_write_cmos_sensor(0x96,0x9d);
	SP2519_write_cmos_sensor(0x97,0xa9);
	SP2519_write_cmos_sensor(0x98,0xb6);
	SP2519_write_cmos_sensor(0x99,0xc1);
	SP2519_write_cmos_sensor(0x9a,0xcc);
	SP2519_write_cmos_sensor(0x9b,0xd4);
	SP2519_write_cmos_sensor(0x9c,0xdc);
	SP2519_write_cmos_sensor(0x9d,0xe4);
	SP2519_write_cmos_sensor(0x9e,0xeb);
	SP2519_write_cmos_sensor(0x9f,0xf1);
	SP2519_write_cmos_sensor(0xa0,0xf7); 
	
	SP2519_write_cmos_sensor(0xfd,0x02); 
	SP2519_write_cmos_sensor(0x15,0xC8); 
	SP2519_write_cmos_sensor(0x16,0x95); 
	                                                                                       
	SP2519_write_cmos_sensor(0xa0,0xa0);                                                           
	SP2519_write_cmos_sensor(0xa1,0xf4);                                                           
	SP2519_write_cmos_sensor(0xa2,0xec);                                                           
	SP2519_write_cmos_sensor(0xa3,0xf4);                                                           
	SP2519_write_cmos_sensor(0xa4,0x8c);                                                           
	SP2519_write_cmos_sensor(0xa5,0x00);                                                           
	SP2519_write_cmos_sensor(0xa6,0xf4);                                                           
	SP2519_write_cmos_sensor(0xa7,0xda);                                                           
	SP2519_write_cmos_sensor(0xa8,0xb2);                                                           
	SP2519_write_cmos_sensor(0xa9,0x3c);                                                      
	SP2519_write_cmos_sensor(0xaa,0x03);                                                           
	SP2519_write_cmos_sensor(0xab,0x0f);                                                                                                                                                 
	SP2519_write_cmos_sensor(0xac,0xa0);                                                                      
	SP2519_write_cmos_sensor(0xad,0xf4);                                                                      
	SP2519_write_cmos_sensor(0xae,0xec);                                                                      
	SP2519_write_cmos_sensor(0xaf,0xf4);                                                                      
	SP2519_write_cmos_sensor(0xb0,0x8c);                                                                      
	SP2519_write_cmos_sensor(0xb1,0x00);                                                                      
	SP2519_write_cmos_sensor(0xb2,0xf4);                                                                      
	SP2519_write_cmos_sensor(0xb3,0xda);                                                                      
	SP2519_write_cmos_sensor(0xb4,0xb2);                                                                      
	SP2519_write_cmos_sensor(0xb5,0x3c);                                                                      
	SP2519_write_cmos_sensor(0xb6,0x03);                                                                      
	SP2519_write_cmos_sensor(0xb7,0x0f);
	
	SP2519_write_cmos_sensor(0xfd,0x01);
	SP2519_write_cmos_sensor(0xd2,0x2f);
	...
	SP2519_write_cmos_sensor(0xfd,0x01);
	SP2519_write_cmos_sensor(0xd3,0xa8);
	SP2519_write_cmos_sensor(0xd4,0xa8);
	SP2519_write_cmos_sensor(0xd5,0xa0);
	SP2519_write_cmos_sensor(0xd6,0x90);
	SP2519_write_cmos_sensor(0xd7,0xa8);
	SP2519_write_cmos_sensor(0xd8,0xa8);
	...
	SP2519_write_cmos_sensor(0x10,0x84);
	SP2519_write_cmos_sensor(0x11,0x84);
	SP2519_write_cmos_sensor(0x12,0x84);
	SP2519_write_cmos_sensor(0x13,0x84);
	SP2519_write_cmos_sensor(0x14,0xa0);
	SP2519_write_cmos_sensor(0x15,0xa0);
	SP2519_write_cmos_sensor(0x16,0x98);
	SP2519_write_cmos_sensor(0x17,0x90);
...
*/
   /*	SP2519_write_cmos_sensor(0xfd,0x01);	
	SP2519_write_cmos_sensor(0x32,0x6c);
         mDELAY(100);
        SP2519_write_cmos_sensor(0xfd , 0x00);
	temp_reg2 = SP2519_read_cmos_sensor(0x04);
	temp_reg1 = SP2519_read_cmos_sensor(0x03);
	
	temp_reg5 =SP2519_read_cmos_sensor(0x23);

	temp_reg6 = (temp_reg1 << 8)|temp_reg2 ;
	temp_reg7 = temp_reg6*3;
	   
	//SP2519_write_cmos_sensor(0xfd,0x01);	
	//SP2519_write_cmos_sensor(0x32,0x14);
               	
     // shutter=SP2519_read_cmos_sensor(0x32);
...
*/
        SP2519_write_cmos_sensor(0xfd,0x01);	
	SP2519_write_cmos_sensor(0xcd,0x50);
...
void SP2519_set_contrast(UINT16 para)
{
	...
	case ISP_CONTRAST_MIDDLE:
		...
		SP2519_write_cmos_sensor(0x16,0xa4);
