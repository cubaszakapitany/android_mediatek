...
int kdCISModulePowerOn(CAMERA_DUAL_CAMERA_SENSOR_ENUM SensorIdx, char *currSensorName, BOOL On, char* mode_name)
{
	...
	if ((currSensorName && (0 == strcmp(SENSOR_DRVNAME_HI257_YUV,currSensorName)))
		||(currSensorName && (0 == strcmp(SENSOR_DRVNAME_SP2519_YUV,currSensorName)))
		||(currSensorName && (0 == strcmp(SENSOR_DRVNAME_SP0A19_YUV,currSensorName))) && (0 == pinSetIdx))   
       {
...
*/
			...
			||(currSensorName && (0 == strcmp(SENSOR_DRVNAME_SP0A18_YUV,currSensorName))) && (1 == pinSetIdx))    
       {  
