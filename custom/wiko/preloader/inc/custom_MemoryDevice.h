...
//#define CS_PART_NUMBER[1]	  SD5C28B_16G_MMD2
#define CS_PART_NUMBER[0]       H9TP17A8JDACNR_KGM_MMD2
#define CS_PART_NUMBER[1]       H9TCNNNBLDMMPR_mmd2
#define CS_PART_NUMBER[2]       EDBA232B1MA_MMD2
