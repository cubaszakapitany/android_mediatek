...
(1)SP0A19:按黄工要求，当前项目使用TXD和TKC的屏，三赢兴和凯木金的模组，互相混用，效果需差不多；

S4050
主观效果
Ver.2.1	2015/3/23	SP_CGJ
1.只调用SP0A19_init_para_TXD();	屏蔽SP0A19_init_para_TKC();	
Ver.2.2	2015/4/8	邋邋邋SP_CGJ
1.饱和度、亮度等low/middle/high都用同一组参数
...
static unsigned int SP0A19_GetLCMID(void)
{
    unsigned int id = 0;
    ...
    SENSORDB("SP0A19 LINE=%d %s, id1 = 0x%08x\n",__LINE__,__func__, id);   

    if(adcVol > 1300 && adcVol < 1400) /*tkc adcVol = 1390*/
    {
        return 1; //tkc
    }
    else
    {
        return 0; //txd adcVol > 550 && adcVol < 1300
    }
}

 //txd 
static void SP0A19_init_para_TXD(void)
{   ////update param by sp_yjp,20140122
	SP0A19_write_cmos_sensor(0xfd,0x00);
	...
	SP0A19_write_cmos_sensor(0x2e,0x00);
	SP0A19_write_cmos_sensor(0x2f,0x00);
	...
	SP0A19_write_cmos_sensor(0x74,0x04);

	SP0A19_write_cmos_sensor(0x1a,0x80);
	SP0A19_write_cmos_sensor(0x1b,0x8c);

	SP0A19_write_cmos_sensor(0x65,0xcd);
	SP0A19_write_cmos_sensor(0x66,0xf0);
	SP0A19_write_cmos_sensor(0x67,0x7a);
	SP0A19_write_cmos_sensor(0x68,0x90);

	SP0A19_write_cmos_sensor(0x69,0xab);
	SP0A19_write_cmos_sensor(0x6a,0xdb);
	SP0A19_write_cmos_sensor(0x6b,0x90);
	SP0A19_write_cmos_sensor(0x6c,0xbb);

	SP0A19_write_cmos_sensor(0x61,0x83);
	SP0A19_write_cmos_sensor(0x62,0xa0);
	SP0A19_write_cmos_sensor(0x63,0xbf);
	SP0A19_write_cmos_sensor(0x64,0xd0);
	...
	SP0A19_write_cmos_sensor(0x0f,0x78);
	SP0A19_write_cmos_sensor(0x59,0x04);
	SP0A19_write_cmos_sensor(0xfd,0x00);
	...
	SP0A19_write_cmos_sensor(0xfd,0x00);
	 ...
	 SP0A19_write_cmos_sensor(0x59,0x20);
			
	 SP0A19_write_cmos_sensor(0x89,0x06);
	 SP0A19_write_cmos_sensor(0x8a,0x0a);
	 SP0A19_write_cmos_sensor(0x9c,0x12);
	 SP0A19_write_cmos_sensor(0x9d,0x20);
			
	 SP0A19_write_cmos_sensor(0x81,0xe0);
	 SP0A19_write_cmos_sensor(0x82,0x90);
	 SP0A19_write_cmos_sensor(0x83,0x60);
	 SP0A19_write_cmos_sensor(0x84,0x08);
			
	 SP0A19_write_cmos_sensor(0x85,0xe0);
	 SP0A19_write_cmos_sensor(0x86,0x90);
	 SP0A19_write_cmos_sensor(0x87,0x60);
	 SP0A19_write_cmos_sensor(0x88,0x08);
			
	 SP0A19_write_cmos_sensor(0x5a,0xff);
	 SP0A19_write_cmos_sensor(0x5b,0x90);
	 SP0A19_write_cmos_sensor(0x5c,0x60);
	 SP0A19_write_cmos_sensor(0x5d,0x08);
	...
	SP0A19_write_cmos_sensor(0xe5,0x06);
	SP0A19_write_cmos_sensor(0xd3,0x06);
	SP0A19_write_cmos_sensor(0xd7,0x06);
	       
	SP0A19_write_cmos_sensor(0xe6,0x08);
	SP0A19_write_cmos_sensor(0xd4,0x08);
	SP0A19_write_cmos_sensor(0xd8,0x08);
	...
	SP0A19_write_cmos_sensor(0xd9,0x12);
	 ...
	 SP0A19_write_cmos_sensor(0xe8,0x2c);
	 SP0A19_write_cmos_sensor(0xec,0x38);
			
	 SP0A19_write_cmos_sensor(0xe9,0x2c);
	 SP0A19_write_cmos_sensor(0xed,0x38);
			
	 SP0A19_write_cmos_sensor(0xea,0x28);
	 SP0A19_write_cmos_sensor(0xef,0x2c);
			
	 SP0A19_write_cmos_sensor(0xeb,0x18);
	 SP0A19_write_cmos_sensor(0xf0,0x24);
			
	 SP0A19_write_cmos_sensor(0xfd,0x01);
	 SP0A19_write_cmos_sensor(0xa0,0x8b);//0x8b);
	 SP0A19_write_cmos_sensor(0xa1,0x00);//0x00);
	 SP0A19_write_cmos_sensor(0xa2,0xf5);//0xe6);
	 SP0A19_write_cmos_sensor(0xa3,0xf3);//0xf3);
	 SP0A19_write_cmos_sensor(0xa4,0x81);//0x8e);
	 SP0A19_write_cmos_sensor(0xa5,0x0b);//0x00);
	 SP0A19_write_cmos_sensor(0xa6,0x00);//0x00);
	 SP0A19_write_cmos_sensor(0xa7,0xe6);//0xe6);
	 SP0A19_write_cmos_sensor(0xa8,0x9a);//0x9a);
	 SP0A19_write_cmos_sensor(0xa9,0x30);//0x30);
	 SP0A19_write_cmos_sensor(0xaa,0x03);//0x03);
	 SP0A19_write_cmos_sensor(0xab,0x0c);//0x0c);
	 SP0A19_write_cmos_sensor(0xfd,0x00);
	 ...
	 SP0A19_write_cmos_sensor(0x95,0xb8);
	 SP0A19_write_cmos_sensor(0x96,0xc3);
	 ...
	 SP0A19_write_cmos_sensor(0x9b,0xed);
	 SP0A19_write_cmos_sensor(0xfd,0x01);
	 SP0A19_write_cmos_sensor(0x8d,0xf1);
	 SP0A19_write_cmos_sensor(0x8e,0xf4);
	 SP0A19_write_cmos_sensor(0xfd,0x00);
	 ...
	 SP0A19_write_cmos_sensor(0xfd,0x00);
	 SP0A19_write_cmos_sensor(0xed,0x98);
	 SP0A19_write_cmos_sensor(0xf7,0x94);
	 SP0A19_write_cmos_sensor(0xf8,0x8c);
	 SP0A19_write_cmos_sensor(0xec,0x88);
			
	 SP0A19_write_cmos_sensor(0xef,0x88);
	 SP0A19_write_cmos_sensor(0xf9,0x84);
	 SP0A19_write_cmos_sensor(0xfa,0x7c);
	 SP0A19_write_cmos_sensor(0xee,0x78);
	 ...
	 SP0A19_write_cmos_sensor(0x4e,0x28);
	 ...
	 SP0A19_write_cmos_sensor(0xb5,0x65);
	 ...
	 SP0A19_write_cmos_sensor(0xd3,0x84);
	 SP0A19_write_cmos_sensor(0xd4,0x84);
...
//tkc 信利模组验证
static void SP0A19_init_para_TKC(void)
{
		SP0A19_write_cmos_sensor(0xfd,0x00);
		SP0A19_write_cmos_sensor(0x1C,0x28);
		SP0A19_write_cmos_sensor(0x32,0x00);
		...
		SP0A19_write_cmos_sensor(0xca,0x30);
		SP0A19_write_cmos_sensor(0xcb,0x45);
		SP0A19_write_cmos_sensor(0xcc,0x90);
		SP0A19_write_cmos_sensor(0xcd,0x48);
		SP0A19_write_cmos_sensor(0xfd,0x00);
		...
		SP0A19_write_cmos_sensor(0x9d,0x18);
			
		SP0A19_write_cmos_sensor(0x81,0xe0);
		SP0A19_write_cmos_sensor(0x82,0xb0);
		SP0A19_write_cmos_sensor(0x83,0x70);
		SP0A19_write_cmos_sensor(0x84,0x10);
			
		SP0A19_write_cmos_sensor(0x85,0xe0);
		SP0A19_write_cmos_sensor(0x86,0xb0);
		SP0A19_write_cmos_sensor(0x87,0x70);
		SP0A19_write_cmos_sensor(0x88,0x10);
			
		SP0A19_write_cmos_sensor(0x5a,0xff);
		SP0A19_write_cmos_sensor(0x5b,0xb0);
		SP0A19_write_cmos_sensor(0x5c,0x90);
		SP0A19_write_cmos_sensor(0x5d,0x40);
		...
		SP0A19_write_cmos_sensor(0xe8,0x28);
		SP0A19_write_cmos_sensor(0xec,0x34);
			
		SP0A19_write_cmos_sensor(0xe9,0x28);
		SP0A19_write_cmos_sensor(0xed,0x34);
			
		SP0A19_write_cmos_sensor(0xea,0x20);
		SP0A19_write_cmos_sensor(0xef,0x24);
			
		SP0A19_write_cmos_sensor(0xeb,0x1c);
		SP0A19_write_cmos_sensor(0xf0,0x20);
			
		SP0A19_write_cmos_sensor(0xfd,0x01);
		SP0A19_write_cmos_sensor(0xa0,0x90);
		SP0A19_write_cmos_sensor(0xa1,0x00);
		SP0A19_write_cmos_sensor(0xa2,0xe6);
		...
		SP0A19_write_cmos_sensor(0x98,0xD0);
		SP0A19_write_cmos_sensor(0x99,0xD9);
		SP0A19_write_cmos_sensor(0x9a,0xE2);
		SP0A19_write_cmos_sensor(0x9b,0xE8);
		SP0A19_write_cmos_sensor(0xfd,0x01);
		SP0A19_write_cmos_sensor(0x8d,0xF0);
		SP0A19_write_cmos_sensor(0x8e,0xF4);
		SP0A19_write_cmos_sensor(0xfd,0x00);
...
{  
	...
	#if 0	//sp_cgj	20150323
    if(0 == SP0A19_GetLCMID())
        SP0A19_init_para_TXD();
	else
	    SP0A19_init_para_TKC();
	#else
	SP0A19_init_para_TXD();
	#endif
}       
...
BOOL SP0A19_set_param_exposure(UINT16 para)
{
	...
	sensor_exposure=SP0A19_read_cmos_sensor(0xdc);
    SENSORDB("-------- SP0A19Open sensor_exposure = %x --------\n", sensor_exposure);
...
void SP0A19_set_saturation(UINT16 para)
{
    ...
    switch (para)
    {
        ...
        case ISP_SAT_HIGH:
			...
			SP0A19_write_cmos_sensor(0xd7,0x70);
			/*
			SP0A19_write_cmos_sensor(0xd3,0x84+0x20); //outdoor 
			SP0A19_write_cmos_sensor(0xd4,0x84+0x20); //normal 
			SP0A19_write_cmos_sensor(0xd6,0x70+0x20); //dummy
			SP0A19_write_cmos_sensor(0xd7,0x70+0x20); //low light
			*/
             break;
        ...
        case ISP_SAT_LOW:
			...
			SP0A19_write_cmos_sensor(0xd7,0x70);
			/*
			SP0A19_write_cmos_sensor(0xd3,0x84-0x20); 
			SP0A19_write_cmos_sensor(0xd4,0x84-0x20); 
			SP0A19_write_cmos_sensor(0xd6,0x70-0x20); 
			SP0A19_write_cmos_sensor(0xd7,0x70-0x20);
			*/
             break;
	...
	sensor_saturation=SP0A19_read_cmos_sensor(0xd3);
    SENSORDB("-------- SP0A19Open sensor_saturation = %x --------\n", sensor_saturation);
...
void SP0A19_set_contrast(UINT16 para)
{
	...
	sensor_contrast=SP0A19_read_cmos_sensor(0xdd);
    SENSORDB("-------- SP0A19Open sensor_contrast = %x --------\n", sensor_contrast);
...
void SP0A19_set_brightness(UINT16 para)
{
    ...
    switch (para)
    {
        ...
        case ISP_BRIGHT_LOW:
			...
			SP0A19_write_cmos_sensor(0xee,0x78);
			/*
			SP0A19_write_cmos_sensor(0xed,0x98-0x10);
			SP0A19_write_cmos_sensor(0xf7,0x94-0x10);
			SP0A19_write_cmos_sensor(0xf8,0x8c-0x10);
			SP0A19_write_cmos_sensor(0xec,0x88-0x10);
				
			SP0A19_write_cmos_sensor(0xef,0x88-0x10);
			SP0A19_write_cmos_sensor(0xf9,0x84-0x10);
			SP0A19_write_cmos_sensor(0xfa,0x7c-0x10);
			SP0A19_write_cmos_sensor(0xee,0x78-0x10);
			*/
             break;
	...
	sensor_brightness=SP0A19_read_cmos_sensor(0xf7);
    SENSORDB("-------- SP0A19Open sensor_brightness = %x --------\n", sensor_brightness);
        ...
        UINT8 *pFeaturePara,UINT32 *pFeatureParaLen)
{
	...
	#ifndef SP0A19_LOAD_FROM_T_FLASH
