...
S4050
主观效果
Ver.3.0	2015/3/23	SP_CGJ
1.更新部分svn参数
2.优化效果
Ver.3.1	2015/3/24	SP_CGJ
Ver.3.2	2015/3/27	SP_CGJ
1.修改indoor区间
2.修改饱和度
Ver.3.3 	2015/4/8	SP_CGJ
1.主观AWB跑偏
2.shading四角偏黄
3.录像帧率低,	 打开SP2519_24M_48M_Video_binning
Ver.3.4	2015/4/9	SP_CGJ
1.室外绿色太绿，降低CCM绿色分量
2.稍微修改cwf区间
...
#define RETAILMSG(x,...)
#define TEXT
#define FLASH_BV_THRESHOLD 	0x65     //Flash on threshold 

#define SP2519_24M_48M_Video_binning
...
void SP2519_config_window(kal_uint8 index)
{
	...
	switch(index)
	{
		case WINDOW_SIZE_UXGA:
			...
			SP2519_write_cmos_sensor(0x30,0x08);//00 
...
void SP2519_night_mode(kal_bool bEnable)
{
	...
	if (bEnable)/*night mode settings*/
	{
		...
		if(SP2519_MPEG4_encode_mode == KAL_TRUE) /*video night mode*/
		{
...
#elif defined(SP2519_24M_48M_Video_binning)
			//24M 2pll 50Hz binning night 14fps 
			//sp_cgj	20150408
			
			SP2519_write_cmos_sensor(0xfd , 0x00);  
			SP2519_write_cmos_sensor(0x03 , 0x04);  
			SP2519_write_cmos_sensor(0x04 , 0x14);  
			SP2519_write_cmos_sensor(0x05 , 0x00);  
			SP2519_write_cmos_sensor(0x06 , 0x00);  
			SP2519_write_cmos_sensor(0x07 , 0x00);  
			SP2519_write_cmos_sensor(0x08 , 0x00);  
			SP2519_write_cmos_sensor(0x09 , 0x03);  
			SP2519_write_cmos_sensor(0x0a , 0x5e);  
			SP2519_write_cmos_sensor(0xfd , 0x01);  
			SP2519_write_cmos_sensor(0xf0 , 0x00);  
			SP2519_write_cmos_sensor(0xf7 , 0xae);  
			SP2519_write_cmos_sensor(0xf8 , 0x91);  
			SP2519_write_cmos_sensor(0x02 , 0x07);  
			SP2519_write_cmos_sensor(0x03 , 0x01);  
			SP2519_write_cmos_sensor(0x06 , 0xae);  
			SP2519_write_cmos_sensor(0x07 , 0x00);  
			SP2519_write_cmos_sensor(0x08 , 0x01);  
			SP2519_write_cmos_sensor(0x09 , 0x00);  
			SP2519_write_cmos_sensor(0xfd , 0x02);  
			SP2519_write_cmos_sensor(0x3d , 0x08);  
			SP2519_write_cmos_sensor(0x3e , 0x91);  
			SP2519_write_cmos_sensor(0x3f , 0x00);  
			SP2519_write_cmos_sensor(0x88 , 0xf1);  
			SP2519_write_cmos_sensor(0x89 , 0x87);  
			SP2519_write_cmos_sensor(0x8a , 0x32);  
			SP2519_write_cmos_sensor(0xfd , 0x02);  
			SP2519_write_cmos_sensor(0xbe , 0xc2);  
			SP2519_write_cmos_sensor(0xbf , 0x04);  
			SP2519_write_cmos_sensor(0xd0 , 0xc2);  
			SP2519_write_cmos_sensor(0xd1 , 0x04);  
			SP2519_write_cmos_sensor(0xc9 , 0xc2);  
			SP2519_write_cmos_sensor(0xca , 0x04);  
#else                                                                 
...
#elif defined(SP2519_24M_48M_Video_binning)
			//24M 2pll 60Hz binning night 14fps 
			//sp_cgj	20150408
			
			SP2519_write_cmos_sensor(0xfd , 0x00);
			SP2519_write_cmos_sensor(0x03 , 0x03);
			SP2519_write_cmos_sensor(0x04 , 0x66);
			SP2519_write_cmos_sensor(0x05 , 0x00);
			SP2519_write_cmos_sensor(0x06 , 0x00);
			SP2519_write_cmos_sensor(0x07 , 0x00);
			SP2519_write_cmos_sensor(0x08 , 0x00);
			...
			SP2519_write_cmos_sensor(0xfd , 0x01);
			SP2519_write_cmos_sensor(0xf0 , 0x00);
			SP2519_write_cmos_sensor(0xf7 , 0x91);
			SP2519_write_cmos_sensor(0xf8 , 0x91);
			SP2519_write_cmos_sensor(0x02 , 0x08);
			SP2519_write_cmos_sensor(0x03 , 0x01);
			SP2519_write_cmos_sensor(0x06 , 0x91);
			SP2519_write_cmos_sensor(0x07 , 0x00);
			SP2519_write_cmos_sensor(0x08 , 0x01);
			SP2519_write_cmos_sensor(0x09 , 0x00);
			SP2519_write_cmos_sensor(0xfd , 0x02);
			...
			SP2519_write_cmos_sensor(0x3e , 0x91);
			SP2519_write_cmos_sensor(0x3f , 0x00);
			SP2519_write_cmos_sensor(0x88 , 0x87);
			SP2519_write_cmos_sensor(0x89 , 0x87);
			SP2519_write_cmos_sensor(0x8a , 0x33);
			SP2519_write_cmos_sensor(0xfd , 0x02);
			SP2519_write_cmos_sensor(0xbe , 0x88);
			SP2519_write_cmos_sensor(0xbf , 0x04);
			SP2519_write_cmos_sensor(0xd0 , 0x88);
			SP2519_write_cmos_sensor(0xd1 , 0x04);
			SP2519_write_cmos_sensor(0xc9 , 0x88);
			SP2519_write_cmos_sensor(0xca , 0x04);			 
#else
	...
	else /*normal mode settings*/
	{
		...
		if (SP2519_MPEG4_encode_mode == KAL_TRUE) 
		{
			...
			SP2519_write_cmos_sensor(0xca , 0x04);
#elif defined(SP2519_24M_48M_Video_binning)
			//24M 2pll 50Hz binning daylight 16fps 
			//sp_cgj	20150408		
			
			SP2519_write_cmos_sensor(0xfd , 0x00);  
			SP2519_write_cmos_sensor(0x03 , 0x04);  
			SP2519_write_cmos_sensor(0x04 , 0xa4);  
			SP2519_write_cmos_sensor(0x05 , 0x00);  
			SP2519_write_cmos_sensor(0x06 , 0x00);  
			SP2519_write_cmos_sensor(0x07 , 0x00);  
			SP2519_write_cmos_sensor(0x08 , 0x00);  
			SP2519_write_cmos_sensor(0x09 , 0x02);  
			SP2519_write_cmos_sensor(0x0a , 0xb7);  
			SP2519_write_cmos_sensor(0xfd , 0x01);  
			SP2519_write_cmos_sensor(0xf0 , 0x00);  
			SP2519_write_cmos_sensor(0xf7 , 0xc6);  
			SP2519_write_cmos_sensor(0xf8 , 0xa5);  
			SP2519_write_cmos_sensor(0x02 , 0x06);  
			SP2519_write_cmos_sensor(0x03 , 0x01);  
			SP2519_write_cmos_sensor(0x06 , 0xc6);  
			SP2519_write_cmos_sensor(0x07 , 0x00);  
			SP2519_write_cmos_sensor(0x08 , 0x01);  
			SP2519_write_cmos_sensor(0x09 , 0x00);  
			SP2519_write_cmos_sensor(0xfd , 0x02);  
			SP2519_write_cmos_sensor(0x3d , 0x07);  
			SP2519_write_cmos_sensor(0x3e , 0xa5);  
			SP2519_write_cmos_sensor(0x3f , 0x00);  
			SP2519_write_cmos_sensor(0x88 , 0x95);  
			SP2519_write_cmos_sensor(0x89 , 0x1a);  
			SP2519_write_cmos_sensor(0x8a , 0x32);  
			SP2519_write_cmos_sensor(0xfd , 0x02);  
			...
			SP2519_write_cmos_sensor(0xca , 0x04);
#elif defined(SP2519_24M_48M_Video_binning)
			//24M 2pll 60Hz binning daylight 16fps 
			//sp_cgj	20150408			
			
			SP2519_write_cmos_sensor(0xfd , 0x00); 
			SP2519_write_cmos_sensor(0x03 , 0x03); 
			SP2519_write_cmos_sensor(0x04 , 0xde); 
			SP2519_write_cmos_sensor(0x05 , 0x00); 
			SP2519_write_cmos_sensor(0x06 , 0x00); 
			SP2519_write_cmos_sensor(0x07 , 0x00); 
			SP2519_write_cmos_sensor(0x08 , 0x00); 
			...
			SP2519_write_cmos_sensor(0xfd , 0x01); 
			SP2519_write_cmos_sensor(0xf0 , 0x00); 
			SP2519_write_cmos_sensor(0xf7 , 0xa5); 
			SP2519_write_cmos_sensor(0xf8 , 0xa5); 
			SP2519_write_cmos_sensor(0x02 , 0x07); 
			SP2519_write_cmos_sensor(0x03 , 0x01); 
			SP2519_write_cmos_sensor(0x06 , 0xa5); 
			SP2519_write_cmos_sensor(0x07 , 0x00); 
			SP2519_write_cmos_sensor(0x08 , 0x01); 
			SP2519_write_cmos_sensor(0x09 , 0x00); 
			SP2519_write_cmos_sensor(0xfd , 0x02); 
			...
			SP2519_write_cmos_sensor(0x3e , 0xa5); 
			SP2519_write_cmos_sensor(0x3f , 0x00); 
			SP2519_write_cmos_sensor(0x88 , 0x1a); 
			SP2519_write_cmos_sensor(0x89 , 0x1a); 
			SP2519_write_cmos_sensor(0x8a , 0x33); 
			SP2519_write_cmos_sensor(0xfd , 0x02); 
			SP2519_write_cmos_sensor(0xbe , 0x83); 
			SP2519_write_cmos_sensor(0xbf , 0x04); 
			SP2519_write_cmos_sensor(0xd0 , 0x83); 
			SP2519_write_cmos_sensor(0xd1 , 0x04); 
			SP2519_write_cmos_sensor(0xc9 , 0x83); 
			SP2519_write_cmos_sensor(0xca , 0x04); 
...
SP2519_write_cmos_sensor(0x21,0x0d);
SP2519_write_cmos_sensor(0x28,0x0b);
SP2519_write_cmos_sensor(0x1d,0x01);
...
SP2519_write_cmos_sensor(0xb8,0x70);
...
SP2519_write_cmos_sensor(0xeb,0x7c);
SP2519_write_cmos_sensor(0xec,0x76);
...
SP2519_write_cmos_sensor(0xa2,0x1c);
SP2519_write_cmos_sensor(0xa3,0x15);
SP2519_write_cmos_sensor(0xa4,0x20);
SP2519_write_cmos_sensor(0xa5,0x13);
SP2519_write_cmos_sensor(0xa6,0x18);
SP2519_write_cmos_sensor(0xa7,0x13);
SP2519_write_cmos_sensor(0xa8,0x1a);
SP2519_write_cmos_sensor(0xa9,0x10);
SP2519_write_cmos_sensor(0xaa,0x15);
SP2519_write_cmos_sensor(0xab,0x10);
SP2519_write_cmos_sensor(0xac,0x18);
SP2519_write_cmos_sensor(0xad,0x02);
SP2519_write_cmos_sensor(0xae,0x03);
SP2519_write_cmos_sensor(0xaf,0x01);
SP2519_write_cmos_sensor(0xb0,0x00);
SP2519_write_cmos_sensor(0xb1,0x04);
SP2519_write_cmos_sensor(0xb2,0x05);
SP2519_write_cmos_sensor(0xb3,0x05);
SP2519_write_cmos_sensor(0xb4,0x03);
SP2519_write_cmos_sensor(0xb5,0x05);
SP2519_write_cmos_sensor(0xb6,0x08);
SP2519_write_cmos_sensor(0xb7,0x08);
...
//SP2519_write_cmos_sensor(0x10,0xa0);
...
SP2519_write_cmos_sensor(0x6a,0xa5);
//indoor
SP2519_write_cmos_sensor(0x7c,0x20);	
SP2519_write_cmos_sensor(0x7d,0x40);	
SP2519_write_cmos_sensor(0x7e,0xe7);	
SP2519_write_cmos_sensor(0x7f,0x08);	
SP2519_write_cmos_sensor(0x80,0xa6);
...
//cwf
SP2519_write_cmos_sensor(0x70,0x06);	
SP2519_write_cmos_sensor(0x71,0x1d);
SP2519_write_cmos_sensor(0x72,0x1b);	
SP2519_write_cmos_sensor(0x73,0x3a);	
SP2519_write_cmos_sensor(0x74,0xaa);
//tl84
...
SP2519_write_cmos_sensor(0xeb,0x50);
SP2519_write_cmos_sensor(0xef,0x58);
...
SP2519_write_cmos_sensor(0x75,0x30);
SP2519_write_cmos_sensor(0xfd,0x02);
SP2519_write_cmos_sensor(0x78,0x40);
SP2519_write_cmos_sensor(0x79,0x40);
SP2519_write_cmos_sensor(0x7a,0x20);
SP2519_write_cmos_sensor(0x7b,0x20);
SP2519_write_cmos_sensor(0x81,0x40);  
SP2519_write_cmos_sensor(0x82,0x40);
SP2519_write_cmos_sensor(0x83,0x20);
SP2519_write_cmos_sensor(0x84,0x20);

SP2519_write_cmos_sensor(0xfd,0x03);
SP2519_write_cmos_sensor(0x7e,0x03);
SP2519_write_cmos_sensor(0x7f,0x0c);//0d
SP2519_write_cmos_sensor(0x80,0x10);
SP2519_write_cmos_sensor(0x81,0x16);
SP2519_write_cmos_sensor(0x7c,0xff);
SP2519_write_cmos_sensor(0x82,0xaa);
SP2519_write_cmos_sensor(0x83,0x86);
SP2519_write_cmos_sensor(0x84,0x00);
SP2519_write_cmos_sensor(0x85,0x20);
SP2519_write_cmos_sensor(0x86,0x40);
...
SP2519_write_cmos_sensor(0xa0,0xa0);
SP2519_write_cmos_sensor(0xa1,0xf8);
SP2519_write_cmos_sensor(0xa2,0xe7);
SP2519_write_cmos_sensor(0xa3,0xfd);
SP2519_write_cmos_sensor(0xa4,0x98);
SP2519_write_cmos_sensor(0xa5,0xe9);
SP2519_write_cmos_sensor(0xa6,0x03);
SP2519_write_cmos_sensor(0xa7,0xd7);
SP2519_write_cmos_sensor(0xa8,0xa4);
SP2519_write_cmos_sensor(0xa9,0x3c);
SP2519_write_cmos_sensor(0xaa,0x33);
SP2519_write_cmos_sensor(0xab,0x0c);   
...
SP2519_write_cmos_sensor(0xfd,0x01);
SP2519_write_cmos_sensor(0xd3,0x9c);
SP2519_write_cmos_sensor(0xd4,0x9c);
SP2519_write_cmos_sensor(0xd5,0x98);
SP2519_write_cmos_sensor(0xd6,0x80);

SP2519_write_cmos_sensor(0xd7,0x9c);
SP2519_write_cmos_sensor(0xd8,0x9c);
SP2519_write_cmos_sensor(0xd9,0x98);
...
SP2519_write_cmos_sensor(0x12,0x8c);
SP2519_write_cmos_sensor(0x13,0x8c);
SP2519_write_cmos_sensor(0x14,0xb8);
SP2519_write_cmos_sensor(0x15,0xb8);
SP2519_write_cmos_sensor(0x16,0xa0);
SP2519_write_cmos_sensor(0x17,0x98);
		...
		MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	#ifdef SP2519_24M_48M_Video_binning
	...
	else
	{
		...
		SP2519_config_window(WINDOW_SIZE_UXGA);//add zch test(use this for SVGA)
		image_window->GrabStartX= 1;
		image_window->GrabStartY= 1;
...

{
	...
	#if defined(SP2519_24M_48M_Video_binning)
		...
		MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
	...
	pSensorInfo->CaptureDelayFrame = 2;//8;
	pSensorInfo->PreviewDelayFrame = 4;//5;
...
BOOL SP2519_set_param_wb(UINT16 para)
{
	...
	switch (para)
	{
		...
		case AWB_MODE_FLUORESCENT:
			...
			SP2519_write_cmos_sensor(0x32,0x05);
			SP2519_write_cmos_sensor(0xfd,0x02);
			SP2519_write_cmos_sensor(0x26,0x96);//0xb4
			SP2519_write_cmos_sensor(0x27,0x9f);//0xc4
			SP2519_write_cmos_sensor(0xfd,0x00);
		default:
			return FALSE;
	}  
...
BOOL SP2519_set_param_effect(UINT16 para)
{
	...
	switch (para)
	{
		...
		case MEFFECT_NEGATIVE://----datasheet
			SP2519_write_cmos_sensor(0xfd,0x01);
			SP2519_write_cmos_sensor(0x66,0x04);//0x08
			SP2519_write_cmos_sensor(0x67,0x80);
			SP2519_write_cmos_sensor(0x68,0x80);
			SP2519_write_cmos_sensor(0xdb,0x00);
			break;	
...
//		case AE_EV_COMP_10:              /* EV +1.5 */
	...
	sensor_exposure = SP2519_read_cmos_sensor(0xdb);
	SENSORDB("------- Ronlus SP2519 sensor_exposure = %x -------\n", sensor_exposure);
...
void SP2519_set_contrast(UINT16 para)
{
	...
	switch (para)
	{
		...
		SP2519_write_cmos_sensor(0x11,0x78);
		SP2519_write_cmos_sensor(0x12,0x7c);
		SP2519_write_cmos_sensor(0x13,0x7c);
		
		SP2519_write_cmos_sensor(0x14,0xa8);
		SP2519_write_cmos_sensor(0x15,0xa8);
		SP2519_write_cmos_sensor(0x16,0x90);
		SP2519_write_cmos_sensor(0x17,0x88);
		break;

		case ISP_CONTRAST_HIGH:
		//Hig
		SP2519_write_cmos_sensor(0x10,0x90);
		SP2519_write_cmos_sensor(0x11,0x98);
		SP2519_write_cmos_sensor(0x12,0x9c);
		SP2519_write_cmos_sensor(0x13,0x9c);
		
		SP2519_write_cmos_sensor(0x14,0xc8);
		SP2519_write_cmos_sensor(0x15,0xc8);
		SP2519_write_cmos_sensor(0x16,0xb0);
		SP2519_write_cmos_sensor(0x17,0xa8);
		break;
	...
	sensor_contrast = SP2519_read_cmos_sensor(0x10);
	SENSORDB("------- Ronlus SP2519 sensor_contrast = %x -------\n", sensor_contrast);
	return;
}

void SP2519_set_brightness(UINT16 para)
{
	kal_uint16 sensor_brightness=0;
	
	SP2519_write_cmos_sensor(0xfd,0x01);
	switch (para)
	{
	case ISP_BRIGHT_LOW:		
		SP2519_write_cmos_sensor(0xeb,0x7c-0x10);
		SP2519_write_cmos_sensor(0xec,0x76-0x10);
		break;
	...
	sensor_brightness = SP2519_read_cmos_sensor(0xeb);
	SENSORDB("-------- Ronlus SP2519 sensor_brightness = %x -------\n", sensor_brightness);
...
{
	kal_uint16 sensor_saturation=0;
	SENSORDB("SP2519_set_saturation:%d;\n",para);
	SP2519_write_cmos_sensor(0xfd,0x01);
 	switch (para)
	{		 
		case ISP_SAT_LOW:
		//Low
		SP2519_write_cmos_sensor(0xd3,0x9c-0x10);
		SP2519_write_cmos_sensor(0xd4,0x9c-0x10);
		SP2519_write_cmos_sensor(0xd5,0x98-0x10);
		SP2519_write_cmos_sensor(0xd6,0x80-0x10);

		SP2519_write_cmos_sensor(0xd7,0x9c-0x10);
		SP2519_write_cmos_sensor(0xd8,0x9c-0x10);
		SP2519_write_cmos_sensor(0xd9,0x98-0x10);
		SP2519_write_cmos_sensor(0xda,0x80-0x10);
		break;
	...
	sensor_saturation = SP2519_read_cmos_sensor(0xd3);
	SENSORDB("------- Ronlus SP2519 sensor_saturation = %x -------\n", sensor_saturation);
...
void SP2519_set_iso(UINT16 para)
{
	...
	switch (para)
	{
		case AE_ISO_100:
			//ISO100
			//SP2519_write_cmos_sensor(0xeb,0x7a);
			//SP2519_write_cmos_sensor(0xec,0x68);

	 		break;
		case AE_ISO_200:
			//ISO200
			//SP2519_write_cmos_sensor(0xeb,0x7a+0x10);
			//SP2519_write_cmos_sensor(0xec,0x68+0x10);
			break;
		case AE_ISO_400:
			//ISO400
			//SP2519_write_cmos_sensor(0xeb,0x7a+0x20);
			//SP2519_write_cmos_sensor(0xec,0x68+0x20);
	...
	//sensor_iso = SP2519_read_cmos_sensor(0xeb);
	//SENSORDB("------- Ronlus SP2519 sensor_iso = %x -------\n", sensor_iso);
	return;
