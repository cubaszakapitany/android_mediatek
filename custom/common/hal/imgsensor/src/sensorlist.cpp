...
MSDK_SENSOR_INIT_FUNCTION_STRUCT SensorList[] =
{
    ...
    RAW_INFO(OV8825_SENSOR_ID, SENSOR_DRVNAME_OV8825_MIPI_RAW,NULL), //LINE <> <DATE20140103> <S5500:first time open camera,too slow> wupingzhou
#endif
#if defined(OV8826_MIPI_RAW)//LINE <> <DATE20130408> <add sensor:sunny  ov8825 MTM> wupingzhou
    RAW_INFO(OV8826_SENSOR_ID, SENSOR_DRVNAME_OV8826_MIPI_RAW,NULL), //LINE <> <DATE20140103> <S5500:first time open camera,too slow> wupingzhou
#endif
...
#endif
// BEGIN <><2014.4.10><LiteON 3h7> Jiangde 
#if defined(LITEON3H7Y_MIPI_RAW)
    RAW_INFO(LITEON3H7Y_SENSOR_ID, SENSOR_DRVNAME_LITEON3H7Y_MIPI_RAW,NULL), 
#endif
// END <><2014.4.10><LiteON 3h7> Jiangde 
...
//Start added by mickal.ma
	...
	YUV_INFO(HI256_MIPI_YUV_SENSOR_ID, SENSOR_DRVNAME_HI256_MIPI_YUV,NULL),
#endif
...
#endif
#if defined(HI258_MIPI_YUV) //LINE<><20140111><add sensor hi258>wangyanhui
...
#endif
//BEGIN<><20140111><add sensor driver>wangyanhui
#if defined(OV5648_MIPI_RAW_DARLING)
    RAW_INFO(OV5648MIPI_SENSOR_ID, SENSOR_DRVNAME_OV5648_MIPI_RAW_DARLING, NULL), 
#endif
#if defined(OV5648_MIPI_RAW_TRULY)
    RAW_INFO(OV5649MIPI_SENSOR_ID, SENSOR_DRVNAME_OV5648_MIPI_RAW_TRULY, NULL), 
#endif

#if defined(HI258_MIPI_YUV_CMK) 
    YUV_INFO(HI258_SENSOR_ID, SENSOR_DRVNAME_HI258_MIPI_YUV_CMK,NULL),
#endif
#if defined(HI258_MIPI_YUV_SW)
    YUV_INFO(HI259_SENSOR_ID, SENSOR_DRVNAME_HI258_MIPI_YUV_SW,NULL),
#endif
 //END<><20140111><add sensor driver>wangyanhui
