...
static int FM50AF_Release(struct inode * a_pstInode, struct file * a_pstFile)
{
    ...
    if (g_s4FM50AF_Opened)
    {
        ...
        g_sr = 5;
		s4FM50AF_WriteReg(250);
        msleep(20);
		s4FM50AF_WriteReg(230);
        msleep(20);
	    s4FM50AF_WriteReg(200);
        msleep(20);
		s4FM50AF_WriteReg(180);
        msleep(20);
	s4FM50AF_WriteReg(150);
        msleep(20);
		s4FM50AF_WriteReg(130);
        msleep(20);
	    s4FM50AF_WriteReg(100);
        msleep(20);
		s4FM50AF_WriteReg(80);
        msleep(20);
		s4FM50AF_WriteReg(60);
        msleep(20);
		s4FM50AF_WriteReg(50);
        msleep(20);
		s4FM50AF_WriteReg(30);
        msleep(20);
		s4FM50AF_WriteReg(20);
        msleep(20);
		s4FM50AF_WriteReg(10);
        msleep(20);
