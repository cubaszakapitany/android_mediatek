...
static struct LCM_setting_table lcm_initialization_setting[] = {
        ...
        {0xFF,3,{0xff,0x98,0x26}}, /*EXTC Command Set enable register*/
        {0xBC,26,{0x21,0x06,0x20,0x02,0x01,0x01,0x80,0x04,0x05,0x00,
                       0x00,0x00,0x01,0x01,0xFF,0xF0,0x00,0x00,0x00,0xC0,
                       0x08,0x00,0x00,0x00,0x00,0x00}},  /* GIP 1*/
        {0xBD,8,{0x01,0x23,0x45,0x67,0x01,0x23,0x45,0x67}}, /* GIP 2*/
        {0xBE,17,{0x00,0x22,0x22,0x22,0x97,0x86,0xCA,0xDB,0xAC,0xBD,
                       0x68,0x79,0x22,0x22,0x22,0x22,0x22}}, /* GIP 3*/
        {0x3A,1,{0x77}},
        {0xFA,5,{0x08,0x00,0x00,0x02,0x08}},
        {0xB1,3,{0x00,0x62,0x03}}, /*FRAME RATE 60.18Hz (TE ON)*/
        {0xB4,3,{0x02,0x02,0x02}}, /*2 dot*/
		//{0xB5,4,{0x70,0x13,0x12,0x00}},
        {0xC1,3,{0x15,0x78,0x6A}}, /*AVDD=2xVCI=5.06, AVEE=-2xVCI=-4.82*/ //0x15,0x78,0x6A
        //{0xC7,1,{0x51}}, /*VCOM=-1.337*/
		{0xC7,1,{0x57}},
		{0xDF,3,{0x06,0x22,0x20}},
        {0x35,1,{0x00}}, /*TE ON*/
        {0x44,2,{0x01,0x00}},//切线位置的高8位 ,切线位置的低8位
        {0xF7,1,{0x02}}, /*480x800*/
        {0xF2,6,{0x05,0x02,0x08,0x8A,0x07,0x04}},//05,08 0x04
	#if 0
		{0XE0,16,{0x00,0x06,0x10,0x12,0x0D,0x1F,0XC9,0x09,0x02,0x04
                      ,0x03,0x01,0x0A,0x30,0x26,0x00}},
        {0XE1,16,{0x00,0x06,0x0E,0x10,0x0A,0x19,0x77,0x07,0x04,0x09,
                       0x06,0x03,0x0A,0x1B,0x17,0x00}},
...
static unsigned int lcm_compare_id(void)
{
        ...
        */
        ...
        #ifdef BUILD_LK
           printf("LINE=%d %s, res=%d, lli9806h_tkc_adcVol = %d \n", __LINE__,__func__,res,adcVol); 
        #else
...
// ---------------------------------------------------------------------------
LCM_DRIVER ili9806h_dsi_lcm_drv_tkc = 
{
	.name			= "ili9806h_tkc",
