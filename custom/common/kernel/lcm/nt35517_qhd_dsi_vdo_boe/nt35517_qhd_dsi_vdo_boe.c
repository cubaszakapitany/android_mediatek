...
//	{0xF0,5,{0x55, 0xAA, 0x52, 0x08, 0x01}},
	...
	//{0x36,	1,     {0x82}},   
		...
		{0xF0,5,{0x55, 0xAA, 0x52, 0x08, 0x00}},
		{0xB0,5,{0x00, 0x0C, 0x40, 0x3C, 0x3C}},
		{0xB1,2,{0xFC, 0x00}},//0x06 180 revert lcm  0x00 0
		//{0xB3,1,{0x80}},
		{0xB6,1,{0x08}},
		{0xB7,2,{0x00, 0x00}},
		{0xBA,1,{0x01}},
...
static void lcm_get_params(LCM_PARAMS *params)
{
		...
		params->physical_width= ACTIVE_WIDTH;
		params->physical_height= ACTIVE_HEIGHT;
	...
	//	params->dsi.pll_div2=1; 		// div2=0~15: fout=fvo/(2*div2)
		params->dsi.PLL_CLOCK = 273;//LCM_DSI_6589_PLL_CLOCK_273;
...
LCM_DRIVER boe_nt35517_qhd_dsi_vdo_lcm_drv = 
{
