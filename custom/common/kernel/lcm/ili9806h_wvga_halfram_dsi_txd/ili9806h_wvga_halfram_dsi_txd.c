...
static struct LCM_setting_table lcm_initialization_setting[] = {
        ...
        {0xBC,26,{0x21,0x06,0x20,0x02,0x01,0x01,0x98,0x04,0x05,0x00,
                       0x00,0x00,0x01,0x01,0xff,0xf0,0x00,0x00,0x00,0xc0,
                       0x08,0x00,0x00,0x00,0x00,0x00}},
        {0xBD,8,{0x01,0x23,0x45,0x67,0x01,0x23,0x45,0x67}},
        {0xBE,17,{0x12,0x22,0x22,0x22,0x87,0x96,0xBA,0xAB,0xDC,0xCD,
                       0x78,0x69,0x22,0x22,0x22,0x22,0x22}},

        {0x3A,1,{0x77}},
        {0xFA,5,{0x08,0x00,0x00,0x02,0x08}},

		//TN801031 modified 2013.09.14 for yutao
        //{0xB1,3,{0x00,0x58,0x02}},
        {0xB1,3,{0x00,0x62,0x03}},//TE rate 03-60.14hz 04-48hz
		//TN801031 modified 2013.09.14 

        {0xB4,3,{0x02,0x02,0x02}}, //0x00,0x00,0x00,nei 

      //  {0xC1,3,{0x15,0x78,0x6A}},// 78 6a songyutao test
    //{0xC1,3,{0x15,0x78,0x78}},    //备份1，效果跟对比机基本接近
    {0xC1,3,{0x15,0x70,0x70}},    
 //       {0xC7,1,{0x51}},
 {0xC7,1,{0x81}},
        {0xED,2,{0x7F,0x0F}},
        {0x35,1,{0x00}},//TE on

		//TN801031 added 2013.09.14 for yutao
		{0x44,2,{0x01,0x00}},//切线位置的高8位 低8位        
		//TN801031 added 2013.09.14

        {0xF7,1,{0x02}},

//add test//调色彩饱和度
	//{0x55,1,{0xb0}},//备份1，效果跟对比机基本接近
	{0x55,1,{0xb0}},
//add test

        //{0xF2,6,{0x05,0x08,0x08,0x8A,0x07,0x04}},
        {0XE0,16,{0x00,0x0A,0x1F,0x17,0x16,0x1F,0XCF,0x0E,0x00,0x08
                      ,0x00,0x05,0x08,0x1D,0x1A,0x00}},
        {0XE1,16,{0x00,0x03,0x07,0x0B,0x02,0x15,0x73,0x03,0x07,0x0A,
                       0x09,0x03,0x09,0x37,0x32,0x00}},

//备份1，效果跟对比机基本接近
 //       {0XE0,16,{0x00,0x0A,0x16,0x15,0x10,0x1F,0XCF,0x0E,0x00,0x08
  //                    ,0x00,0x05,0x08,0x1D,0x1A,0x00}},
  //      {0XE1,16,{0x00,0x03,0x17,0x0F,0x0A,0x15,0x73,0x03,0x07,0x0A,
 //                      0x09,0x03,0x09,0x37,0x32,0x00}},
 //备份1，效果跟对比机基本接近
        ...
        {0x3A,1,{0x77}},
        {0xFA,5,{0x08,0x00,0x00,0x02,0x08}},
        {0xF2,6,{0x08,0x07,0x00,0x8e,0x0a,0x0a}},
         {0xF9,5,{0x00,0xda,0x80,0x70,0xc0}},

		//TN801031 modified 2013.09.14 for yutao
        {0xB1,3,{0x00,0x65,0x03}},
       // {0xB1,3,{0x00,0x62,0x03}},//TE rate 03-60.14hz 04-48hz
		//TN801031 modified 2013.09.14 

        {0xB4,3,{0x02,0x02,0x02}}, //0x00,0x00,0x00,nei 

        {0xC1,3,{0x15,0x78,0x70}},  
        {0xC7,1,{0x57}},
        {0x44,2,{0x01,0x00}},
        {0x35,1,{0x00}},//TE on
        ...
        {0xF7,1,{0x02}},
	#if 0
        {0XE0,16,{0x00,0x08,0x11,0x12,0x0D,0x1F,0XC9,0x09,0x02,0x04
                      ,0x03,0x01,0x0A,0x36,0x37,0x00}},
        {0XE1,16,{0x00,0x08,0x10,0x10,0x0A,0x19,0x77,0x07,0x04,0x09,
                       0x06,0x03,0x0A,0x1E,0x1C,0x00}},
	#else
	{0xE0,16,{0x00,0x06,0x15,0x11,0x12,0x1C,0xCA,0x08,0x02,0x08,
                           0x02,0x0D,0x0B,0x30,0x26,0x00}}, /*Positive Gamma Control*/
        {0xE1,16,{0x00,0x05,0x0D,0x10,0x12,0x16,0x79,0x07,0x05,0x09,
                       0x07,0x0C,0x0B,0x1B,0x17,0x00}}, /*Negative Gamma Control*/
	#endif
	 {0x11,0,{}},
        {REGFLAG_DELAY, 120, {}},
        {0x29,0,{}},
