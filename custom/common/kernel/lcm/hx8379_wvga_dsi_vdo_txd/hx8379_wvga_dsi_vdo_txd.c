...
//        {0xBA,18,{0x01,0x93,0x00,0x16,0xA4,0x00,0x18,0xFF,0x0F,0x21,0x03,0x21,0x23,0x25,0x20,0x02,0x31,0x40}},
{0xBA,18,{0x01,0x93,0x00,0x16,0xA4,0x00,0x18,0xFF,0x0F,0x21,0x03,0x21,0x23,0x25,0x20,0x02,0x35,0x40}},    
        //{0xB1,19,{0x00,0x50,0x44,0xEE,0x90,0x08,0x11,0x12,0x74,0x24,0x2C,0xAA,
        //0x2A,0x42,0x0B,0x5E,0xF1,0x00,0xE6}},
        {0xB1,19,{0x00,0x50,0x26,0xEE,0x90,0x08,0x11,0x14,0x74,0x24,0x2C/*0x2F,0x37*/,0xAA,
        0x2A,0x42,0x0B,0x5E,0xF1,0x00,0xE6}},
        
        {0xB2,13,{0x00,0x00,0x3C,0x05,0x04,0x19,0xA2,0x00,0xFF,0x09,0x04,0x19,0xA0}},

        {0xB4,31,{0x02,0x08,0x00,0x32,0x10,0x08,0x32,0x13,0x2C,0x32,0x10,0x08,0x37,
        0x01,0x3F,0x0B,0x27,0x08,0x30,0x08,0x34,0x34,0x04,0x00,0x40,0x08,0x28,0x08,
        0x30,0x30,0x04}},

        {0xD5,47,{0x00,0x00,0x0A,0x00,0x01,0x04,0x00,0x06,0x18,0x88,0x88,0x88,0x32,
        0x10,0x10,0x32,0x54,0x76,0x54,0x76,0x88,0x88,0x88,0x88,0x88,0x88,0x88,0x88,
        0x67,0x45,0x23,0x01,0x67,0x45,0x23,0x01,0x88,0x88,0x88,0x88,0x88,0x00,0x00,
        0x00,0x00,0x00,0x00}},

{0xE0,35,{0x79,0x07,0x12,0x14,0x18,0x17,0x20,0x25,0x3B,0x06,0x0C,0x0F,0x17,0x17,0x15,0x15,0x10,0x10,0x07,0x00,0x00,0x18,0x17,0x20,0x25,0x3B,0x06,0x0c,0x0F,0x17,0x17,0x15,0x15,0x10,0x10}},
        {0xCC,1,{0x02}},
        //{0xB6,4,{0x00,0xA7,0x00,0xA7}},
{0xB6,4,{0x00,0x8C,0x00,0x8C}},
...
static void lcm_get_params(LCM_PARAMS *params)
{
		...
		params->dsi.vertical_backporch					= 9; // 7 6 24
		params->dsi.vertical_frontporch					= 12; // 6, 6 24
		params->dsi.vertical_active_line				= FRAME_HEIGHT; 

		params->dsi.horizontal_sync_active				= 10; // 12 12 32 32
		params->dsi.horizontal_backporch				= 172; //132 92 52 60
		params->dsi.horizontal_frontporch				= 172; //132 92 60 60
...
LCM_DRIVER hx8379_wvga_dsi_vdo_drv_txd = 
{
    .name			= "hx8379_dsi_txd",
