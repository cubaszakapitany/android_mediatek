...
extern LCM_DRIVER ili9806c_fwvga_dsi_vdo_txdkj_drv;
extern LCM_DRIVER ili9488_tkc_lcm_drv;
extern LCM_DRIVER ili9806h_fwvga_dsi_vdo_txd_drv;

#if defined(HX8357D)
extern LCM_DRIVER hx8357d_lcm_drv;
#endif

#if defined(HX8357D_TXD_107)
extern LCM_DRIVER hx8357d_txd_107_lcm_drv;
#endif

#if defined(ILI9488)
extern LCM_DRIVER ili9488_lcm_drv;
#endif
...
#if defined(ILI9806C_FWVGA_DSI_VDO_TXDKJ)
	&ili9806c_fwvga_dsi_vdo_txdkj_drv,
#endif

#if defined(ILI9488_TKC)
	&ili9488_tkc_lcm_drv,
#endif

#if defined(ILI9806H_FWVGA_DSI_VDO_TXD)
	&ili9806h_fwvga_dsi_vdo_txd_drv,
#endif
};
