...
void HI253InitSetting(void)
{
  ...
  HI253WriteCmosSensor(0xd4, 0x0c); // DCDCTIMETHON
  HI253WriteCmosSensor(0xd5, 0x0c); // DCDCTIMETHOFF
  ...
  HI253WriteCmosSensor(0x3f, 0x02); // 0x02 for preview and 0x00 for capture
	...
	HI253WriteCmosSensor(0x48, 0x78);// 84
  ...
  HI253WriteCmosSensor(0x50, 0xa0); // DARK3RATIO
  ...
  HI253WriteCmosSensor(0x5d, 0xa0); // YCDARK2RAT
  ...
  HI253WriteCmosSensor(0x61, 0xe0); // YCDARK3STDM
  HI253WriteCmosSensor(0x62, 0xe0); // YCDARK3STDL
HI253WriteCmosSensor(0x63, 0xa0);//80
...
HI253WriteCmosSensor(0x33, 0x35);
...
HI253WriteCmosSensor(0x62, 0xfa);
  ...
  HI253WriteCmosSensor(0x70, 0x01); // BGMA0
HI253WriteCmosSensor(0x71, 0x12);
HI253WriteCmosSensor(0x72, 0x1c);
HI253WriteCmosSensor(0x73, 0x29);
...
HI253WriteCmosSensor(0xb2, 0x8a);
...
HI253WriteCmosSensor(0xc4, 0x10); //08
  ...
  HI253SetPage(0x22); 
  HI253WriteCmosSensor(0x10, 0xe9); // AWBCTL1
  ...
  SENSORDB("[HI253]EXP100:%d EXP120:%d;\n",EXP100,EXP120);
	...
	HI253SetPage(0x20);
	 ...
	 HI253WriteCmosSensor(0x83, 0x04); //EXP Max 20.00 fps 
	  ...
	  HI253WriteCmosSensor(0x86, 0x01); //EXPMin 6944.44 fps
	  HI253WriteCmosSensor(0x87, 0xd4); 
	  HI253WriteCmosSensor(0x88, 0x05); //EXP Max 20.00 fps 
	  HI253WriteCmosSensor(0x89, 0xe9); 
	  HI253WriteCmosSensor(0x8a, 0xb0); //10FPS
	  HI253WriteCmosSensor(0x8B, 0x7e); //EXP100 
	  HI253WriteCmosSensor(0x8C, 0x24); 
...
void HI253set_contrast(UINT16 para)
{
  ...
  HI253WriteCmosSensor(0x13,HI253Status.ISPCTL4);//make sure the Yoffset control is opened.
	...
	HI253WriteCmosSensor(0x03, 0x10);
    HI253WriteCmosSensor(0x13, 0x0a);
	HI253WriteCmosSensor(0x48, 0x78); 
             break;
    }
...
//ISO100
HI253WriteCmosSensor(0x03, 0x20);
HI253WriteCmosSensor(0xb2, 0x50);
...
//ISO200
HI253WriteCmosSensor(0x03, 0x20);
HI253WriteCmosSensor(0xb2, 0x70);
...
void HI253set_saturation(UINT16 para)
{
	...
	spin_unlock(&hi253_drv_lock);
	HI253WriteCmosSensor(0x60,0x6f);//make sure the Yoffset control is opened.
...
UINT32 HI253YUVSetVideoMode(UINT16 FrameRate)
{
  ...
  HI253SetPage(0x00);
  //HI253WriteCmosSensor(0x50, 0x04);  
  HI253WriteCmosSensor(0x01, 0xf9); // Sleep ON
  spin_lock(&hi253_drv_lock);
  ...
  HI253WriteCmosSensor(0x83, 0x02); //EXP Max 20.00 fps 
  HI253WriteCmosSensor(0x84, 0xf4); 
  HI253WriteCmosSensor(0x85, 0xd8); //10FPS
  HI253WriteCmosSensor(0x86, 0x01); //EXPMin 6944.44 fps
  HI253WriteCmosSensor(0x87, 0xd4); 
