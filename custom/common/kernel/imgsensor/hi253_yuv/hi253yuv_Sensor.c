...
struct
{
  ...
  kal_uint32  PvOpClk;
  kal_uint32  CapOpClk;
  kal_uint32  WhiteBalance;   //LINE:  <SSZTZ-2> <20130622> <add the pic exif info function> panzaoyan
  ...
  kal_uint8   ISPCTL4;  //LINE <> <20130729> <add the image properties and iso function.> panzaoyan
  kal_uint8   SATCTL;  //LINE <> <20130729> <add the image properties and iso function.> panzaoyan
...
void HI253InitSetting(void)
{
  ...
  HI253WriteCmosSensor(0x27, 0x40); // WINWIDL
	...
	HI253WriteCmosSensor(0x41, 0xe8);//lxh 
	HI253WriteCmosSensor(0x42, 0x00); 
	HI253WriteCmosSensor(0x43, 0x14);//lxh 
  ...
  HI253WriteCmosSensor(0x92, 0x98); // BLCAGTH ON
  HI253WriteCmosSensor(0x93, 0x90); // BLCAGTH OFF
  ...
  HI253WriteCmosSensor(0xd6, 0x98); // DCDCAGTHON
  HI253WriteCmosSensor(0xd7, 0x90); // DCDCAGTHOFF
  ...
  HI253WriteCmosSensor(0x3f, 0x02); // 0x02 for preview and 0x00 for capture
	...
	HI253WriteCmosSensor(0x50, 0x70);
  
  //Saturation;
  HI253WriteCmosSensor(0x60, 0x67);
  //BEGIN: <> <20130620> <ascend the sat > panzaoyan
  HI253WriteCmosSensor(0x61, 0x86);// 80
  HI253WriteCmosSensor(0x62, 0x80);// 78
  //END: <> <20130620> <ascend the sat > panzaoyan
  ...
  HI253SetPage(0x11);
  HI253WriteCmosSensor(0x10, 0x7f);//lxh,3f 
  ...
  HI253WriteCmosSensor(0x20, 0x60); // XCEN
  HI253WriteCmosSensor(0x21, 0x80); // YCEN
  HI253WriteCmosSensor(0x22, 0x86); // LENSRGAIN
  HI253WriteCmosSensor(0x23, 0x86); // LENSGGAIN
  HI253WriteCmosSensor(0x24, 0x86); // LENSBGAIN
  ...
  HI253WriteCmosSensor(0x34, 0x90);
	...
	HI253WriteCmosSensor(0x40, 0x52);
	HI253WriteCmosSensor(0x50, 0x4d);
	HI253WriteCmosSensor(0x60, 0x48);
	HI253WriteCmosSensor(0x70, 0x4d);
...
//GMA
HI253WriteCmosSensor(0x30, 0x00);
HI253WriteCmosSensor(0x31, 0x09);
HI253WriteCmosSensor(0x32, 0x15);
...
HI253WriteCmosSensor(0x56, 0x8d);
  ...
  HI253WriteCmosSensor(0x28, 0xe7); //LINE <> <20130805> <add the DPC switch.> panzaoyan
  ...
  HI253WriteCmosSensor(0x60, 0xaa); // AEWGT1
  HI253WriteCmosSensor(0x61, 0xaa); // AEWGT2
  ...
  HI253WriteCmosSensor(0x6e, 0xaa); // AEWGT15
  HI253WriteCmosSensor(0x6f, 0xaa); // AEWGT16
  ...
  HI253WriteCmosSensor(0x71, 0xBb);
	...
	HI253WriteCmosSensor(0x77, 0x02);
	HI253WriteCmosSensor(0x78, 0x22);
	HI253WriteCmosSensor(0x79, 0x2a);

	HI253WriteCmosSensor(0x78, 0x24);
	HI253WriteCmosSensor(0x79, 0x23);
 HI253WriteCmosSensor(0x7a, 0x23); //23
 HI253WriteCmosSensor(0x7b, 0x22); //22
HI253WriteCmosSensor(0x7d, 0x23);
  HI253WriteCmosSensor(0x83, 0x04); //EXP Normal 33.33 fps 
  ...
  HI253WriteCmosSensor(0x89, 0xed); 
  HI253WriteCmosSensor(0x8a, 0x68); 
  ...
  HI253WriteCmosSensor(0x9c, 0x0c); //EXP Limit 1736.11 fps 
  HI253WriteCmosSensor(0x9d, 0xcc); 
...
HI253WriteCmosSensor(0xc4, 0x10); //08
  ...
  HI253WriteCmosSensor(0x83, 0x50); // RMAX
  HI253WriteCmosSensor(0x84, 0x20); // RMIN
	HI253WriteCmosSensor(0x85, 0x53); // BMAX
  HI253WriteCmosSensor(0x86, 0x25); // BMIN
...
void HI253InitPara(void)
{
  ...
  HI253Status.WhiteBalance = 0; //LINE:  <SSZTZ-2> <20130622> <add the pic exif info function> panzaoyan
...
void HI253NightMode(kal_bool Enable)
{
  ...
  if(Enable)
  {
    if (HI253Status.Banding == AE_FLICKER_MODE_50HZ) 
    {
     ...
     HI253WriteCmosSensor(0x86, 0x01); //EXPMin 6944.44 fps
     HI253WriteCmosSensor(0x87, 0xd4); 
     HI253WriteCmosSensor(0x88, 0x09); //EXP Max 20.00 fps 
     HI253WriteCmosSensor(0x89, 0xda); 
     HI253WriteCmosSensor(0x8a, 0xd0); //10FPS
     HI253WriteCmosSensor(0x8B, 0x7e); //EXP100 
     HI253WriteCmosSensor(0x8C, 0x24); 
     HI253WriteCmosSensor(0x8D, 0x69); //EXP120 
     HI253WriteCmosSensor(0x8E, 0x1e); 
     HI253WriteCmosSensor(0x9c, 0x0c); //EXP Limit 992.06 fps 
     HI253WriteCmosSensor(0x9d, 0xcc); 
     HI253WriteCmosSensor(0x9e, 0x01); //EXP Unit 
     HI253WriteCmosSensor(0x9f, 0xd4); 
	...
	//  HI253WriteCmosSensor(0x83, 0x01); //0x017a00 //20130125
	  //HI253WriteCmosSensor(0x84, 0x7a);//20130125
	 // HI253WriteCmosSensor(0x85, 0x6c);//20130125
  ...
  else
  {
	...
	{	  SENSORDB("[HI253]HI253NightMode Enable AE_FLICKER_MODE_50HZ\n");
	  ...
	  HI253WriteCmosSensor(0x86, 0x01); //EXPMin 6944.44 fps
	  HI253WriteCmosSensor(0x87, 0xd4); 
	  HI253WriteCmosSensor(0x88, 0x05); //EXP Max 8.00 fps 
	  HI253WriteCmosSensor(0x89, 0xe9); 
	  HI253WriteCmosSensor(0x8a, 0xb0); //10FPS
	  HI253WriteCmosSensor(0x8B, 0x7e); //EXP100 
	  HI253WriteCmosSensor(0x8C, 0x24); 
	  HI253WriteCmosSensor(0x8D, 0x69); //EXP120 
	  HI253WriteCmosSensor(0x8E, 0x1e); 
	...
	HI253WriteCmosSensor(0x86, 0x01); //EXPMin 6944.44 fps
	HI253WriteCmosSensor(0x87, 0xd4); 
	HI253WriteCmosSensor(0x88, 0x06); //EXP Max 8.00 fps 
	HI253WriteCmosSensor(0x89, 0x28); 
	HI253WriteCmosSensor(0x8a, 0xc2); //10FPS
	HI253WriteCmosSensor(0x8B, 0x7e); //EXP100 
	HI253WriteCmosSensor(0x8C, 0x24); 
	HI253WriteCmosSensor(0x8D, 0x69); //EXP120 
	HI253WriteCmosSensor(0x8E, 0x1e); 
...
*
*************************************************************************/
//LINE <solve the extra exposure bug> <20130619> panzaoyan
                      ...
                      MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
  ...
  HI253SetMirror(IMAGE_NORMAL);
	...
	spin_lock(&hi253_drv_lock);
//LINE: <> <20130620> <descend the hblank > panzaoyan
  HI253Status.PvDummyPixels = 232; //424
  spin_unlock(&hi253_drv_lock);
  ...
  SENSORDB("[HI253]EXP100:%d EXP120:%d;\n",EXP100,EXP120);
	...
	HI253SetPage(0x20);
	  ...
	  HI253WriteCmosSensor(0x10, 0x1c); //EXPMin 6944.44 fps
	 HI253WriteCmosSensor(0x18, 0x38); //EXPMin 6944.44 fps
	 HI253WriteCmosSensor(0x83, 0x09); //EXP Max 20.00 fps 
	  HI253WriteCmosSensor(0x84, 0xda); 
	  HI253WriteCmosSensor(0x85, 0xd0); //10FPS
	 ...
	 HI253WriteCmosSensor(0x8a, 0xd0); //10FPS
	  ...
	  HI253WriteCmosSensor(0x9f, 0xd4); 
	  HI253WriteCmosSensor(0x18, 0x30); 
	  HI253WriteCmosSensor(0x10, 0x9c); //EXPMin 6944.44 fps
...
//BEGIN: <solve the extra exposure bug> <20130619> panzaoyan
/*
...
*/
 	 ...
 	 HI253SetPage(0x20);
          HI253Status.PvShutter = (HI253ReadCmosSensor(0x80) << 16)|(HI253ReadCmosSensor(0x81) << 8)|HI253ReadCmosSensor(0x82);
//END: <solve the extra exposure bug> <20130619> panzaoyan
  ...
  HI253WriteCmosSensor(0x90, 0x5d); //LINE <> <20130805> <add the DPC switch.> panzaoyan   
  HI253SetPage(0x13);
  HI253WriteCmosSensor(0x80, 0xfd);   
  ...
  {
//LINE: <to solve the extra exposure bug> <20130619> panzaoyan
    ClockDivider = 0;//ClockDivider = 1; //Op CLock 13M
  }
  else
  {
...
BOOL HI253SetWb(UINT16 Para)
{
  ...
  HI253Status.WhiteBalance = Para; //LINE:  <SSZTZ-2> <20130622> <add the pic exif info function> panzaoyan
  switch (Para)
  {
    case AWB_MODE_OFF:
      HI253SetAwbMode(KAL_FALSE);
    ...
    case AWB_MODE_AUTO:
      ...
      HI253WriteCmosSensor(0x84, 0x18);
...
//BEGIN <> <20130729> <add the image properties and iso function.> panzaoyan		
void HI253set_contrast(UINT16 para)
{
  kal_uint8   ISPCTL4; /* P10.0x13. */
  
  
  SENSORDB("[HI253]HI253set_contrast Para:%d;\n",para);
  HI253SetPage(0x10);  
  spin_lock(&hi253_drv_lock);
...
//ISO100
//HI253WriteCmosSensor(0x03, 0x20);
//HI253WriteCmosSensor(0xb2, 0x40);
HI253WriteCmosSensor(0x03, 0x10);
HI253WriteCmosSensor(0x13, 0x0a);
HI253WriteCmosSensor(0x4a, 0x40);

             break;
        case AE_ISO_200:
//ISO200
//HI253WriteCmosSensor(0x03, 0x20);
//HI253WriteCmosSensor(0xb2, 0x60);

HI253WriteCmosSensor(0x03, 0x10);
HI253WriteCmosSensor(0x13, 0x0a);
HI253WriteCmosSensor(0x4a, 0x55);
...
void HI253set_saturation(UINT16 para)
{
	...
	spin_unlock(&hi253_drv_lock);
	HI253WriteCmosSensor(0x60,0x67);//make sure the Yoffset control is opened.
	...
	HI253WriteCmosSensor(0x03, 0x10);
	HI253WriteCmosSensor(0x61, 0x86); //Sat B
...
void HI253set_brightness(UINT16 para)
{
	...
	HI253WriteCmosSensor(0x70, 0x20);
	
             break;
        case ISP_BRIGHT_HIGH:

	HI253WriteCmosSensor(0x70, 0x70); 
...
//END <> <20130729> <add the image properties and iso function.> panzaoyan		
...
/*
	 HI253WriteCmosSensor(0x03, 0x20);
	  ...
	  HI253WriteCmosSensor(0x86, 0x01); //EXPMin 6944.44 fps
	  HI253WriteCmosSensor(0x87, 0xd4); 
	  HI253WriteCmosSensor(0x88, 0x04); //EXP Max 20.00 fps 
	  HI253WriteCmosSensor(0x89, 0xed); 
	  HI253WriteCmosSensor(0x8a, 0x68); //10FPS
	  HI253WriteCmosSensor(0x8B, 0x7e); //EXP100 
	  HI253WriteCmosSensor(0x8C, 0x24); 
	  HI253WriteCmosSensor(0x8D, 0x69); //EXP120 
	  HI253WriteCmosSensor(0x8E, 0x1e); 
	...
	*/  
	...
	HI253WriteCmosSensor(0x89, 0xe9); 
	HI253WriteCmosSensor(0x8a, 0xb0); 
	...
	*/
	...
	HI253WriteCmosSensor(0x88, 0x06); 
	HI253WriteCmosSensor(0x89, 0x28); 
	HI253WriteCmosSensor(0x8a, 0xc2);
	HI253WriteCmosSensor(0x18, 0x30);

	HI253WriteCmosSensor(0x10, 0x8c);//60hz
	spin_unlock(&hi253_drv_lock);
  	}
...
BOOL HI253SetExposure(UINT16 Para)
{
  ...
  HI253SetPage(0x10);  
 //BEGIN <SSZTZ-96> <20130618> <solve the bug that the color effect can't reserve> panzoayan
  HI253SetPage(0x10);
  HI253WriteCmosSensor(0x12,(HI253ReadCmosSensor(0x12)|0x10));//make sure the Yoffset control is opened.
 //END <SSZTZ-96> <20130618> <solve the bug that the color effect can't reserve> panzoayan
...
UINT32 HI253YUVSetVideoMode(UINT16 FrameRate)
{
  ...
  HI253WriteCmosSensor(0xd6, 0x98); // DCDC_AG_TH_ON
  HI253WriteCmosSensor(0xd7, 0x90); // DCDC_AG_TH_OFF
 ...
 // HI253WriteCmosSensor(0x83, 0x04); //EXP Max 20.00 fps 
 // HI253WriteCmosSensor(0x84, 0xed); 
 // HI253WriteCmosSensor(0x85, 0x68); //10FPS
  HI253WriteCmosSensor(0x86, 0x01); //EXPMin 6944.44 fps
  HI253WriteCmosSensor(0x87, 0xd4); 
  HI253WriteCmosSensor(0x88, 0x02); //EXP Max 20.00 fps 
  HI253WriteCmosSensor(0x89, 0xf4); 
  HI253WriteCmosSensor(0x8a, 0xd8); //10FPS
  HI253WriteCmosSensor(0x8B, 0x7e); //EXP100 
  HI253WriteCmosSensor(0x8C, 0x24); 
  HI253WriteCmosSensor(0x8D, 0x69); //EXP120 
  HI253WriteCmosSensor(0x8E, 0x1e); 

  HI253WriteCmosSensor(0x91, 0x04); //EXP Limit 992.06 fps 
  HI253WriteCmosSensor(0x92, 0xf4); 
  HI253WriteCmosSensor(0x93, 0xb8); //EXP Unit 
...
//BEGIN: <SSZTZ-2> <20130622> <add the pic exif info function> panzaoyan
...
//END: <SSZTZ-2> <20130622> <add the pic exif info function> panzaoyan
