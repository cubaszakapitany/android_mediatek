...

{
  ...
  HI704_write_cmos_sensor(0x85, 0xac);
  HI704_write_cmos_sensor(0x86, 0x00);
  HI704_write_cmos_sensor(0x87, 0xfa);
  
  HI704_write_cmos_sensor(0x88, 0x04);
  HI704_write_cmos_sensor(0x89, 0xf5);
  HI704_write_cmos_sensor(0x8A, 0x88);//7
  ...
  else
  {
		...
		HI704_write_cmos_sensor(0x8A, 0xa0);//7
...
else
{
  ...
  HI704_write_cmos_sensor(0x8A, 0xac);//7
  ...
  HI704_write_cmos_sensor(0x83, 0x03);
  HI704_write_cmos_sensor(0x84, 0x80);
  ...
  HI704_write_cmos_sensor(0x8A, 0x7c);//7
...
//	 HI704_Set_VGA_mode();
 ...
 HI704_write_cmos_sensor(0x90, 0x08);
 HI704_write_cmos_sensor(0x91, 0x07);

  HI704_write_cmos_sensor(0x03, 0x10);
 HI704_write_cmos_sensor(0x48, 0x90);
...
BOOL HI704_set_param_banding(UINT16 para)
{
    ...
    case AE_FLICKER_MODE_50HZ:
		...
		HI704_write_cmos_sensor(0x88, 0x03);
		HI704_write_cmos_sensor(0x89, 0x78);
		HI704_write_cmos_sensor(0x8A, 0xac);//50HZ
    ...
    HI704_write_cmos_sensor(0x88, 0x03);
    HI704_write_cmos_sensor(0x89, 0x80);
    HI704_write_cmos_sensor(0x8A, 0x7c);//60HZ
