...
typedef enum
{
  ...
  SENSOR_FEATURE_SET_SENSOR_PIP_FRONT_CAMERA_WINDOW,
#endif
...
typedef struct
{
  ...
  MUINT16 SensorPIPPreviewWidth;
  MUINT16 SensorPIPPreviewHeight;
  MUINT16 SensorPIPFullWidth;
  MUINT16 SensorPIPFullHeight;
  MUINT16 SensorPIPVideoWidth;
  MUINT16 SensorPIPVideoHeight;  
#endif
