...
#define KDIMGSENSORIOC_X_RELEASE_I2C_TRIGGER_LOCK     _IO(IMGSENSORMAGIC,50)
    ...
    //sensorSearch Condition
    #define KDIMGSENSORIOC_X_SEARCH_SENSOR     _IOWR(IMGSENSORMAGIC,55,u32)
#endif
...
#define OV5645PIP_MIPI_SENSOR_ID                0x5646
  #define OV7695MIPI_SENSOR_ID                    0x7695
#define OV7695PIP_SENSOR_ID                     0x7696
#define OV7695_SENSOR_ID 				 0x7695
#define OV5644MIPI_SENSOR_ID                    0x5644  
...
#define SP0A18_SENSOR_ID			0x00a7
...
#define SENSOR_DRVNAME_OV5645PIP_MIPI_YUV  "ov5645pip_mipi_yuv"
#define SENSOR_DRVNAME_OV7695_MIPI_YUV     "ov7695_mipi_yuv"
#define SENSOR_DRVNAME_OV7695PIP_YUV  "ov7695pip_yuv"
#define SENSOR_DRVNAME_OV7695_YUV  "ov7695_yuv"   
#define SENSOR_DRVNAME_OV5644_MIPI_YUV     "ov5644_mipi_yuv"  
...
#define SENSOR_DRVNAME_SP0A18_YUV		"sp0a18_yuv"
...
//Jieve Append
extern int kdCamADCReadChipID(int camID, int min, int max);
