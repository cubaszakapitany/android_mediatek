...
UINT32 HI256_YUV_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
UINT32 HI256_SW_YUV_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
...
UINT32 HI258_YUV_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc); //LINE<><20140111><add sensor hi258>wangyanhui
...
ACDK_KD_SENSOR_INIT_FUNCTION_STRUCT kdSensorList[MAX_NUM_OF_SUPPORT_SENSOR+1] =
{
    ...
    {OV8835_SENSOR_ID, SENSOR_DRVNAME_OV8835_MIPI_RAW, OV8835_MIPI_RAW_SensorInit}, 
#endif
  ...
  {AR0833_SENSOR_ID, SENSOR_DRVNAME_AR0833_MIPI_RAW,AR0833_MIPI_RAW_SensorInit},
    ...
    {HI256_SENSOR_ID, SENSOR_DRVNAME_HI256_YUV, HI256_YUV_SensorInit}, 
#endif
#if defined(HI256_MIPI_YUV_SW)
    {HI256_SW_SENSOR_ID, SENSOR_DRVNAME_HI256_SW_YUV, HI256_SW_YUV_SensorInit},
#endif
