...
#endif
UINT32 OV5644_MIPI_YUV_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
UINT32 OV7695_YUV_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
...
//LINE <sp0a19> <DATE20130509> <sp0a19 driver> zhangxiaofei
...
#endif
#if defined(OV7695_MIPI_YUV)
		{OV7695MIPI_SENSOR_ID, SENSOR_DRVNAME_OV7695_MIPI_YUV, OV7695_MIPI_YUV_SensorInit}, 
#endif
#if defined(TINNO_PIP_SUPPORT)
  #if defined(OV5645PIP_MIPI_YUV)
		{OV5645PIP_MIPI_SENSOR_ID, SENSOR_DRVNAME_OV5645PIP_MIPI_YUV, OV5645PIP_YUV_SensorInit}, 
		{OV7695PIP_SENSOR_ID, SENSOR_DRVNAME_OV7695PIP_YUV, OV7695_YUV_SensorInit}, 
  #endif
#endif
#if defined(OV5644_MIPI_YUV)
		{OV5644MIPI_SENSOR_ID, SENSOR_DRVNAME_OV5644_MIPI_YUV, OV5644_MIPI_YUV_SensorInit}, 
#endif
#if defined(OV7695_YUV)
	{OV7695_SENSOR_ID, SENSOR_DRVNAME_OV7695_YUV, OV7695_YUV_SensorInit}, 
#endif
