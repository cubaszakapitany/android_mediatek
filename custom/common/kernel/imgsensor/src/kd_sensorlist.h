...
UINT32 LITEON3H7Y_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc); // LINE <><2014.4.10><LiteON 3h7> Jiangde 
...
//BEGIN<><20140111><add sensor driver>mickal.ma
...
//END<><20140111><add sensor driver>mickal.ma
