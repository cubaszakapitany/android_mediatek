...
{  
	...
	SP0A19_write_cmos_sensor(0x82,0x70);// 0x80
	SP0A19_write_cmos_sensor(0x83,0x30);// 0x40
	SP0A19_write_cmos_sensor(0x84,0x10);//0x20
	//GrGb
	SP0A19_write_cmos_sensor(0x85,0xe0);
	SP0A19_write_cmos_sensor(0x86,0x70);//0x80
	SP0A19_write_cmos_sensor(0x87,0x30);// 0x40
	SP0A19_write_cmos_sensor(0x88,0x10);// 0x20
	// 
	SP0A19_write_cmos_sensor(0x5a,0xff);
	SP0A19_write_cmos_sensor(0x5b,0xe0);// 0xe0
	SP0A19_write_cmos_sensor(0x5c,0x60);// 0x80
	...
	SP0A19_write_cmos_sensor(0xe5,0x0c);//0x08
	SP0A19_write_cmos_sensor(0xd3,0x0c);// 0x08
	SP0A19_write_cmos_sensor(0xd7,0x0c);//0x08
	
	SP0A19_write_cmos_sensor(0xe6,0x0f);// 0x0a
	SP0A19_write_cmos_sensor(0xd4,0x0f);//0x0a
	SP0A19_write_cmos_sensor(0xd8,0x0f);//0x0a
	...
	SP0A19_write_cmos_sensor(0xe8,0x1e);
	SP0A19_write_cmos_sensor(0xec,0x2c);
	
	SP0A19_write_cmos_sensor(0xe9,0x1e);
	...
	//CCM
    SP0A19_write_cmos_sensor(0xfd,0x01);
	SP0A19_write_cmos_sensor(0xa0,0x80);// 0x6a
	SP0A19_write_cmos_sensor(0xa1,0x0c);
	SP0A19_write_cmos_sensor(0xa2,0xf6);// 0x19
	SP0A19_write_cmos_sensor(0xa3,0xf3);
	SP0A19_write_cmos_sensor(0xa4,0x81);
	SP0A19_write_cmos_sensor(0xa5,0x0b);
	SP0A19_write_cmos_sensor(0xa6,0xdb);
	SP0A19_write_cmos_sensor(0xa7,0x0d);
	SP0A19_write_cmos_sensor(0xa8,0xa5);
	SP0A19_write_cmos_sensor(0xa9,0x30);
	SP0A19_write_cmos_sensor(0xaa,0x03);
	SP0A19_write_cmos_sensor(0xab,0x03);
	...
	//ae target
	SP0A19_write_cmos_sensor(0xfd,0x00);
	SP0A19_write_cmos_sensor(0xed,0xa8);// 0x98
	SP0A19_write_cmos_sensor(0xf7,0xa4);//0x94
	SP0A19_write_cmos_sensor(0xf8,0x9c);// 0x8C
	SP0A19_write_cmos_sensor(0xec,0x98);// 0x88

	SP0A19_write_cmos_sensor(0xef,0x90);//0x80
	SP0A19_write_cmos_sensor(0xf9,0x8c);//0x7c
	SP0A19_write_cmos_sensor(0xfa,0x84);//0x74
	SP0A19_write_cmos_sensor(0xee,0x80);// 0x70
	...
	//lowlight lum
	SP0A19_write_cmos_sensor(0xfd,0x00);
	SP0A19_write_cmos_sensor(0xb2,0x10);//0x20
	...
	SP0A19_write_cmos_sensor(0xd3,0x90);
	SP0A19_write_cmos_sensor(0xd4,0x90);
	SP0A19_write_cmos_sensor(0xd6,0x78);// 0x78
	SP0A19_write_cmos_sensor(0xd7,0x50);//0x6c
	
	//HEQ
	SP0A19_write_cmos_sensor(0xfd,0x00);
	SP0A19_write_cmos_sensor(0xdc,0x00);
	SP0A19_write_cmos_sensor(0xdd,0x7d);
