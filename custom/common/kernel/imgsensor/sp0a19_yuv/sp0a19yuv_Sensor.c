...
#define SP2528_OP_CODE_END		0x03		/* End of initial setting. */
	...
	static SP2528_initial_set_struct SP2528_Init_Reg[1000];
	...
	static u8 SP2528_Initialize_from_T_Flash()
	{
...
//ae setting
	SP0A19_write_cmos_sensor(0xfd,0x00);
	SP0A19_write_cmos_sensor(0x03,0x00);
	SP0A19_write_cmos_sensor(0x04,0xea);
	SP0A19_write_cmos_sensor(0x06,0x00);
	SP0A19_write_cmos_sensor(0x09,0x03);
	SP0A19_write_cmos_sensor(0x0a,0x31);
	SP0A19_write_cmos_sensor(0xf0,0x4e);
	SP0A19_write_cmos_sensor(0xf1,0x00);
	SP0A19_write_cmos_sensor(0xfd,0x01);
	SP0A19_write_cmos_sensor(0x90,0x0f);
	SP0A19_write_cmos_sensor(0x92,0x01);
	SP0A19_write_cmos_sensor(0x98,0x4e);
	SP0A19_write_cmos_sensor(0x99,0x00);
	SP0A19_write_cmos_sensor(0x9a,0x01);
	SP0A19_write_cmos_sensor(0x9b,0x00);
//Status 
	SP0A19_write_cmos_sensor(0xfd,0x01);
	SP0A19_write_cmos_sensor(0xce,0x92);
	SP0A19_write_cmos_sensor(0xcf,0x04);
	SP0A19_write_cmos_sensor(0xd0,0x92);
	SP0A19_write_cmos_sensor(0xd1,0x04);
	SP0A19_write_cmos_sensor(0xfd,0x00);
...
//awb 1
	SP0A19_write_cmos_sensor(0xfd,0x01);
	SP0A19_write_cmos_sensor(0x28,0xc5);//0x28,0xc9);
	SP0A19_write_cmos_sensor(0x29,0x9b);//0x29,0x98);
	...
	//SP0A19_write_cmos_sensor(0xfd,0x01);
	SP0A19_write_cmos_sensor(0x2e,0x02);//0xfd,0x00);
	SP0A19_write_cmos_sensor(0x2f,0x16);//0xe7,0x03);
...
//awb2
	...
	SP0A19_write_cmos_sensor(0x1b,0x80);//0x2b,0x15);
//d65
	SP0A19_write_cmos_sensor(0x65,0xd5);//0xfd,0x01);
	SP0A19_write_cmos_sensor(0x66,0xfa);//0x73,0x80);
	SP0A19_write_cmos_sensor(0x67,0x72);//0x1a,0x80);
	SP0A19_write_cmos_sensor(0x68,0x8a);//0x1b,0x8c);
//indoor 
	SP0A19_write_cmos_sensor(0x69,0xc6);//0x65,0xd1);
	SP0A19_write_cmos_sensor(0x6a,0xee);//0x66,0xe7);
	SP0A19_write_cmos_sensor(0x6b,0x94);//0x67,0x7f);
	SP0A19_write_cmos_sensor(0x6c,0xab);//0x68,0x94);
//f 
	SP0A19_write_cmos_sensor(0x61,0x7a);//0x69,0xbb);
	SP0A19_write_cmos_sensor(0x62,0x98);//0x6a,0xdd);
	SP0A19_write_cmos_sensor(0x63,0xc5);//0x6b,0x96);
	SP0A19_write_cmos_sensor(0x64,0xe6);//0x6c,0xbb);
//cwf
	SP0A19_write_cmos_sensor(0x6d,0xb9);//0x61,0x7b);
	SP0A19_write_cmos_sensor(0x6e,0xde);//0x62,0xa1);
...
//smooth
	SP0A19_write_cmos_sensor(0xfd,0x00);
//
	SP0A19_write_cmos_sensor(0x57,0x0a);
	SP0A19_write_cmos_sensor(0x58,0x0d);
	SP0A19_write_cmos_sensor(0x56,0x14);
	SP0A19_write_cmos_sensor(0x59,0x20);
//GrGb
	SP0A19_write_cmos_sensor(0x89,0x0a);
	SP0A19_write_cmos_sensor(0x8a,0x0d);
	SP0A19_write_cmos_sensor(0x9c,0x14);
	SP0A19_write_cmos_sensor(0x9d,0x20);
//Gr\Gb
	SP0A19_write_cmos_sensor(0x81,0xe0);//0xe0
	SP0A19_write_cmos_sensor(0x82,0x30);
	SP0A19_write_cmos_sensor(0x83,0x10);
	SP0A19_write_cmos_sensor(0x84,0x08);//0x20
//GrGb
	SP0A19_write_cmos_sensor(0x85,0xe0);//0xe0
	SP0A19_write_cmos_sensor(0x86,0x30);
	SP0A19_write_cmos_sensor(0x87,0x10);
	SP0A19_write_cmos_sensor(0x88,0x08);//0x20
//
	SP0A19_write_cmos_sensor(0x5a,0xff);//0xff
	SP0A19_write_cmos_sensor(0x5b,0x30);
	SP0A19_write_cmos_sensor(0x5c,0x10);
	SP0A19_write_cmos_sensor(0x5d,0x08);//0x20
//sharpen 
	SP0A19_write_cmos_sensor(0xfd,0x01);
	...
	SP0A19_write_cmos_sensor(0xe5,0x0a);
	SP0A19_write_cmos_sensor(0xd3,0x0a);
	SP0A19_write_cmos_sensor(0xd7,0x0a);
	
	SP0A19_write_cmos_sensor(0xe6,0x0d);
	SP0A19_write_cmos_sensor(0xd4,0x0d);
	SP0A19_write_cmos_sensor(0xd8,0x0d);
	
	SP0A19_write_cmos_sensor(0xe7,0x18);
	SP0A19_write_cmos_sensor(0xd5,0x18);
	SP0A19_write_cmos_sensor(0xd9,0x18);
	
	SP0A19_write_cmos_sensor(0xd2,0x20);
	SP0A19_write_cmos_sensor(0xd6,0x20);
	SP0A19_write_cmos_sensor(0xda,0x20);
...
//CCM
	SP0A19_write_cmos_sensor(0xfd,0x01);
	SP0A19_write_cmos_sensor(0xa0,0x7f);//0xa0,0x72);//0xa0,0x7D);
	SP0A19_write_cmos_sensor(0xa1,0x00);//0xa1,0x18);//0xa1,0x00);
	SP0A19_write_cmos_sensor(0xa2,0x00);//0xa2,0xf5);//0xa2,0x00);
	SP0A19_write_cmos_sensor(0xa3,0xf3);
	SP0A19_write_cmos_sensor(0xa4,0x8e);
	SP0A19_write_cmos_sensor(0xa5,0x00);//0xa5,0x0e);//0xa5,0x00);
	SP0A19_write_cmos_sensor(0xa6,0x00);//0xa6,0xd9);//0xa6,0x00);
	SP0A19_write_cmos_sensor(0xa7,0xe6);
	SP0A19_write_cmos_sensor(0xa8,0x9a);
	SP0A19_write_cmos_sensor(0xa9,0x00);//0xa9,0x30);//0xa9,0x00);
	SP0A19_write_cmos_sensor(0xaa,0x03);//0xaa,0x03);//0xaa,0x03);
	SP0A19_write_cmos_sensor(0xab,0x0c);//0xab,0x03);//0xab,0x0c);
	SP0A19_write_cmos_sensor(0xfd,0x00);
//gamma  
	SP0A19_write_cmos_sensor(0xfd,0x00);
...
//rpc
	SP0A19_write_cmos_sensor(0xfd,0x00);
	SP0A19_write_cmos_sensor(0xe0,0x44);//0x4c
	SP0A19_write_cmos_sensor(0xe1,0x36);//0x3c
	SP0A19_write_cmos_sensor(0xe2,0x2e);//0x34
	SP0A19_write_cmos_sensor(0xe3,0x2a);//0x2e 
	SP0A19_write_cmos_sensor(0xe4,0x2a);//0x2e
	SP0A19_write_cmos_sensor(0xe5,0x28);//0x2c
	SP0A19_write_cmos_sensor(0xe6,0x28);//0x2c
	SP0A19_write_cmos_sensor(0xe8,0x26);//0x2a
	SP0A19_write_cmos_sensor(0xe9,0x26);//0x2a
	SP0A19_write_cmos_sensor(0xea,0x26);//0x2a
	SP0A19_write_cmos_sensor(0xeb,0x24);//0x28
	SP0A19_write_cmos_sensor(0xf5,0x24);//0x28
	SP0A19_write_cmos_sensor(0xf6,0x24);//0x28
//ae min gain  
	SP0A19_write_cmos_sensor(0xfd,0x01);//0x01
	SP0A19_write_cmos_sensor(0x94,0xa0);
	SP0A19_write_cmos_sensor(0x95,0x28);
	SP0A19_write_cmos_sensor(0x9c,0xa0);//0xa0
	SP0A19_write_cmos_sensor(0x9d,0x28);
//ae target
	SP0A19_write_cmos_sensor(0xfd,0x00 + 0x18);
	SP0A19_write_cmos_sensor(0xed,0x7e + 0x18);
	SP0A19_write_cmos_sensor(0xf7,0x7a + 0x18);
	SP0A19_write_cmos_sensor(0xf8,0x72 + 0x18);
	SP0A19_write_cmos_sensor(0xec,0x6c + 0x18);
	
	SP0A19_write_cmos_sensor(0xef,0x88 + 0x18);
	SP0A19_write_cmos_sensor(0xf9,0x84 + 0x18);
	SP0A19_write_cmos_sensor(0xfa,0x7C + 0x18);
	SP0A19_write_cmos_sensor(0xee,0x78 + 0x18);
...
//lowlight lum
	...
	SP0A19_write_cmos_sensor(0xb3,0x1f);
	SP0A19_write_cmos_sensor(0xb4,0x40);
	SP0A19_write_cmos_sensor(0xb5,0x55);
//saturation
	SP0A19_write_cmos_sensor(0xfd,0x00);
	...
	SP0A19_write_cmos_sensor(0xd3,0x78);//83
	SP0A19_write_cmos_sensor(0xd4,0x70);//78
	SP0A19_write_cmos_sensor(0xd6,0x68);//0x70
	SP0A19_write_cmos_sensor(0xd7,0x58);//0x60
//HEQ
	SP0A19_write_cmos_sensor(0xfd,0x00);
	SP0A19_write_cmos_sensor(0xdc,0x00);
	SP0A19_write_cmos_sensor(0xdd,0x7c);
	SP0A19_write_cmos_sensor(0xde,0x98);//0x98
...
UINT32 SP0A19GetSensorID(UINT32 *sensorID)
{
	...
	*sensorID=sensor_id;
	...
	//Jieve Liu
	strcpy(SP0A19_CurrentStatus.vendor, "SUNWIN");
	return ERROR_NONE;	  
}
...
UINT32 SP0A19Open(void)
{
    ...
    //判断手机对应目录下是否有名为sp0a19_sd 的文件,没有默认参数
...
void SP0A19_set_saturation(UINT16 para)
{
    switch (para)
    {
        ...
        case ISP_SAT_HIGH:
			SP0A19_write_cmos_sensor(0xd3,0x83+0x20); //outdoor 
			SP0A19_write_cmos_sensor(0xd4,0x83+0x20); //normal 
			SP0A19_write_cmos_sensor(0xd6,0x70+0x20); //dummy
			SP0A19_write_cmos_sensor(0xd7,0x60+0x20); //low light
             break;
			 
        case ISP_SAT_LOW:
			SP0A19_write_cmos_sensor(0xd3,0x83-0x20); 
			SP0A19_write_cmos_sensor(0xd4,0x83-0x20); 
        ...
        case ISP_SAT_MIDDLE:
        default:
			SP0A19_write_cmos_sensor(0xd3,0x83);
			SP0A19_write_cmos_sensor(0xd4,0x83); 
...
void SP0A19_set_contrast(UINT16 para)
{
	...
	switch (para)
	{
		...
		case ISP_CONTRAST_LOW:
			...
			SP0A19_write_cmos_sensor(0xde,0xa4-0x20); 
			 break;
		...
		default:
			SP0A19_write_cmos_sensor(0xdd,0x7c); 
			SP0A19_write_cmos_sensor(0xde,0xa4); 
			 break;
	}
       ...
       case SENSOR_FEATURE_GET_SENSOR_NAME:
	       {/*MAX LEN is 31 char*/
	               *pFeaturePara = '\0';
	               ...
	               strcat(pFeaturePara, SP0A19_CurrentStatus.vendor );
