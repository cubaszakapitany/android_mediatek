/*****************************************************************************
Ver:2.0  2013/12/28 SuperPix Yuanjianping
(1)按黄工要求，当前项目使用TXD和TKC的屏，三赢兴和凯木金的模组，互相混用，效果需差不多；
...
{	
	...
	SP0A19_write_cmos_sensor(0x58,0x10);
	SP0A19_write_cmos_sensor(0x56,0x14);
	SP0A19_write_cmos_sensor(0x59,0x18);

	SP0A19_write_cmos_sensor(0x89,0x0a);
	SP0A19_write_cmos_sensor(0x8a,0x10);
	...
	SP0A19_write_cmos_sensor(0x5b,0xa0);
	...
	SP0A19_write_cmos_sensor(0x9b,0xE6);
	SP0A19_write_cmos_sensor(0xfd,0x01);
	SP0A19_write_cmos_sensor(0x8d,0xec);
	SP0A19_write_cmos_sensor(0x8e,0xF2);
	SP0A19_write_cmos_sensor(0xfd,0x00);
	...
	SP0A19_write_cmos_sensor(0xfd,0x01);
	SP0A19_write_cmos_sensor(0x94,0x90);
	SP0A19_write_cmos_sensor(0x95,0x28);
	SP0A19_write_cmos_sensor(0x9c,0xa0);
	SP0A19_write_cmos_sensor(0x9d,0x28);
	        
	SP0A19_write_cmos_sensor(0xfd,0x00);
	SP0A19_write_cmos_sensor(0xed,0x7c);
	SP0A19_write_cmos_sensor(0xf7,0x78);
	SP0A19_write_cmos_sensor(0xf8,0x70);
	SP0A19_write_cmos_sensor(0xec,0x6c);
	...
	SP0A19_write_cmos_sensor(0xde,0xb8);
...
{	//update param by sp_yjp,20131228
    SP0A19_write_cmos_sensor(0xfd,0x00);
    SP0A19_write_cmos_sensor(0x1C,0x28);
    SP0A19_write_cmos_sensor(0x32,0x00);
    SP0A19_write_cmos_sensor(0x0f,0x2f);
    ...
    SP0A19_write_cmos_sensor(0xfd,0x00);
    SP0A19_write_cmos_sensor(0xed,0x84);
    SP0A19_write_cmos_sensor(0xf7,0x80);
    SP0A19_write_cmos_sensor(0xf8,0x78);
    SP0A19_write_cmos_sensor(0xec,0x74);
        ...
        switch (para)
	{
		...
		case AE_EV_COMP_03: 
			...
			//ae target
			  SP0A19_write_cmos_sensor(0xfd,0x00); 
			  SP0A19_write_cmos_sensor(0xdc,0x20);
			  SP0A19_write_cmos_sensor(0xed,0x9c+0x40);
                      SP0A19_write_cmos_sensor(0xf7,0x98+0x40);
                      SP0A19_write_cmos_sensor(0xf8,0x90+0x40);
                      SP0A19_write_cmos_sensor(0xec,0x8c+0x40);
                                 
                      SP0A19_write_cmos_sensor(0xef,0x88+0x40);
                      SP0A19_write_cmos_sensor(0xf9,0x84+0x40);
                      SP0A19_write_cmos_sensor(0xfa,0x80+0x40);
                      SP0A19_write_cmos_sensor(0xee,0x7c+0x40);
		...
		case AE_EV_COMP_00:  // +0 EV
			...
			//ae target
			  SP0A19_write_cmos_sensor(0xfd,0x00); 
			   SP0A19_write_cmos_sensor(0xdc,0x00);
			  SP0A19_write_cmos_sensor(0xed,0x9c );
                      SP0A19_write_cmos_sensor(0xf7,0x98 );
                      SP0A19_write_cmos_sensor(0xf8,0x90);
                      SP0A19_write_cmos_sensor(0xec,0x8c);
                                 
                      SP0A19_write_cmos_sensor(0xef,0x88);
                      SP0A19_write_cmos_sensor(0xf9,0x84);
                      SP0A19_write_cmos_sensor(0xfa,0x80);
                      SP0A19_write_cmos_sensor(0xee,0x7c);
			  #endif
			break;
		case AE_EV_COMP_n03:  
		case AE_EV_COMP_n07:	
	    ...
	    switch (para)
	{
		...
		case AE_EV_COMP_03: 
			...
			//ae target
			  SP0A19_write_cmos_sensor(0xfd,0x00); 
			  SP0A19_write_cmos_sensor(0xdc,0x20);
                    SP0A19_write_cmos_sensor(0xed,0x84+0x40);
                    SP0A19_write_cmos_sensor(0xf7,0x80+0x40);
                    SP0A19_write_cmos_sensor(0xf8,0x78+0x40);
                    SP0A19_write_cmos_sensor(0xec,0x74+0x40);
                               
                    SP0A19_write_cmos_sensor(0xef,0x7c+0x40);
                    SP0A19_write_cmos_sensor(0xf9,0x78+0x40);
                    SP0A19_write_cmos_sensor(0xfa,0x70+0x40);
                    SP0A19_write_cmos_sensor(0xee,0x6c+0x40);
