...
//update param by sp_yjp,20130417
{	
	SP0A19_write_cmos_sensor(0xfd,0x00);
	...
	SP0A19_write_cmos_sensor(0x31,0x10);
	...
	SP0A19_write_cmos_sensor(0x2b,0x08);
	...
	SP0A19_write_cmos_sensor(0x65,0xdc);
	SP0A19_write_cmos_sensor(0x66,0xf3);
	SP0A19_write_cmos_sensor(0x67,0x93);
	SP0A19_write_cmos_sensor(0x68,0xae);

	SP0A19_write_cmos_sensor(0x69,0xba);
	SP0A19_write_cmos_sensor(0x6a,0xd3);
	SP0A19_write_cmos_sensor(0x6b,0x9b);
	SP0A19_write_cmos_sensor(0x6c,0xb3);

	SP0A19_write_cmos_sensor(0x61,0x62);
	SP0A19_write_cmos_sensor(0x62,0x7c);
	SP0A19_write_cmos_sensor(0x63,0xbc);
	SP0A19_write_cmos_sensor(0x64,0xdc);

	SP0A19_write_cmos_sensor(0x6d,0xA3);
	SP0A19_write_cmos_sensor(0x6e,0xc0);
	SP0A19_write_cmos_sensor(0x6f,0xb8);
	...
	SP0A19_write_cmos_sensor(0xef,0x18);

	SP0A19_write_cmos_sensor(0xeb,0x15);
	SP0A19_write_cmos_sensor(0xf0,0x15);

	SP0A19_write_cmos_sensor(0xfd,0x01);
	SP0A19_write_cmos_sensor(0xa0,0x84);
	...
	SP0A19_write_cmos_sensor(0xc1,0xf8);
