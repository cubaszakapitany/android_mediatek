...
#define FLASH_BV_THRESHOLD 0xa0     //Flash on threshold 
...
extern void MainCameraDigtalPDNCtrl(u32 onoff); //LINE <> <20130822> <resolve the Bug that can't change to subCamera on little phones> panzaoyan
...
///// PAGE 0 Start /////
    ...
    HI257WriteCmosSensor(0x12, 0x04); //Rinsing edge 0x04 // Falling edge 0x00 //1114 xieqi
...
//Dark BLC
    HI257WriteCmosSensor(0xa0, 0x43);//R,Gr,B,Gb Offset
...
///// PAGE 10 START /////
    ...
    HI257WriteCmosSensor(0x41, 0x08); //D-YOffset Th
    ...
    HI257WriteCmosSensor(0x50, 0x50); //D-YOffset AG

    HI257WriteCmosSensor(0x60, 0x4f); //Outdoor Saturation
    ...
    HI257WriteCmosSensor(0x6a, 0x58); //White Protection Offset Dark/Indoor//7F
...
//YC2D
    ...
    HI257WriteCmosSensor(0x23, 0x12); //Outdoor Dy Th
    HI257WriteCmosSensor(0x24, 0x1e); //Indoor Dy Th // For reso Limit 0x20
    HI257WriteCmosSensor(0x25, 0x24); //Dark Dy Th
...
//Indoor Slope
    HI257WriteCmosSensor(0xbc, 0x30); //Lum negative Hi
    HI257WriteCmosSensor(0xbd, 0x30); //Lum negative middle
    HI257WriteCmosSensor(0xbe, 0x30); //Lum negative Low
    HI257WriteCmosSensor(0xbf, 0x30); //Lum postive Hi
    HI257WriteCmosSensor(0xc0, 0x30); //Lum postive middle
    HI257WriteCmosSensor(0xc1, 0x30); //Lum postive Low

//Dark Slope
    HI257WriteCmosSensor(0xc2, 0x1f); //Lum negative Hi
    HI257WriteCmosSensor(0xc3, 0x28); //Lum negative middle
    HI257WriteCmosSensor(0xc4, 0x26); //Lum negative Low
    HI257WriteCmosSensor(0xc5, 0x1f); //Lum postive Hi
    HI257WriteCmosSensor(0xc6, 0x28); //Lum postive middle
    HI257WriteCmosSensor(0xc7, 0x26); //Lum postive Low
///// PAGE 13 END /////
...
///// PAGE 14 START /////
    ...
    HI257WriteCmosSensor(0x21, 0x80);//Y-Center

    HI257WriteCmosSensor(0x22, 0x16); //LSC R 1b->15 20130125
    HI257WriteCmosSensor(0x23, 0x11); //LSC G
    HI257WriteCmosSensor(0x24, 0x11); //LSC B
...
/////// PAGE 15 START ///////
    ...
    HI257WriteCmosSensor(0x10, 0x0f);
    HI257WriteCmosSensor(0x14, 0x52);
    HI257WriteCmosSensor(0x15, 0x42);
    HI257WriteCmosSensor(0x16, 0x32);
    HI257WriteCmosSensor(0x17, 0x2f);
//CMC
    //CMC
    HI257WriteCmosSensor(0x30, 0x8f);
    HI257WriteCmosSensor(0x31, 0x59);
    HI257WriteCmosSensor(0x32, 0x0a);
    HI257WriteCmosSensor(0x33, 0x15);
    HI257WriteCmosSensor(0x34, 0x5b);
    HI257WriteCmosSensor(0x35, 0x06);
    HI257WriteCmosSensor(0x36, 0x07);
    HI257WriteCmosSensor(0x37, 0x40);
    HI257WriteCmosSensor(0x38, 0x86);

    //CMC OFS
    HI257WriteCmosSensor(0x40, 0x95);
    HI257WriteCmosSensor(0x41, 0x1f);
    HI257WriteCmosSensor(0x42, 0x8a);
    HI257WriteCmosSensor(0x43, 0x86);
    HI257WriteCmosSensor(0x44, 0x0a);
    HI257WriteCmosSensor(0x45, 0x84);
    HI257WriteCmosSensor(0x46, 0x87);
    HI257WriteCmosSensor(0x47, 0x9b);
    HI257WriteCmosSensor(0x48, 0x23);

    //CMC POFS
    HI257WriteCmosSensor(0x50, 0x8c);
    HI257WriteCmosSensor(0x51, 0x0c);
    HI257WriteCmosSensor(0x52, 0x00);
    HI257WriteCmosSensor(0x53, 0x07);
    HI257WriteCmosSensor(0x54, 0x17);
    HI257WriteCmosSensor(0x55, 0x9d);
    HI257WriteCmosSensor(0x56, 0x00);
    HI257WriteCmosSensor(0x57, 0x0b);
    HI257WriteCmosSensor(0x58, 0x89);



    HI257WriteCmosSensor(0x03, 0x16);
    HI257WriteCmosSensor(0x10, 0x31);//GMA_CTL
    HI257WriteCmosSensor(0x18, 0x67);// Double_AG 5e->37
    HI257WriteCmosSensor(0x19, 0x66);// Double_AG 5e->36
...
//GMA
    ...
    HI257WriteCmosSensor(0x32, 0x19);
    HI257WriteCmosSensor(0x33, 0x35);
    HI257WriteCmosSensor(0x34, 0x55);
    HI257WriteCmosSensor(0x35, 0x73);
    HI257WriteCmosSensor(0x36, 0x86);
...
//BGMA
    HI257WriteCmosSensor(0x70, 0x20);
    HI257WriteCmosSensor(0x71, 0x28);
    HI257WriteCmosSensor(0x72, 0x30);
    HI257WriteCmosSensor(0x73, 0x44);
    HI257WriteCmosSensor(0x74, 0x5e);
...
///// PAGE 17 END /////
    ...
    HI257WriteCmosSensor(0x14, 0x00); //Cubic Off
...
///// PAGE 19 START /////
    ...
    HI257WriteCmosSensor(0x1f, 0x37); //mcmc_sat_gain2
    HI257WriteCmosSensor(0x20, 0x21); //mcmc_sat_gain3
    HI257WriteCmosSensor(0x21, 0x43); //mcmc_sat_gain4
    ...
    HI257WriteCmosSensor(0x26, 0x09); //mcmc_hue_angle3
...
/////// PAGE 20 START ///////
    ...
    HI257WriteCmosSensor(0x70, 0x50); //6c
    ...
    HI257WriteCmosSensor(0x83, 0x09); //EXP Normal 33.33 fps
    ...
    HI257WriteCmosSensor(0xb2, 0xa0);
    HI257WriteCmosSensor(0xb3, 0x15);
    HI257WriteCmosSensor(0xb4, 0x16);
    HI257WriteCmosSensor(0xb5, 0x44);
    HI257WriteCmosSensor(0xb6, 0x2f);
    HI257WriteCmosSensor(0xb7, 0x28);
    HI257WriteCmosSensor(0xb8, 0x25);
    HI257WriteCmosSensor(0xb9, 0x22);
    HI257WriteCmosSensor(0xba, 0x21);
    HI257WriteCmosSensor(0xbb, 0x20);
    HI257WriteCmosSensor(0xbc, 0x1f);
    HI257WriteCmosSensor(0xbd, 0x1f);

    HI257WriteCmosSensor(0xc0, 0x14);
    HI257WriteCmosSensor(0xc1, 0x1f);
    HI257WriteCmosSensor(0xc2, 0x1f);
    HI257WriteCmosSensor(0xc3, 0x18);
    HI257WriteCmosSensor(0xc4, 0x10);
...
///// PAGE 22 START /////
    ...
    HI257WriteCmosSensor(0x44, 0x87); //Unstb cdiff
    ...
    HI257WriteCmosSensor(0x8f, 0x48); //4e
    HI257WriteCmosSensor(0x90, 0x44); //4d
    HI257WriteCmosSensor(0x91, 0x3f); //4c
    HI257WriteCmosSensor(0x92, 0x37); //4a
    HI257WriteCmosSensor(0x93, 0x2e); //46
    HI257WriteCmosSensor(0x94, 0x26);
    HI257WriteCmosSensor(0x95, 0x1f);
    HI257WriteCmosSensor(0x96, 0x19);
    HI257WriteCmosSensor(0x97, 0x14);
    HI257WriteCmosSensor(0x98, 0x12);
    HI257WriteCmosSensor(0x99, 0x11);
    HI257WriteCmosSensor(0x9a, 0x10);

    HI257WriteCmosSensor(0x9b, 0x66);
...
void HI257InitPara(void)
{
    ...
    HI257Status.SATCTL = 0x0f;//SATCTL
...
//HI257WriteCmosSensor(0x11, 0x90);  // Fixed frame rate ON
            ...
            HI257WriteCmosSensor(0x83, 0x13);  //EXP Normal 8.33 fps
            HI257WriteCmosSensor(0x84, 0xd6);
            HI257WriteCmosSensor(0x85, 0x20);

            HI257WriteCmosSensor(0x86, 0x01); //EXPMin 13000.00 fps*2 by paul
            HI257WriteCmosSensor(0x87, 0xf4);


            HI257WriteCmosSensor(0x88, 0x13); //EXP Max(120Hz) 8.00 fps
            HI257WriteCmosSensor(0x89, 0xc6);
            HI257WriteCmosSensor(0x8a, 0x80);

            HI257WriteCmosSensor(0xa5, 0x13); //EXP Max(100Hz) 8.33 fps
            HI257WriteCmosSensor(0xa6, 0xd6);
            HI257WriteCmosSensor(0xa7, 0x20);

            HI257WriteCmosSensor(0x8b, 0xfd); //EXP Max(120Hz) 8.00 fps
            HI257WriteCmosSensor(0x8c, 0xe8);
            HI257WriteCmosSensor(0x8d, 0xd2);
            HI257WriteCmosSensor(0x8e, 0xf0);

            HI257WriteCmosSensor(0x9c, 0x0f);
            HI257WriteCmosSensor(0x9d, 0xa0);
        ...
        {
            SENSORDB("[HI257]HI257NightMode Enable AE_FLICKER_MODE_60HZ\n");

            SENSORDB("[HI257]HI257NightMode Disable AE_FLICKER_MODE_60HZ\n");
            HI257WriteCmosSensor(0x03, 0x00); //Page 0
//HI257WriteCmosSensor(0x11, 0x90);  // Fixed frame rate ON
            HI257WriteCmosSensor(0x03, 0x20);
            ...
            HI257WriteCmosSensor(0x84, 0xc6);
    ...
    else
    {
        ...
        if (HI257Status.Banding == AE_FLICKER_MODE_50HZ)
        {
            ...
            HI257WriteCmosSensor(0x83, 0x0b);  //EXP Normal 8.33 fps
            HI257WriteCmosSensor(0x84, 0xe6);
            HI257WriteCmosSensor(0x85, 0xe0);

            HI257WriteCmosSensor(0x86, 0x01); //EXPMin 13000.00 fps*2 by paul
            HI257WriteCmosSensor(0x87, 0xf4);


            HI257WriteCmosSensor(0x88, 0x0e); //EXP Max(120Hz) 7.00 fps
            HI257WriteCmosSensor(0x89, 0x01);
            HI257WriteCmosSensor(0x8a, 0xf0);

            HI257WriteCmosSensor(0xa5, 0x0d); //EXP Max(100Hz) 7.33 fps
            HI257WriteCmosSensor(0xa6, 0xe2);
            HI257WriteCmosSensor(0xa7, 0xb0);
...

        {
            ...
            HI257WriteCmosSensor(0x83, 0x0c);  //EXP Normal 8.33 fps
            HI257WriteCmosSensor(0x84, 0x5c);
            HI257WriteCmosSensor(0x85, 0x10);
...
u8 Hi257_Initialize_from_T_Flash()
{
    ...
    fp = filp_open("/storage/sdcard0/hi257_sd.dat", O_RDONLY , 0);
    if (IS_ERR(fp))
    {
    ...
    for (j=0; j<i; j++)
    {
        ...
        {
            HI257WriteCmosSensor((kal_uint8)HI256_Init_Reg[j].init_reg, (kal_uint8)HI256_Init_Reg[j].init_val);
        }
        else
        {
            printk("REG ERROR!\n");
                    ...
                    MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
    ...
    HI257_MPEG4_encode_mode = KAL_FALSE;
    spin_unlock(&hi257_drv_lock);
    HI257SetMirror(IMAGE_HV_MIRROR/*IMAGE_NORMAL*/);
    HI257SetAeMode(KAL_FALSE);
    HI257WriteCmosSensor(0x03,0x00);
    HI257WriteCmosSensor(0x10,0x90);
    HI257WriteCmosSensor(0x03,0x10); //page10 for flash
//HI257WriteCmosSensor(0x48,0x90);
    HI257WriteCmosSensor(0x6a,0x58);
    HI257WriteCmosSensor(0x41,0x08);

    HI257WriteCmosSensor(0x03, 0x12); //Outdoor Dy Th
    HI257WriteCmosSensor(0x24, 0x18); //Indoor Dy Th // For reso Limit 0x20
    ...
    HI257WriteCmosSensor(0x83, (HI257Status.PvShutter >> 16) & 0xFF);
    HI257WriteCmosSensor(0x84, (HI257Status.PvShutter >> 8) & 0xFF);
    HI257WriteCmosSensor(0x85, HI257Status.PvShutter & 0xFF);
                    ...
                    MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
    ...
    HI257SetPage(0x20);
    AG=HI257ReadCmosSensor(0xB0);
    Ymean=HI257ReadCmosSensor(0xD2);

    HI257WriteCmosSensor(0x03,0x00);
    HI257WriteCmosSensor(0x10,0x00);

    HI257WriteCmosSensor(0x03,0x12); //Outdoor Dy Th
    HI257WriteCmosSensor(0x24,0x10); //Indoor Dy Th // For reso Limit 0x20
...
//HI257WriteCmosSensor(0x48, 0x88);
    ...
    tempbrightness=HI257ReadCmosSensor(0xd2);
    CapShutter = HI257Status.PvShutter;

//Flash_FLAG = FL_GetCaputureFLStatus();
    if (Flash_FLAG == 0)
    {
        HI257WriteCmosSensor(0x03, 0x10);//normal mode
        HI257WriteCmosSensor(0x6a, 0x58);
    ...
    else
    {
        ...
        {
            HI257WriteCmosSensor(0x03, 0x10);//very dark mode
            HI257WriteCmosSensor(0x6a, 0x22);
            CapShutter = HI257Status.PvShutter*2;
        }

        else
        {
            HI257WriteCmosSensor(0x03, 0x10);// dark mode
            HI257WriteCmosSensor(0x6a, 0x24);
            HI257SetPage(0x22);
            HI257WriteCmosSensor(0x82,(HI257ReadCmosSensor(0x82)-5));//make sure the Yoffset control is opened.
            CapShutter = HI257Status.PvShutter;
        }
        ...
        SENSORDB("HI257 FL_GetCaputureFLStatus\n");
    }
...
static void HI257GetAEFlashlightInfo(UINT32 pSensorAEAWBCurStruct)
{
    PSENSOR_AE_AWB_CUR_STRUCT Info = (PSENSOR_AE_AWB_CUR_STRUCT)pSensorAEAWBCurStruct;
    SENSORDB("HI257GetAEFlashlightInfo Info = 0x%x \n", Info);
    ...
    /*
        ...
        Info->GAIN_BASE = 50;  */
//    Flash_FLAG = 1;
    SENSORDB("HI257GetAEFlashlightInfo Info->SensorAECur.AeCurShutter  = 0x%x \n", Info->SensorAECur.AeCurShutter);
    SENSORDB("HI257GetAEFlashlightInfo Info->SensorAECur.AeCurGain  = 0x%x \n", Info->SensorAECur.AeCurGain);
}
...
BOOL HI257SetEffect(UINT16 Para)
{
    ...
    switch (Para)
    {
        case MEFFECT_OFF:
            HI257WriteCmosSensor(0x03, 0x10);
            HI257WriteCmosSensor(0x11, 0x03);
            HI257WriteCmosSensor(0x13, 0x03);//contrast on
            HI257WriteCmosSensor(0x12, 0xf0);
...
BOOL HI257SetExposure(UINT16 Para)
{
    ...
    HI257SetPage(0x10);
    HI257WriteCmosSensor(0x12,(HI257ReadCmosSensor(0x12)|0x10));//make sure the Yoffset control is opened.
...
void HI257set_iso(UINT16 para)
{
    ...
    switch (para)
    {
        ...
        case AE_ISO_200:
            //ISO200
            HI257WriteCmosSensor(0x03, 0x20);
            HI257WriteCmosSensor(0xb2, 0x58);
            break;
        case AE_ISO_400:
            //ISO400
            HI257WriteCmosSensor(0x03, 0x20);
...
//HI257WriteCmosSensor(0x11, 0x90);
        ...
        HI257WriteCmosSensor(0x90, 0x0f); //BLC_TIME_TH_ON
        HI257WriteCmosSensor(0x91, 0x0f); //BLC_TIME_TH_OFF
        HI257WriteCmosSensor(0x92, 0x88); //BLC_AG_TH_ON
        HI257WriteCmosSensor(0x93, 0x80); //BLC_AG_TH_OFF

        HI257WriteCmosSensor(0x03, 0x02);
        HI257WriteCmosSensor(0xd4, 0x0f); //DCDC_TIME_TH_ON
        HI257WriteCmosSensor(0xd5, 0x0f); //DCDC_TIME_TH_OFF
        HI257WriteCmosSensor(0xd6, 0x88); //DCDC_AG_TH_ON
        HI257WriteCmosSensor(0xd7, 0x80); //DCDC_AG_TH_OFF
        /*
        HI257WriteCmosSensor(0x03, 0x20);
        HI257WriteCmosSensor(0x10, 0x1c);
        ...
        HI257WriteCmosSensor(0x83, 0x13);  //EXP Normal 5.33 fps
        HI257WriteCmosSensor(0x84, 0xd6);
        HI257WriteCmosSensor(0x85, 0x20);
        ...
        HI257WriteCmosSensor(0xa5, 0x13); //EXP Max(100Hz) 5.33 fps
        HI257WriteCmosSensor(0xa6, 0xd6);
        HI257WriteCmosSensor(0xa7, 0x20);

        HI257WriteCmosSensor(0x8b, 0xfd); //EXP Max(120Hz) 5.00 fps
        HI257WriteCmosSensor(0x8c, 0xe8);
        HI257WriteCmosSensor(0x8d, 0xd2);
        HI257WriteCmosSensor(0x8e, 0xf0);
...
///add feature
        ...
        case SENSOR_FEATURE_GET_AE_FLASHLIGHT_INFO:
            HI257GetAEFlashlightInfo(*pFeatureData32);
            break;
