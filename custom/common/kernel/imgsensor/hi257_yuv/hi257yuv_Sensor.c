...
HI257WriteCmosSensor(0x12, 0x00); //Rinsing edge 0x04 // Falling edge 0x00
...
HI257WriteCmosSensor(0x74, 0x0f); //White Protection Offset Outdoor
...
HI257WriteCmosSensor(0x22, 0x12); //LSC R 1b->15 20130125
HI257WriteCmosSensor(0x23, 0x0f); //LSC G
HI257WriteCmosSensor(0x24, 0x0f); //LSC B
...
HI257WriteCmosSensor(0x71, 0x0b);
HI257WriteCmosSensor(0x72, 0x18);
HI257WriteCmosSensor(0x73, 0x2c);
HI257WriteCmosSensor(0x74, 0x4b);
HI257WriteCmosSensor(0x75, 0x67);
HI257WriteCmosSensor(0x76, 0x7e);
HI257WriteCmosSensor(0x77, 0x90);
HI257WriteCmosSensor(0x78, 0xa2);
HI257WriteCmosSensor(0x79, 0xb0);
HI257WriteCmosSensor(0x7a, 0xbe);
HI257WriteCmosSensor(0x7b, 0xcb);
HI257WriteCmosSensor(0x7c, 0xd6);
HI257WriteCmosSensor(0x7d, 0xe0);
HI257WriteCmosSensor(0x7e, 0xe8);
HI257WriteCmosSensor(0x7f, 0xef);
HI257WriteCmosSensor(0x80, 0xf6);
HI257WriteCmosSensor(0x81, 0xfb);
...
HI257WriteCmosSensor(0x9b, 0xbb);
...
void HI257set_iso(UINT16 para)
{
	...
	//ISO400
	HI257WriteCmosSensor(0x03, 0x20); 
	HI257WriteCmosSensor(0xb2, 0xd0); 
...
void HI257set_saturation(UINT16 para)
{
	...
	HI257WriteCmosSensor(0x03, 0x10);
	HI257WriteCmosSensor(0x61, 0xa0); //Sat B
	HI257WriteCmosSensor(0x62, 0xa0); // SATR
             break;
    }
     return;
}
