...
void SP2519_night_mode(kal_bool bEnable)
{
	...
	if (bEnable)/*night mode settings*/
	{
		...
		if(SP2519_MPEG4_encode_mode == KAL_TRUE) /*video night mode*/
		{
			...
			SP2519_write_cmos_sensor(0x3f , 0x02);
...
{	////update param by sp_yjp,20140122
	...
	SP2519_write_cmos_sensor(0x66,0x3e);
	SP2519_write_cmos_sensor(0x67,0x63);
	SP2519_write_cmos_sensor(0x68,0xb9);
	SP2519_write_cmos_sensor(0x69,0xdf);
	SP2519_write_cmos_sensor(0x6a,0xa5);
	
	SP2519_write_cmos_sensor(0x7c,0x2b);	
	SP2519_write_cmos_sensor(0x7d,0x4d);	
	SP2519_write_cmos_sensor(0x7e,0xe6);	
	SP2519_write_cmos_sensor(0x7f,0x06);	
	SP2519_write_cmos_sensor(0x80,0xa6);
	
	SP2519_write_cmos_sensor(0x70,0x06);	
	SP2519_write_cmos_sensor(0x71,0x30);	
	SP2519_write_cmos_sensor(0x72,0x06);	
	SP2519_write_cmos_sensor(0x73,0x2c);	
	...
	SP2519_write_cmos_sensor(0x8b,0x00);
	SP2519_write_cmos_sensor(0x8c,0x0b);
	SP2519_write_cmos_sensor(0x8d,0x18);
	SP2519_write_cmos_sensor(0x8e,0x26);
	SP2519_write_cmos_sensor(0x8f,0x31);
