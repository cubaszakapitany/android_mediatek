#ifndef __OV5645_MIPIYUV_SENSOR_H
#define __OV5645_MIPIYUV_SENSOR_H
...
typedef enum _OV5645_OP_TYPE_ {
        OV5645_MODE_NONE,
        OV5645_MODE_PREVIEW,
        OV5645_MODE_CAPTURE,
        OV5645_MODE_QCIF_VIDEO,
        OV5645_MODE_CIF_VIDEO,
        OV5645_MODE_QVGA_VIDEO
    } OV5645_OP_TYPE;
...
struct Sensor_para
{
    ...
    kal_int32      AF_window_x;
    kal_int32      AF_window_y;
    ...
    UINT16 iWB;
    OV5645_SENSOR_MODE SensorMode;
    kal_uint32 zone_addr[6];
};
...
extern OV5645_OP_TYPE OV5645_g_iOV5645_Mode;

#define OV5645_ID_REG                          (0x300A)
#define OV5645_INFO_REG                        (0x300B)
 extern int ov5645_mipi_yuv_af_poweron(BOOL On);

/* sensor size */
#define OV5645_IMAGE_SENSOR_SVGA_WIDTH          (1280)
#define OV5645_IMAGE_SENSOR_SVGA_HEIGHT         (960)
#define OV5645_IMAGE_SENSOR_VIDEO_WITDH         (1280)
#define OV5645_IMAGE_SENSOR_VIDEO_HEIGHT        (960)

#define OV5645_IMAGE_SENSOR_720P_WIDTH          (1280)
#define OV5645_IMAGE_SENSOR_720P_HEIGHT         (720)
#define OV5645_IMAGE_SENSOR_QSXGA_WITDH        (2560) 
#define OV5645_IMAGE_SENSOR_QSXGA_HEIGHT       (1440)

/* Sesnor Pixel/Line Numbers in One Period */	
#define OV5645_PV_PERIOD_PIXEL_NUMS    		(2160)  		/* Default preview line length */
#define OV5645_PV_PERIOD_LINE_NUMS     		(740)   	/* Default preview frame length */
#define OV5645_FULL_PERIOD_PIXEL_NUMS  		(2984)  	/* Default full size line length */
#define OV5645_FULL_PERIOD_LINE_NUMS   		(1464)  	/* Default full size frame length */

/* Sensor Exposure Line Limitation */
#define OV5645_PV_EXPOSURE_LIMITATION      	(740-4)
#define OV5645_FULL_EXPOSURE_LIMITATION    	(1464-4)

/* Config the ISP grab start x & start y, Config the ISP grab width & height */
#define OV5645_PV_GRAB_START_X                 (1)
#define OV5645_PV_GRAB_START_Y  			(1)
#define OV5645_PV_GRAB_WIDTH				(OV5645_IMAGE_SENSOR_720P_WIDTH - 8)
#define OV5645_PV_GRAB_HEIGHT				(OV5645_IMAGE_SENSOR_720P_HEIGHT - 6)

#define OV5645_FULL_GRAB_START_X               (1)
#define OV5645_FULL_GRAB_START_Y	  		(1)
#define OV5645_FULL_GRAB_WIDTH				(OV5645_IMAGE_SENSOR_QSXGA_WITDH - 16)
#define OV5645_FULL_GRAB_HEIGHT				(OV5645_IMAGE_SENSOR_QSXGA_HEIGHT - 12)

/*50Hz,60Hz*/
#define OV5645_NUM_50HZ                        (50 * 2)
#define OV5645_NUM_60HZ                        (60 * 2)

/* FRAME RATE UNIT */
#define OV5645_FRAME_RATE_UNIT                 (10)

/* MAX CAMERA FRAME RATE */
#define OV5645_MAX_CAMERA_FPS                  (OV5645_FRAME_RATE_UNIT * 30)
...
#define OV5645_WRITE_ID						    0x78
#define OV5645_READ_ID								0x79

extern BOOL OV5645_set_param_wb(UINT16 para);
extern BOOL OV5645_set_param_effect(UINT16 para);
extern BOOL OV5645_set_param_banding(UINT16 para);
extern BOOL OV5645_set_param_exposure(UINT16 para);
extern void OV5645_set_brightness(UINT16 para);
extern void OV5645_set_contrast(UINT16 para);
extern void OV5645_set_saturation(UINT16 para);
extern void OV5645_set_iso(UINT16 para);
extern kal_uint32 OV5645ReadShutter(void);
extern kal_uint32 OV5645ReadSensorGain(void);
extern void OV5645WriteShutter(kal_uint32 shutter);
extern void OV5645_night_mode(kal_bool enable);
extern void OV5645WriteSensorGain(kal_uint32 gain);
extern void OV5645SetDummy(kal_uint32 dummy_pixels, kal_uint32 dummy_lines);
extern void OV5645_set_AE_mode(kal_bool AE_enable);
extern void OV5645_set_AWB_mode(kal_bool AWB_enable);
extern void OV5645_night_mode(kal_bool enable);
extern kal_uint32 OV5645_GetSensorID(kal_uint32 *sensorID);
extern void OV5645InitialSetting_truly_af(void);
extern void OV5645InitialSetting_truly_ff(void);
extern void OV5645InitialSetting_darling_af(void);
extern void OV5645InitialSetting_darling_ff(void);
extern void OV5645_Standby(void);
extern void OV5645_Wakeup(void);
extern void OV5645PreviewSetting_720p(void);
extern void OV5645VideoSetting_720p(void);
extern void OV5645FullSizeCaptureSetting(OV5645_SENSOR_MODE eSensorMode);
extern void OV5645SetHVMirror(kal_uint8 Mirror,kal_uint8 Mode);
extern void OV5645_FOCUS_OVT_AFC_Init(void);
extern void OV5645_FOCUS_OVT_AFC_Constant_Focus(void);
extern void OV5645_set_scene_mode(UINT16 para);
extern UINT32 OV5645GetDefaultFramerateByScenario(MSDK_SCENARIO_ID_ENUM scenarioId, MUINT32 *pframeRate);
extern void update_PIP_position(int position, int Cam_Mode);
extern void change_pip_position(u32 x, u32 y, u32 z);
extern void OV5645GetExifInfo(UINT32 exifAddr);
extern void OV5645_FlashTriggerCheck(unsigned int *pFeatureReturnPara32);
extern void OV5645initalvariable(void);
extern void OV5645_FOCUS_OVT_AFC_Get_AF_Status(UINT32 *pFeatureReturnPara32);
extern void OV5645_FOCUS_OVT_AFC_Single_Focus(void);
extern kal_uint32 OV5645ReadExtraShutter(void);
extern void OV5645GetCurAeAwbInfo(UINT32 pSensorAEAWBCurStruct);
extern void OV5645GetEvAwbRef(UINT32 pSensorAEAWBRefStruct);
extern void OV5645PreviewSetting_SVGA(void);
extern void OV5645_FOCUS_OVT_AFC_Pause(void);
extern void OV5645_FOCUS_OVT_AFC_Realse(void);
extern void OV5645_FOCUS_Get_AF_Max_Num_Focus_Areas(UINT32 *pFeatureReturnPara32);
extern void OV5645_FOCUS_Get_AE_Max_Num_Metering_Areas(UINT32 *pFeatureReturnPara32);
extern void OV5645_FOCUS_OVT_AFC_Touch_AF(INT32 x, INT32 y);
extern void OV5645WBcalibattion(kal_uint32 color_r_gain,kal_uint32 color_b_gain);
extern void OV5645_FOCUS_Set_AF_Window(UINT32 zone_addr);
extern void OV5645_FOCUS_Get_AF_Macro(UINT32 *pFeatureReturnPara32);
extern void OV5645_FOCUS_Get_AF_Inf(UINT32 * pFeatureReturnPara32);
extern UINT32 OV5645_FOCUS_Move_to(UINT32 a_u2MovePosition);
extern void OV5645_FOCUS_OVT_AFC_Cancel_Focus(void);
extern void OV5645_get_AEAWB_lock(UINT32 *pAElockRet32, UINT32 *pAWBlockRet32);
extern void OV5645PIP_FOCUS_Set_AE_Window(UINT32 zone_addr);
extern void OV5645_3ACtrl(ACDK_SENSOR_3A_LOCK_ENUM action);
extern void OV5645_GetDelayInfo(UINT32 delayAddr);
extern UINT32 OV5645PIPSetTestPatternMode(kal_bool bEnable);
extern void OV5645WriteExpShutter(kal_uint32 shutter);
extern UINT32 OV5645read_vcm_adc(void);
extern UINT32 OV5645set_vcm_adc(adcvalue);
extern void OV5645_PIP_Set_Window(UINT32 zone_addr);
extern void OV5645_PIP_Set_Frame_Color(kal_uint8  uR, kal_uint8 uG, kal_uint8 uB);
extern int OV5645PIP_Initialize_from_T_Flash(void);
#ifndef DEBUG_SENSOR
#define DEBUG_SENSOR
#endif

#if 1
static kal_uint8 firmware[]=
{
...
static kal_uint8 firmware[]=
{
    ...
    0xff, 0x3a, 0x00, 0x00, 0xff, 0x36, 0x03, 0x36, 0x02, 0x41, 0x44, 0x58, 0x20, 0x18, 0x10, 0x0a, //0x8e60,
    0x04, 0x04, 0x00, 0x03, 0xff, 0x64, 0x00, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, //0x8e70,
    0x04, 0x06, 0x06, 0x00, 0x02, 0x65, 0x00, 0x7a, 0x50, 0x28, 0x1e, 0x08, 0x08, 0x01, 0x1e, 0x1e, //0x8e80,
    0x1e, 0x1e, 0x68, 0x68, 0x68, 0x68, 0x03, 0x05, 0x0a, 0x08, 0x10, 0x01, 0x0a, 0x06, 0x06, 0x05, //0x8e90,
    0x05, 0x05, 0x05, 0x04, 0x04, 0x04, 0x04, 0x04, 0xfc, 0xfc, 0xfc, 0xfc, 0xfc, 0xfc, 0x00, 0xa5, //0x8ea0,
    0x5a, 0x00, 0x12, 0x0a, 0xf0, 0x8f, 0x0e, 0x8e, 0x0d, 0x8d, 0x0c, 0x8c, 0x0b, 0x78, 0x07, 0x12, //0x8eb0,
    0x0c, 0x1e, 0x8f, 0x0e, 0x8e, 0x0d, 0x8d, 0x0c, 0x8c, 0x0b, 0xab, 0x0e, 0xaa, 0x0d, 0xa9, 0x0c, //0x8ec0,
    0xa8, 0x0b, 0x22, 0xef, 0x25, 0xe0, 0x24, 0x56, 0xf8, 0xe6, 0xfc, 0x08, 0xe6, 0xfd, 0xee, 0x25, //0x8ed0,
