...
int tpd_driver_add(struct tpd_driver_t *tpd_drv)
{
	...
	for(i = 1; i < TP_DRV_MAX_COUNT; i++)
	{
		...
		if(tpd_driver_list[i].tpd_device_name == NULL)
		{
			...
			tpd_driver_list[i].tpd_TpName = tpd_drv->tpd_TpName;
			#if 0
...
#if defined (TINNO_ANDROID_S9096) || defined (TINNO_ANDROID_S8122)||defined(TINNO_ANDROID_S7811A)||defined(TINNO_ANDROID_S7810)||defined(TINNO_ANDROID_S3520AP)||defined(TINNO_ANDROID_S3521AP)
char tpd_desc[50];
int tpd_fw_version = 0;
static ssize_t tpd_fw_version_show(struct device *dev,struct device_attribute *attr,char *buf)
{
...
static ssize_t tpd_desc_show(struct device *dev,struct device_attribute *attr,char *buf)
{	

#if defined   TINNO_ANDROID_S3520AP
        sprintf(tpd_desc, "%s",g_tpd_drv->tpd_TpName());
#elif defined TINNO_ANDROID_S7810
	sprintf(tpd_desc, "%s-S7810BP-%s-%X",get_fw_name(),"FT5436", get_fw_version_ext());
#else
	sprintf(tpd_desc, "%s-S7811AE-%s-%X",get_fw_name(),"FT5436", get_fw_version_ext());
#endif
...
#if defined(TINNO_ANDROID_S9096) || defined(TINNO_ANDROID_S8122)||defined(TINNO_ANDROID_S7811A)||defined(TINNO_ANDROID_S3520AP)||defined(TINNO_ANDROID_S3521AP)
