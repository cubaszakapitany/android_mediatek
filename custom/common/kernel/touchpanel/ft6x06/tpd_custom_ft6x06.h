...
#define TPD_YMAX_NB	        531
#define TPD_YMAX_BYD	    516  //LINE <tp> <DATE20130508> <TP YMAX> zhangxiaofei 
...
//BEGIN <S6030> <DATE20121220> <S6030 TP> zhangxiaofei
  #define TPD_B1_FP	35		//Button 1 pad space
  #define TPD_B1_W	50		//Button 1 Width
  #define TPD_B2_FP	50		//Button 2 pad space
  #define TPD_B2_W	50		//Button 2 Width
  #define TPD_B3_FP	50		//Button 3 pad space
  #define TPD_B3_W	50		//Button 3 Width 
...
#define FTS_CTP_VENDOR_EKT      (0xf0)
