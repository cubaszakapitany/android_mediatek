...
#if 0
#define STP_INFO_DEV(fmt,arg...)           printk("<<-STP-INFO->> "fmt"\n",##arg)
#else
#define STP_INFO_DEV(fmt,arg...)           do {} while (0)
#endif
#ifdef  SYNAPTICS_DEBUG_IF
