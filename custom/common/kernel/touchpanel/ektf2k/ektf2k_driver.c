...
static int tpd_keys_local2[TPD_KEY_COUNT] = TPD_KEYS;
...
#include "S3511_hua_9008.i"
};
static uint8_t file_fw_data_shenyue[] = {
#include "S3511_shen_9008.i"
};
static uint8_t* file_fw_data = NULL;

//FW ID CHECK ----start by baojun.fu
#define FW_ID_HUARUICHUAN				0x3510
#define FW_ID_SHENYUE			0x3511
...
//    if( (major != 0X40) && (major != 0X27) )//not fit for all FW ID then write it
    if(buf_recv[2] != cmd[2])
    {
