...
#define ELAN_X_MAX      778 
#define ELAN_Y_MAX      1152

#define LCM_X_MAX      320 //simple_strtoul(LCM_WIDTH, NULL, 0)
#define LCM_Y_MAX       480//simple_strtoul(LCM_HEIGHT, NULL, 0)
...
//LINE <Jira ID (KeyCode)> <DATE20130726> <BUG INFO> zhangxiaofei
