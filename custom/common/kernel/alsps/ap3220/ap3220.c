...
//	    APS_ERR("Ivan ap3220_check_intr PS1 = %x \n", databuf[1]);
	   ...
	   if(1)  // //LINE<DATE20140507><screen can't suspend under sunshine>zx++
	    {
...
//PS Configuration 
	data = (AP3220_PS_SETTING_INTG_TIME_4<< AP3220_PS_INTEGEATED_TIME_SHIFT) & AP3220_PS_INTEGEATED_TIME_MASK;
...
//PS Calibration L 
	data = 0x0;		// 0 = no waiting; 1 = 1 mean time, etc
...
//PS Calibration H	
	data = 0x70;		// 0 = no waiting; 1 = 1 mean time, etc
...
static int __init ap3220_init(void)
{
	...
	i2c_register_board_info(hw->i2c_num, &i2c_ap3220, 1);
