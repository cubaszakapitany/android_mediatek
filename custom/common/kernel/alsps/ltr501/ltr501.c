...
static DRIVER_ATTR(phone_color,    0666, ltr501_show_phone_color, ltr501_store_phone_color);
...
static DRIVER_ATTR(factory_reset_flag,    0666, ltr501_show_factory_reset_flag, ltr501_store_factory_reset_flag);
/*----------------------------------------------------------------------------*/
	...
	switch (command)
	{
		...
		case SENSOR_GET_DATA:
			...
			else
			{
				sensor_data = (hwm_sensor_data *)buff_out;
				obj->als = ltr501_als_read(als_gainrange);
				//begin<bug><EFFA-83><><20140505>yinhuiyong
