...
#include "STK3308.h"
#define DRIVER_VERSION          "3.2.2 20140916"
...
#define STK_LT_N_CT	50
#define STK_HT_N_CT	100
#endif /* #ifdef STK_TUNE0 */

#define STK_LT_DEF     450
#define STK_HT_DEF     500
...
static int stk_ps_tune_zero_final(struct stk3x1x_priv *obj)
{
	...
	{
		obj->ps_high_thd_boot = obj->ps_stat_data[1] + 200;
		obj->ps_low_thd_boot = obj->ps_stat_data[1] + 150;	
		obj->boot_cali = 40;
	}
...
static int stk_ps_tune_zero_func_fae(struct stk3x1x_priv *obj)
{
	...
	if(diff == obj->psi)
	{
		...
		obj->ps_high_thd_boot = obj->psi + 200;
		obj->ps_low_thd_boot = obj->psi + 150;
		...
		if(atomic_read(&obj->ps_high_thd_val) > obj->ps_high_thd_tmp)
		{
			...
			if(obj->boot_cali >= 1 && obj->boot_ct != 0xFFFF)
			{
				obj->ps_high_thd_boot = obj->boot_ct + 200;
				obj->ps_low_thd_boot = obj->boot_ct + 150;	
		...
		{
			obj->boot_ct = obj->psi;
			obj->ps_high_thd_tmp = obj->boot_ct + 200;
			obj->ps_low_thd_tmp = obj->boot_ct + 150;
...
static void stk3308_ps_cali_set_threshold(void)
{
    ...
    if( value_high > 0x7ef)
    {
        value_high= 0x7ff;
        value_low= 0x7ff;
        APS_LOG("stk3308_ps_cali_set_threshold: set value_high=0x7ff,value_low=0x7ff, please check the phone \n");
    }
...
static int stk3x1x_i2c_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	obj->wait_val = 0x00;//obj->hw->wait_val;
	obj->int_val = 0;
	obj->first_boot = true;			 
	obj->als_correct_factor = 1000;
