					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
    ...
    spin_unlock(&hi704_yuv_drv_lock);
	 HI704_write_cmos_sensor(0x03, 0x10);
        HI704_write_cmos_sensor(0x61, 0xa0);
        HI704_write_cmos_sensor(0x62, 0xb0);
    return ERROR_NONE;
}	/* HM3451Capture() */
...
BOOL HI704_set_param_effect(UINT16 para)
{
   SENSORDB("[Enter]HI704 set_param_effect func:para = %d\n",para);
    ...
    case MEFFECT_OFF:
        ...
        HI704_write_cmos_sensor(0x60, 0x8d);
        HI704_write_cmos_sensor(0x62, 0xa0);
        HI704_write_cmos_sensor(0x63, 0xb0);
