...
* custom exif
*******************************************************************************/
#define EN_CUSTOM_EXIF_INFO//LINE <SJSOIB-23 ><SSZTZ-9> <DATE20130509> <modify camera EXIF: "maker","Model"> wupingzhou
MINT32 custom_SetExif(void **ppCustomExifTag)
{
#ifdef EN_CUSTOM_EXIF_INFO
#ifdef CUSTOM_WIKO_VERSION
#define CUSTOM_EXIF_STRING_MAKE  "WIKO"//guchunhua,DATE20130715,modify for BSSZTOEFRWIKO-8.LINE
#define CUSTOM_EXIF_STRING_MODEL "OZZY"
#else
#define CUSTOM_EXIF_STRING_MAKE  "Tinno"//LINE <SJSOIB-23 ><SSZTZ-9> <DATE20130509> <modify camera EXIF: "maker","Model"> wupingzhou
#define CUSTOM_EXIF_STRING_MODEL "S6031"//LINE <SJSOIB-23 ><SSZTZ-9> <DATE20130509> <modify camera EXIF: "maker","Model"> wupingzho
#endif
#define CUSTOM_EXIF_STRING_SOFTWARE "S6031"//LINE <SJSOIB-23 ><SSZTZ-9> <DATE20130509> <modify camera EXIF: "maker","Model"> wupingzhou
