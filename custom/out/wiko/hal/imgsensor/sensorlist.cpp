...
MSDK_SENSOR_INIT_FUNCTION_STRUCT SensorList[] =
{
		...
		YUV_INFO(OV7695MIPI_SENSOR_ID, SENSOR_DRVNAME_OV7695_MIPI_YUV,NULL), 
#endif
#if defined(TINNO_PIP_SUPPORT)
  #if defined(OV5645PIP_MIPI_YUV)
		YUV_INFO(OV5645PIP_MIPI_SENSOR_ID, SENSOR_DRVNAME_OV5645PIP_MIPI_YUV,NULL), 
		YUV_INFO(OV7695PIP_SENSOR_ID, SENSOR_DRVNAME_OV7695PIP_YUV,NULL), 
  #endif
#endif
#if defined(OV5644_MIPI_YUV)
		YUV_INFO(OV5644MIPI_SENSOR_ID, SENSOR_DRVNAME_OV5644_MIPI_YUV,NULL),     
#endif
#if defined(OV7695_YUV)
		YUV_INFO(OV7695_SENSOR_ID, SENSOR_DRVNAME_OV7695_YUV,NULL), 
#endif
...
//END <sp0a19> <DATE20130509> <sp0a19 driver> zhangxiaofei
    ...
    YUV_INFO(SP0A18_SENSOR_ID, SENSOR_DRVNAME_SP0A18_YUV, NULL), 
#endif
