...
void OV5646MIPIInitialSetting(void)
{
	...
	OV5646MIPI_write_cmos_sensor(0x3a19, 0xa0);//	; gain ceiling          
	...
	OV5646MIPI_write_cmos_sensor(0x5181, 0xfa);//
	...
	OV5646MIPI_write_cmos_sensor(0x5186, 0x13);//
	OV5646MIPI_write_cmos_sensor(0x5187, 0x1a);//
	OV5646MIPI_write_cmos_sensor(0x5188, 0x10);//
	OV5646MIPI_write_cmos_sensor(0x5189, 0x75);//0x75
	OV5646MIPI_write_cmos_sensor(0x518a, 0x58);//
	OV5646MIPI_write_cmos_sensor(0x518b, 0x99);//0xcc
	OV5646MIPI_write_cmos_sensor(0x518c, 0x84);//
	OV5646MIPI_write_cmos_sensor(0x518d, 0x2e);//
	OV5646MIPI_write_cmos_sensor(0x518e, 0x2e);//
	OV5646MIPI_write_cmos_sensor(0x518f, 0x61);//
	OV5646MIPI_write_cmos_sensor(0x5190, 0x44);//
	...
	OV5646MIPI_write_cmos_sensor(0x5384, 0x07);//08
	OV5646MIPI_write_cmos_sensor(0x5385, 0x69);//75
	OV5646MIPI_write_cmos_sensor(0x5386, 0x70);//7d
	OV5646MIPI_write_cmos_sensor(0x5387, 0x74);//81
	OV5646MIPI_write_cmos_sensor(0x5388, 0x68);//74
	OV5646MIPI_write_cmos_sensor(0x5389, 0x0b);//0d
	...
	OV5646MIPI_write_cmos_sensor(0x5300, 0x18);//	; sharpen MT th1
	OV5646MIPI_write_cmos_sensor(0x5301, 0x48);//	; sharpen MT th2
	OV5646MIPI_write_cmos_sensor(0x5302, 0x30);//	; sharpen MT off1
	...
	//From OV Kobe D65.
	OV5646MIPI_write_cmos_sensor(0x5800, 0x17);//lsc
	OV5646MIPI_write_cmos_sensor(0x5801, 0x13);//
	OV5646MIPI_write_cmos_sensor(0x5802, 0x10);//
	OV5646MIPI_write_cmos_sensor(0x5803, 0x10);//
	OV5646MIPI_write_cmos_sensor(0x5804, 0x15);//
	OV5646MIPI_write_cmos_sensor(0x5805, 0x1c);//
	OV5646MIPI_write_cmos_sensor(0x5806, 0x0c);//
	OV5646MIPI_write_cmos_sensor(0x5807, 0x09);//
	OV5646MIPI_write_cmos_sensor(0x5808, 0x05);//
	OV5646MIPI_write_cmos_sensor(0x5809, 0x06);//
	OV5646MIPI_write_cmos_sensor(0x580a, 0x08);//
	OV5646MIPI_write_cmos_sensor(0x580b, 0x10);//
	OV5646MIPI_write_cmos_sensor(0x580c, 0x08);//
	OV5646MIPI_write_cmos_sensor(0x580d, 0x03);//
	OV5646MIPI_write_cmos_sensor(0x580e, 0x01);//
	OV5646MIPI_write_cmos_sensor(0x580f, 0x01);//
	OV5646MIPI_write_cmos_sensor(0x5810, 0x03);//
	OV5646MIPI_write_cmos_sensor(0x5811, 0x09);//
	...
	OV5646MIPI_write_cmos_sensor(0x5816, 0x03);//
	OV5646MIPI_write_cmos_sensor(0x5817, 0x09);//
	OV5646MIPI_write_cmos_sensor(0x5818, 0x0d);//
	OV5646MIPI_write_cmos_sensor(0x5819, 0x09);//
	OV5646MIPI_write_cmos_sensor(0x581a, 0x06);//
	OV5646MIPI_write_cmos_sensor(0x581b, 0x06);//
	OV5646MIPI_write_cmos_sensor(0x581c, 0x09);//
	OV5646MIPI_write_cmos_sensor(0x581d, 0x10);//
	OV5646MIPI_write_cmos_sensor(0x581e, 0x19);//
	OV5646MIPI_write_cmos_sensor(0x581f, 0x15);//
	OV5646MIPI_write_cmos_sensor(0x5820, 0x11);//
	OV5646MIPI_write_cmos_sensor(0x5821, 0x12);//
	OV5646MIPI_write_cmos_sensor(0x5822, 0x18);//
	OV5646MIPI_write_cmos_sensor(0x5823, 0x1d);//
	OV5646MIPI_write_cmos_sensor(0x5824, 0x26);//
	OV5646MIPI_write_cmos_sensor(0x5825, 0x24);//
	OV5646MIPI_write_cmos_sensor(0x5826, 0x26);//
	OV5646MIPI_write_cmos_sensor(0x5827, 0x24);//
	OV5646MIPI_write_cmos_sensor(0x5828, 0x46);//
	OV5646MIPI_write_cmos_sensor(0x5829, 0x06);//
	OV5646MIPI_write_cmos_sensor(0x582a, 0x22);//
	OV5646MIPI_write_cmos_sensor(0x582b, 0x22);//
	OV5646MIPI_write_cmos_sensor(0x582c, 0x22);//
	OV5646MIPI_write_cmos_sensor(0x582d, 0x24);//
	OV5646MIPI_write_cmos_sensor(0x582e, 0x06);//
	...
	OV5646MIPI_write_cmos_sensor(0x5833, 0x28);//
	OV5646MIPI_write_cmos_sensor(0x5834, 0x24);//
	OV5646MIPI_write_cmos_sensor(0x5835, 0x24);//
	OV5646MIPI_write_cmos_sensor(0x5836, 0x24);//
	OV5646MIPI_write_cmos_sensor(0x5837, 0x26);//
	OV5646MIPI_write_cmos_sensor(0x5838, 0x46);//
	OV5646MIPI_write_cmos_sensor(0x5839, 0x24);//
	OV5646MIPI_write_cmos_sensor(0x583a, 0x26);//
	OV5646MIPI_write_cmos_sensor(0x583b, 0x44);//
...
static void OV5646MIPIFullSizeCaptureSetting(void)
{
	...
	//OV5646MIPI_write_cmos_sensor(0x5306, 0x08);//	; DNS off1
	//OV5646MIPI_write_cmos_sensor(0x5307, 0x10);//	; DNS off2
       //ov5646_mipi_yuv_darling remove capture red by glimon
	OV5646MIPISetHVMirror(IMAGE_H_MIRROR, SENSOR_MODE_CAPTURE);	
	if(OV5646MIPI_run_test_potten)
	{
		OV5646MIPI_run_test_potten=0;
		OV5646SetTestPatternMode(1);
...
static void OV5646MIPISetHVMirror(kal_uint8 Mirror, kal_uint8 Mode)
{
	...
	mirror=OV5646MIPIYUV_read_cmos_sensor(0x3821);
       //ov5646_mipi_yuv_darling camera direction by glimon
