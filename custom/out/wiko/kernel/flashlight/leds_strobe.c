...
{
// BEGIN <><20130910><flash driver external IC or internal> Jiangde
#if 0  // external IC driver
...
#else // internal driver
    PK_DBG("HJDDBG 10.08, Enable_light    g_duty = %d \n" , g_duty);
	if(g_duty <= 6)//LINE <> <DATE20130516> <ext flash ic brightness> wupingzhou
	{
		PK_DBG("HJDDBG 10.08, TORCH_MODE\n");
	...
	{
		PK_DBG("HJDDBG 10.08, FLASH_MODE\n");
...
#endif
// END <><20130910><flash driver external IC or internal> Jiangde
