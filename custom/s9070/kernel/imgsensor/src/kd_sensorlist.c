...
{
/********
#ifndef TINNO_SW_I2C_IMPL  //elan tpd 0x2a,ov2659 0x60,imx105 0x34,hi253 0x40,hi704 0x60,fm50af 0x18,ov8825 0x6c
    if((slave_address==(0x34>>1))||(slave_address==(0x60>>1))
	||(slave_address==(0x40>>1))||(slave_address==(0x6c>>1))||(slave_address==(0x18>>1))){
        cam_i2c1_mode_set(1);
    }else{
        cam_i2c1_mode_set(0);
    }
